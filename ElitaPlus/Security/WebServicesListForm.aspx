<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Navigation/masters/content_default.Master"
    CodeBehind="WebServicesListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Security.WebServicesListForm" %>
                ...
                <table cellpadding="4" cellspacing="0" border="0" style="border: #999999 1px solid;
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; white-space: nowrap; vertical-align: middle; width: 40%">
                            <asp:DropDownList ID="cboOn_Line_Status" runat="server" AutoPostBack="False" CssClass="FLATTEXTBOX">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:GridView ID="Grid" runat="server" Width="100%" OnRowCreated="RowCreated" OnRowCommand="RowCommand"
                    ...
                    <Columns>
                        <asp:TemplateField Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="lblWebservice_id" runat="server" ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>                    
                        ...
                        <asp:TemplateField SortExpression="web_service_name" HeaderText="web_service_name">
                            <ItemStyle HorizontalAlign="CENTER"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="web_service_nameLabel" runat="server" Visible="True"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList id ="cboweb_service_name" runat="server" Style="width: 180px; overflow: hidden"></asp:DropDownList>
                                <asp:Label ID="web_service_nameLabelEdit" runat="server" Visible="True" ></asp:Label>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderStyle-Width="28px">
                            ...
                            <ItemStyle Width="28px" CssClass="CenteredTD" />
                            <ItemTemplate>
                                <asp:Button ID="btnItems" runat="server" CssClass="FLATBUTTON" Text="Items" CommandName="ItemsCMD" CommandArgument="<%#Container.DisplayIndex %>">
                                </asp:Button>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
