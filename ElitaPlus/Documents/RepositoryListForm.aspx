<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="../Navigation/masters/ElitaBase.Master"
    Theme="Default" CodeBehind="RepositoryListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.RepositoryListForm" %>
    ...
    <div class="dataContainer" runat="server" id="moSearchResults">
        ...
        <asp:GridView ID="Grid" runat="server" Width="100%" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField Visible="True" HeaderText="STORAGE_PATH" SortExpression="STORAGE_PATH">
                    <ItemTemplate>
                        <asp:Label ID="StoragePathLabel" runat="server" />
                    </ItemTemplate>
                    <EditItemTemplate>
