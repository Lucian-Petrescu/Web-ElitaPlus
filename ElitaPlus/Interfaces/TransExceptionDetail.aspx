            ...
            <td valign="top" align="center" height="100%">
                <asp:Panel ID="WorkingPanel" runat="server" Height="98%" Width="98%">
                    <table id="tblMain1" style="border-right: #999999 1px solid; border-top: #999999 1px solid;
                        ...
                        height: 100%" cellspacing="0" cellpadding="6" rules="cols" width="100%" align="center" bgcolor="#fef9ea" border="0">
                        <tr>
                                ...
                                <div id="scroller" style="overflow: auto; width: 100%; height: 100%" align="center">
                                    <table id="Table3" style="width: 100%" cellspacing="1" cellpadding="0" border="0">
                                        <asp:Panel ID="EditPanel_WRITE" runat="server" Height="100%" Width="100%">
                                            <tr>
                                                <td valign="top">
                                                    <table id="tblHeader" cellspacing="0" cellpadding="0" rules="cols" width="100%" align="center" bgcolor="#fef9ea" border="0">                                                      
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:TextBox ID="TextboxOriginator" Style="background-color: whitesmoke" TabIndex="1" runat="server" ReadOnly="True" Width="95%" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="TextboxFunction" Style="background-color: whitesmoke" TabIndex="1" runat="server" ReadOnly="True" Width="95%" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="TextboxServiceType" Style="background-color: whitesmoke" TabIndex="1" runat="server" ReadOnly="True" Width="95%" CssClass="FLATTEXTBOX"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td>
                                                    <table id="Table2" cellspacing="0" cellpadding="0" rules="cols" width="100%" align="center" bgcolor="#fef9ea" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 75%; height: 17px" colspan="2">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxCUSTOMER_NAME" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="320px"></asp:TextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxTAX_ID" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxADDRESS1" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxADDRESS2" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxPOSTAL_CODE" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxSTATE" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxPHONE1" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxPHONE2" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxEMAIL" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxRETAILER" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxINVOICE_NUMBER" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxPRODUCT_SALES_DATE" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxSALES_PRICE" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxMODEL" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxSERIAL_NUMBER" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxCLAIM_NUMBER" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxGVS_SERVICE_ORDER_NUMBER" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxSERVICE_CENTER_CODE" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxMETHOD_OF_REPAIR" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxDATE_CLAIM_OPENED" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75%; height: 17px" colspan="2">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxPROBLEM_DESCRIPTION" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="320px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 23%; height: 17px">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 75%; height: 17px" colspan="2">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxTECHNICAL_REPORT" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="320px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 23%; height: 17px">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxCLAIM_ACTIVITY" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                                &nbsp;
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxREPAIR_DATE" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxPICKUP_DATE" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxSCHEDULED_VISIT_DATE" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxEXPECTED_REPAIR_DATE" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxVISIT_DATE" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxDEFECT_REASON" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxLIABILITY_LIMIT" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxLIABILITY_LIMIT_PERCENT" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxDEDUCTIBLE_AMOUNT" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxDEDUCTIBLE_PERCENT" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxLABOR_AMT" TabIndex="2" runat="server" CssClass="FLATTEXTBOX" Width="160px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 1%; height: 17px" valign="middle" nowrap="" align="right">
                                                            ...
                                                            <td style="width: 50%; height: 17px">
                                                                &nbsp;
                                                                <asp:TextBox ID="TextboxSHIPPING" TabIndex="6" runat="server" CssClass="FLATTEXTBOX" Width="220px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <div id="tabs" class="style-tabs">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="StatusGridView" runat="server" Width="100%" OnRowCreated="ItemCreated_StatusGridView" AllowPaging="True" AllowSorting="False" CellPadding="1" AutoGenerateColumns="False" CssClass="DATAGRID">
                                                                ...
                                                                <div id="tabsParts">
                                                                    <asp:Panel ID="Panel1" runat="server" Width="100%">
                                                                        <table id="Table1" style="border-right: #999999 0px solid; border-top: #999999 0px solid; border-left: #999999 0px solid; border-bottom: #999999 0px solid; width: 100%; height: 178px" cellspacing="4" cellpadding="4" rules="cols" background="" border="0">
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="PartsGridView" runat="server" Width="100%" OnRowCreated="ItemCreated_PartsGridView" AllowPaging="True" AllowSorting="False" CellPadding="1" AutoGenerateColumns="False" CssClass="DATAGRID">
                                                                                                    <SelectedRowStyle CssClass="SELECTED"></SelectedRowStyle>
                                                                                                    <EditRowStyle CssClass="EDITROW"></EditRowStyle>
                                                                                                    <AlternatingRowStyle Wrap="False" CssClass="ALTROW"></AlternatingRowStyle>
                                                                                                    <RowStyle CssClass="ROW"></RowStyle>
                                                                ...
                                                                <div id="tabsFollowUP">
                                                                    <asp:Panel ID="Panel2" runat="server" Width="100%">
                                                                        <table id="Table4" style="border-right: #999999 0px solid; border-top: #999999 0px solid; border-left: #999999 0px solid; border-bottom: #999999 0px solid; width: 100%; height: 178px" cellspacing="4" cellpadding="4" rules="cols" background="" border="0">
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="FollowUpGridView" runat="server" Width="100%" OnRowCreated="ItemCreated_FollowUpGridView" AllowPaging="True" AllowSorting="False" CellPadding="1" AutoGenerateColumns="False" CssClass="DATAGRID">
                                                                                                    <SelectedRowStyle CssClass="SELECTED"></SelectedRowStyle>
                                                                                                    <EditRowStyle CssClass="EDITROW"></EditRowStyle>
                                                                                                    <AlternatingRowStyle Wrap="False" CssClass="ALTROW"></AlternatingRowStyle>
                                                                                                    <RowStyle CssClass="ROW"></RowStyle>
                        ...
                        <tr>
                            <td valign="top" nowrap="" align="left" height="20">
                                ...
                                <asp:Button ID="btnEdit_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                    cursor: hand; background-repeat: no-repeat" TabIndex="43" runat="server" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Edit"></asp:Button>&nbsp;
                                <asp:Button ID="btnUndo_Write" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif);
                                    cursor: hand; background-repeat: no-repeat" TabIndex="45" runat="server" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Undo"></asp:Button>&nbsp;
                                <asp:Button ID="btnAdd_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/add_icon.gif); 
                                    CURSOR: hand; BACKGROUND-REPEAT: no-repeat" TabIndex="46" runat="server" Width="150px" CssClass="FLATBUTTON" height="20px" Text="ADD_COMUNA_ALIAS"></asp:Button>&nbsp;
                            </td>
                            <td align="right">
                                <asp:Button ID="btnResend_WRITE" runat="server" CssClass="FLATBUTTON" Height="20px" Style="cursor: hand; background-repeat: no-repeat" TabIndex="5" Text="RESEND" Width="90px"></asp:Button>
                                &nbsp;<asp:Button ID="btnHide_Write" Style="cursor: hand; background-repeat: no-repeat" runat="server" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="HIDE">
                                </asp:Button>
                                &nbsp;
                            </td>
                        </tr>
