...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BestReplacementFileForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.BestReplacementFileForm" %>

<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>BestReplacementFile</title>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="moTitleLabel2" runat="server" CssClass="TITLELABELTEXT">BEST_REPLACEMENT_FILE</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <tr>
                            <td>
                                <uc1:FileProcessedController ID="moFileController" runat="server" 
                                    ShowComapnyGroup="true" ShowReference="true" ShowDealer="false" 
                                    ShowComapny="false" ReferenceCaption="SELECT_BEST_REPLACEMENT"
                                    FileType="BestReplacement" FileNameCaption="BEST_REPLACEMENT_FILE"
                                    RejectReportFileName="RejectedBestReplacement-Exp_EN"
                                    ProcessedReportFileName="ProcessedBestReplacement-Exp_EN"></uc1:FileProcessedController>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
