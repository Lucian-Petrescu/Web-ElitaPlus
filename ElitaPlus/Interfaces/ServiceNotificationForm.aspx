...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ServiceNotificationForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.ServiceNotificationForm"%>
<%@ Register TagPrefix="uc1" TagName="SvrNotificationFileProcessedController" Src="SvrNotificationFileProcessedController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>ServiceNotificationForm</title>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20">&nbsp;<asp:label id="moTitleLabel" runat="server" CssClass="TITLELABEL">INTERFACES</asp:label>:
									<asp:label id="moTitleLabel2" runat="server" CssClass="TITLELABELTEXT">SERVICE_NOTIFICATION</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				...
				<tr>
					<td vAlign="top" align="center" height="100%"><asp:panel id="moPanel" runat="server" Height="100px" Width="98%">
							<TABLE id="moTablelMain" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid"
								...
								<TR>
									<TD>
										<uc1:SvrNotificationFileProcessedController id="moSvrNotificationController" runat="server"></uc1:SvrNotificationFileProcessedController></TD>
								</TR>
							</TABLE>
						</asp:panel></td>
				</tr>
