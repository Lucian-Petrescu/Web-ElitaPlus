<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InterfaceStatusForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.InterfaceStatusForm" %>
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelTables" runat="server"  Cssclass="TITLELABEL">Admin</asp:label>:&nbsp;
								<asp:label id="Label7" runat="server" Cssclass="TITLELABELTEXT">Interface Status</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD vAlign="top" colSpan="2">
													<TABLE id="tblSearch" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; WIDTH: 98%; BORDER-BOTTOM: #999999 1px solid; HEIGHT: 64px"
																...
																<TABLE cellSpacing="2" cellPadding="2" width="100%" border="0">
																	<TR>
																		<TD noWrap align="left">
																			<asp:Label id="lblActivefilename" Runat="server">Active File</asp:Label>:</TD>
																	
																		<TD noWrap align="right">&nbsp;
																		</TD>
																	</TR>
																	<TR>
																		<TD style="HEIGHT: 26px" noWrap align="left">
																			<asp:textbox id="SearchActiveFileTextBox" runat="server" AutoPostBack="False" Width="180px"
													...
													<asp:GridView id="Grid" runat="server" Width="100%" 
														...
														<Columns>
														    <asp:TemplateField HeaderText="Reset">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkbxreset" runat="server" AutoPostBack="true" OnCheckedChanged="chkbxreset_checkedchanged"  Checked="false" ></asp:CheckBox>
                                                                   
                                                                </ItemTemplate>
                                                            </asp:TemplateField> 
                                                            <asp:TemplateField SortExpression="Active_FileName" HeaderText="Active File">
                                                            ...
                                                            <asp:TemplateField SortExpression="Created_Date" HeaderText="Created Date">
																<HeaderStyle HorizontalAlign="Center" Width="20%"></HeaderStyle>
																<ItemStyle HorizontalAlign="Center"></ItemStyle>
															</asp:TemplateField>
															<asp:TemplateField Visible="False" SortExpression="Interface_status_id" HeaderText="Interface_status_id"></asp:TemplateField>
														</Columns>
