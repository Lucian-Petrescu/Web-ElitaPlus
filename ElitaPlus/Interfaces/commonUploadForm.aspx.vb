Imports System.IO
Imports System.Text
Public Class commonUploadForm
    Inherits ElitaPlusSearchPage
#Region "Constants"
    Public Const URL As String = "Interfaces/commonUploadForm.aspx"
    Public Const PAGETITLE As String = "UPLOADS"
...
#Region "Helper function"
    ...
    Private Sub PopulateDropdown()
        Dim Data As DataView = LookupListNew.DropdownLookupList("UPLOAD", ElitaPlusIdentity.Current.ActiveUser.LanguageId, True)
        Dim i As Integer
