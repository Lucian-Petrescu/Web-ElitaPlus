            ...
            Try
                If Not IsPostBack Then
                    If mbIsPageReturn = False Then
                        TheClaimController.InitController(CloseClaimReconWrkForm.URL, PrintClaimLoadRejectForm.URL, _
                                                                    ClaimFileProcessedData.InterfaceTypeCode.CLOSE_CLAIM)
                    End If
