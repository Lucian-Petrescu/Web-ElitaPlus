<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NewClaimHpReconWrkForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.NewClaimHpReconWrkForm"%>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>NewClaimHpReconWrkForm</title>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20">&nbsp;<asp:label id="Label7" runat="server" CssClass="TITLELABEL">INTERFACES</asp:label>:
									<asp:label id="Label3" runat="server" CssClass="TITLELABELTEXT">NEW_CLAIMS_HP</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
															...
															<TR>
																<TD noWrap>
																	<asp:datagrid id="moDataGrid" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
																		...
																		BorderStyle="Solid" CssClass="DATAGRID_NOWRAP" OnItemCreated="ItemCreated" OnItemCommand="ItemCommand">
