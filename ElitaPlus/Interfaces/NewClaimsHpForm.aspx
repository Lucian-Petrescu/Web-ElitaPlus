<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NewClaimsHpForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.NewClaimsHpForm"%>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20">&nbsp;<asp:label id="moTitleLabel" runat="server" CssClass="TITLELABEL">INTERFACES</asp:label>:
									<asp:label id="moTitleLabel2" runat="server" CssClass="TITLELABELTEXT">NEW_CLAIMS_HP</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
