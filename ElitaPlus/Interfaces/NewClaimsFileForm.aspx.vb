...
Namespace Interfaces
    ...
    Partial Class NewClaimsfileForm
            ...
            Try
                If Not IsPostBack Then
                    If mbIsPageReturn = False Then
                        TheClaimController.InitController(ClaimReconWrkForm.URL, PrintClaimLoadRejectForm.URL, _
                                                                    ClaimFileProcessedData.InterfaceTypeCode.NEW_CLAIM)
                    End If
                End If
