<%@ Page Language="vb" MasterPageFile="../Navigation/masters/ElitaBase.Master" AutoEventWireup="false"
    CodeBehind="commonUploadForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.commonUploadForm"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:DropDownList ID="ddlUploadType" runat="server" SkinID="MediumDropDown">
                                ...
                                <asp:ListItem Value="SERVICELEVEL">Service Level Group</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
