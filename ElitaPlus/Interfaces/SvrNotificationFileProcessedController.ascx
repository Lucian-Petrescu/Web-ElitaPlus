<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SvrNotificationFileProcessedController.ascx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.SvrNotificationFileProcessedController" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
							...
							<TR>
								<TD style="WIDTH: 539px">
									<TABLE style="WIDTH: 680px; HEIGHT: 30px" cellSpacing="0" cellPadding="0" width="680" border="0">
										<TR>
											<TD style="WIDTH: 170px; HEIGHT: 30px" noWrap align="RIGHT">*<asp:label id="moDealerLabel" runat="server" Width="137px">NOTIFICATION_INTERFACE</asp:label>:&nbsp;</TD>
											<TD style="HEIGHT: 30px" noWrap align="left"><asp:dropdownlist id="moDealerDrop" runat="server" Width="242px" AutoPostBack="True"></asp:dropdownlist>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<asp:button id="moBtnSearch" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/search_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="90px" Font-Bold="false" Visible="False" CssClass="FLATBUTTON" height="20px"
													Text="Search" CausesValidation="False" Enabled="False"></asp:button></TD>
											<TD style="HEIGHT: 30px" noWrap align="left"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
				...
				<TR>
					<TD colSpan="3"><asp:datagrid id="moDataGrid" runat="server" Width="100%" OnItemCommand="ItemCommand" AllowSorting="True"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" HeaderText="Notificationfile_processed_id"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="BYPASSED" HeaderText="IGNORED">
									<HeaderStyle Wrap="False" HorizontalAlign="Center" Width="1%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
...
<uc1:interfaceprogresscontrol id="moInterfaceProgressControl" runat="server"></uc1:interfaceprogresscontrol><asp:button id="btnAfterProgressBar" style="BACKGROUND-COLOR: #fef9ea" runat="server" Width="0"
	Height="0"></asp:button>
