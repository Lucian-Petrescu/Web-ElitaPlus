...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CloseClaimsSunComForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.CloseClaimsSunComForm"%>
<%@ Register TagPrefix="uc1" TagName="ClaimFileProcessedController" Src="ClaimFileProcessedController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CloseClaimsSunComForm</title>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20">&nbsp;<asp:label id="moTitleLabel" runat="server" CssClass="TITLELABEL">INTERFACES</asp:label>:
									<asp:label id="moTitleLabel2" runat="server"   CssClass="TITLELABELTEXT">CLOSE_CLAIMS_SUNCOM</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
