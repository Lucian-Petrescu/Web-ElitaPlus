...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CloseClaimReconWrkForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Interfaces.CloseClaimReconWrkForm" %>
...
<HTML>
	...
	arColumnMap[":moDateClaimClosedTextGrid"] = ++n;
	arColumnMap["col"+n] = ":moDateClaimClosedTextGrid"
	...
	arColumnMap[":moStatusCodeTextGrid"] = ++n;
	arColumnMap["col"+n] = ":moStatusCodeTextGrid"
	...
	<body onresize="resizeForm(document.getElementById('scroller'));" leftMargin="0" topMargin="0"
		...
		<form id="Form1" method="post" runat="server">
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20">&nbsp;<asp:label id="Label7" runat="server" CssClass="TITLELABEL">INTERFACES</asp:label>:
									<asp:label id="Label3" runat="server"  CssClass="TITLELABELTEXT">CLOSE_CLAIMS</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
			...
			<TABLE id="tblOuter2" style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; MARGIN: 5px; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"
				...
				<tr>
					<td vAlign="top" align="center" height="100%"><asp:panel id="WorkingPanel" runat="server" Height="100px" Width="98%">
										...
										<TABLE style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"
											...
											<TR>
												<TD colSpan="2" style="text-align:left;">
													<DIV id="scroller" onkeydown="arrowKeyHandler()" style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 365px"
														onclick="ClickHandler()" align="left">
																	...
																	<asp:datagrid id="moDataGrid" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
																		...
																		<Columns>
																			...
																			<asp:TemplateColumn SortExpression="DO_NOT_PROCESS" HeaderText="DO_NOT_PROCESS">
																				<HeaderStyle  HorizontalAlign="Center"></HeaderStyle>
																				<ItemStyle Wrap="False" HorizontalAlign="Left" Width="60px" BackColor="White"></ItemStyle>
																				<ItemTemplate>
																			...
																			<asp:TemplateColumn SortExpression="DATE_CLAIM_CLOSED" HeaderText="DATE_CLAIM_CLOSED">
																				<HeaderStyle  HorizontalAlign="Center"></HeaderStyle>
																			...
																			<asp:TemplateColumn SortExpression="STATUS_CODE" HeaderText="STATUS_CODE">
																				<HeaderStyle  HorizontalAlign="Center"></HeaderStyle>
																				<ItemStyle Wrap="False" HorizontalAlign="Left" Width="30%" BackColor="White"></ItemStyle>
																				<ItemTemplate>
																					<asp:TextBox id="moStatusCodeTextGrid" runat="server" onFocus="setHighlighter(this)" onMouseover="setHighlighter(this)"
																						visible="True"></asp:TextBox>
																				</ItemTemplate>
																			</asp:TemplateColumn>
																			<asp:TemplateColumn Visible="False">
