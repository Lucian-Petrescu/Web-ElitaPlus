...
<tr id="bankInfo_hr2">
    ...
    <td align="left">
        <asp:TextBox ID="textboxNameAccount" runat="server" MaxLength="50" SkinID="MediumTextBox" />
    </td>
    <td align="right">
        <asp:Label ID="labelCountryOfBank" runat="server">COUNTRY_OF_BANK:</asp:Label>
    </td>
    <td align="left">
        <asp:DropDownList ID="moCountryDrop_WRITE" runat="server" AutoPostBack="True" SkinID="MediumDropDown">
        </asp:DropDownList>
    </td>
</tr>
  ...
  <tr id="bankInfo_hr3">
            ...
            <td align="left">
                ...
                <asp:TextBox ID="txtBankBranchName" runat="server" SkinID="MediumTextBox" MaxLength="50"></asp:TextBox>
            </td>
        </tr>
        <tr id="bankInfo_hr4">
            <td align="right" class="<%= HiddenClassName %>">
            ...
            <td align="left">
                ...
                <asp:TextBox ID="txtBranchNumber" runat="server" SkinID="MediumTextBox" MaxLength="8"></asp:TextBox>
            </td>
</tr>
...
<tr id="bankInfo_hr5">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtBranchDigit" runat="server" MaxLength="8" SkinID="MediumTextBox" />
    </td>
    <td align="right">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="textboxBankAccountNo" runat="server" SkinID="MediumTextBox" MaxLength="30"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_hr6">
    <td align="right" class="<%= HiddenClassName %>">
    ...
    <td align="left">
        <asp:DropDownList ID="moAccountTypeDrop" runat="server" SkinID="MediumDropDown">
        </asp:DropDownList>
    </td>
    <td align="right" class="<%= HiddenClassName %>">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtAcctDigit" runat="server" SkinID="MediumTextBox" MaxLength="8"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_hr7">
    <td align="right" class="<%= HiddenClassName %>">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="textboxSwiftCode" runat="server" SkinID="MediumTextBox" MaxLength="40"></asp:TextBox>
    </td>
    <td align="right">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="textboxIBAN_Number" runat="server" MaxLength="40" SkinID="MediumTextBox"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_hr8">
    <td align="right" class="<%= HiddenClassName %>">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtBankLookupCode" runat="server" MaxLength="15" SkinID="MediumTextBox" />
    </td>
    <td align="right">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtBankSubcode" runat="server" SkinID="MediumTextBox" MaxLength="5"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_hr9">
    <td align="right" class="<%= HiddenClassName %>">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtTransLimit" runat="server" MaxLength="18" SkinID="MediumTextBox"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_hr10">
    <td align="right" class="<%= HiddenClassName %>">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtTaxId" runat="server" SkinID="MediumTextBox" MaxLength="15"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_Address1">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtAddress1" runat="server" SkinID="MediumTextBox" MaxLength="50"></asp:TextBox>
    </td>
    <td align="right">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtAddress2" runat="server" MaxLength="50" SkinID="MediumTextBox"></asp:TextBox>
    </td>
</tr>
<tr id="bankInfo_Address2">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtCity" runat="server" SkinID="MediumTextBox" MaxLength="50"></asp:TextBox>
    </td>
    <td align="right">
    ...
    <td align="left">
        ...
        <asp:TextBox ID="txtPostalCode" runat="server" MaxLength="25" SkinID="MediumTextBox"></asp:TextBox>
    </td>
</tr>
