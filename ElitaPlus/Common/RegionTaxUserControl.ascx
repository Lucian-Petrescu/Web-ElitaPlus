...
<table id="Table3" border="0">
	<tr>
		...
		<td><asp:textbox id="txtTaxDescription"  runat="server" SkinID="SmallTextBox" Columns="30" maxlength="30"
				Enabled="False"></asp:textbox></td>
	</tr>
	<tr>
		<td noWrap align="right">
		    <asp:label id="lblPercent" runat="server">PERCENT:</asp:label></td>
		<td><asp:textbox id="txtTaxPercent"  runat="server" SkinID="SmallTextBox" Columns="18" maxlength="18"
				Enabled="False"></asp:textbox></td>
	</tr>
	<tr>
		<td noWrap align="right" colspan="1" rowSpan="1">
		    <asp:label id="lblNontaxable" runat="server">NON_TAXABLE</asp:label>:</td>
		<td><asp:textbox id="txtNonTaxable"  runat="server" SkinID="SmallTextBox"  Columns="18" maxlength="18"
				Enabled="False"></asp:textbox></td>
	</tr>
	<tr>
		<td noWrap align="right" colspan="1" rowSpan="1">
		    <asp:label id="lblMinTax" runat="server">MINIMUM_TAX</asp:label>:</td>
		<td><asp:textbox id="txtMinimumTax"  runat="server" SkinID="SmallTextBox" Columns="18" maxlength="18"
				Enabled="False"></asp:textbox></td>
	</tr>
	<tr>
		<td noWrap align="right" colSpan="1" rowspan="1" >
		...
		<td>
			<asp:TextBox id="txtGLAccount" runat="server" SkinID="SmallTextBox" Enabled="False"></asp:TextBox></td>
	</tr>
</table>
