...
#Region "Properties"
        ...
        Public Sub ClearLists()
            moSelectedList.Items.Clear()
            moAvailableList.Items.Clear()
        End Sub

        Public ReadOnly Property SelectedListwithCommaSep() As String
            Get
                Dim oSelectedlist As String
                Dim oItem As ListItem
                oSelectedlist = String.Empty
                For Each oItem In moSelectedList.Items
                    oSelectedlist = oSelectedlist + (oItem.Text) + ","
                Next
        ...
        Public ReadOnly Property SelectedListValuewithCommaSep() As String
            Get
                Dim oSelectedlist As String
                Dim oItem As ListItem
                oSelectedlist = String.Empty
...
#Region "Client & JavaScript"
        ...
        Protected Sub RegisterClientScript()
            ...
            sJavaScript = "<SCRIPT language='JavaScript' src='../Navigation/Scripts/AvailableSelected_New.js'>" & Environment.NewLine
