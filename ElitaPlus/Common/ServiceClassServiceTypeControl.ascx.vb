                ...
                If ServiceClassGuid <> Guid.Empty Then
                    ...
                    Dim ServiceTypes As DataElements.ListItem() =
                        CommonConfigManager.Current.ListManager.GetList(listCode:="ServiceTypeByServiceClass",
                                                                ...
                                                                {
                                                                  .ServiceClassId = ElitaPlusPage.GetSelectedItem(cboServiceClass),
...
#Region "Creates a Multiple Column DropDown Based on DataView"
        ...
        Public Sub SetControl(AutoPostBack As Boolean,
                              ...
                              Optional ByVal addColonToCaption As Boolean = True,
                              Optional ByVal additionalOnClickJavaScript As String = "",
                              Optional ByVal Code_HTML_ID As String = "",
                              Optional ByVal Description_HTML_ID As String = "",
                              Optional ByVal Caption_HTML_ID As String = "",
