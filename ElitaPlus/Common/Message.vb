...
#Region "Messages"
    ...
    Public Const MSG_ERR_INVOICE_AMOUNT_NOT_MATCHED_WITH_LINES As String = "MSG_ERR_INVOICE_AMOUNT_NOT_MATCHED_WITH_LINES"
    Public Const MSG_ERR_INVOICE_AMOUNT_MATCHED_WITH_LINES As String = "MSG_ERR_INVOICE_AMOUNT_MATCHED_WITH_LINES"

    Public Const MSG_CLAIM_NUMBER_OR_AUTHORIZATION_NUMBER_REQUIRED As String = "MSG_CLAIM_NUMBER_OR_AUTHORIZATION_NUMBER_REQUIRED"
    ...
    Public Const MSG_ERR_DUPLICATE_INVOICE As String = "MSG_ERR_DUPLICATE_INVOICE"
    ...
    'US-489838
    Public Const MSG_EITHER_LIMIT_OR_PERCENT_ALLOWED As String = "MSG_EITHER_LIMIT_OR_PERCENT_ALLOWED"
    Public Const MSG_FIRST_RENEWAL_NOT_ZERO As String = "MSG_FIRST_RENEWAL_NOT_ZERO"
    Public Const MSG_RENEWAL_NOT_SEQUENCE As String = "MSG_RENEWAL_NOT_SEQUENCE"

    'US - 565821 - UI - Commission fields check null and position validation
    Public Const MSG_POSITION_SHOULD_NOT_BE_ZERO_NULL As String = "MSG_POSITION_SHOULD_NOT_BE_ZERO_NULL"
    Public Const MSG_POSITION_VALUE_CAN_NOT_BE_REPEATED As String = "MSG_POSITION_VALUE_CAN_NOT_BE_REPEATED"    
    Public Const MSG_EITHER_PERCENTAGE_OR_AMOUNT_NEEDED As String = "MSG_EITHER_PERCENTAGE_OR_AMOUNT_NEEDED"

    'PBI 488284
    Public Const MSG_BRANCH_FIELD_SELECT As String = "MSG_BRANCH_FIELD_SELECT"
    Public Const MSG_BRANCH_CERTFICATE_STATUS_FIELD_SELECT As String = "MSG_BRANCH_CERTFICATE_STATUS_FIELD_SELECT"
