...
#Region "Events"
        ...
        Public Event Attach(ByVal aSrc As UserControlAvailableSelected, ByVal attachedList As ArrayList)
        Public Event Detach(ByVal aSrc As UserControlAvailableSelected, ByVal detachedList As ArrayList)
