...
#Region "Page Events"
    ...
    End Sub
    Public Sub Bind(ByVal PoliceReportBo As PoliceReport, ByVal containerErrorController As ErrorController, Optional ByVal starneeded As Boolean = False, Optional ByVal bypassdualdropinitialization As Boolean = False)
        With State
