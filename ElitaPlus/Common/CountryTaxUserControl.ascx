...
<table id="Table3" border="0">
	<tr>
		...
		<td>&nbsp;<asp:textbox id="txtTaxDescription" runat="server" CssClass="small" maxlength="30" Columns="30"></asp:textbox></td>
	</tr>
	<tr>
		<td align="right"><asp:label id="lblTaxComputeMeth" runat="server" Font-Bold="false">COMPUTE_METHOD</asp:label>:</td>
		<td>&nbsp;<asp:dropdownlist id="dlstTaxComputeMethod" runat="server" CssClass="small" AutoPostBack="True"></asp:dropdownlist></td>
	</tr>
	<tr>
		<td align="right"><asp:label id="lblTaxPercent" runat="server" Font-Bold="false">PERCENT_FLAG:</asp:label></td>
		<td>&nbsp;<asp:dropdownlist id="dlstTaxPercentFlag" runat="server" CssClass="small" AutoPostBack="True"></asp:dropdownlist></td>
	</tr>
	<tr>
		<td align="right"><asp:label id="lblPercent" runat="server" Font-Bold="false">PERCENT:</asp:label></td>
		<td>&nbsp;<asp:textbox id="txtTaxPercent" runat="server" CssClass="small" maxlength="18" Columns="18"></asp:textbox></td>
	</tr>
</table>
