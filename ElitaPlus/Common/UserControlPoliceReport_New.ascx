    ...
    <table class="formGrid" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            ...
            <tr>
                ...
                <td nowrap="nowrap">
                    <asp:TextBox ID="TextboxReportNumber" TabIndex="1" runat="server" SkinID="SmallTextBox"></asp:TextBox>
                </td>
                <td nowrap="nowrap" align="right">
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td nowrap="nowrap">
                    <asp:TextBox ID="TextboxOfficerName" TabIndex="1" runat="server" SkinID="SmallTextBox"></asp:TextBox>
                </td>
                <td nowrap="nowrap" align="right">
                    &nbsp;
                </td>
