...
<tr>
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moAddress1Text" TabIndex="1" runat="server" CssClass="large" TextMode="MultiLine" Rows="2" Style="white-space: pre-wrap; width: 540px;" Columns="50"></asp:TextBox>
    </td>
    <td nowrap="nowrap" align="right">
        <asp:Label ID="moCountryLabel" runat="server">Country</asp:Label>
    </td>
    <td nowrap="nowrap">
        <asp:TextBox ID="moCountryText" runat="server" ReadOnly="True" TabIndex="4" CssClass="small"></asp:TextBox>
...
<tr>
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moAddress2Text" TabIndex="2" runat="server" CssClass="large" TextMode="MultiLine" Rows="2" Style="white-space: pre-wrap; width: 540px;" Columns="50"></asp:TextBox>
    </td>
    <td nowrap="nowrap" align="right">
        <asp:Label ID="moRegionLabel" runat="server">State_Province</asp:Label>
    </td>
    <td nowrap="nowrap">
        <asp:TextBox ID="moRegionText" runat="server" ReadOnly="True" TabIndex="6" CssClass="small"></asp:TextBox>
...
<tr>
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moAddress3Text" TabIndex="3" runat="server" CssClass="large"  TextMode="MultiLine" Rows="2" Style="white-space: pre-wrap; width: 540px;" Columns="50"></asp:TextBox>
    </td>
    <td nowrap="nowrap" align="right">
        <asp:Label ID="moCityLabel" runat="server">City</asp:Label>
    </td>
    <td nowrap="nowrap">
        <asp:TextBox ID="moCityText" TabIndex="8" runat="server" CssClass="small"></asp:TextBox>
    </td>
</tr>
<tr>
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moPostalText" TabIndex="9" runat="server" CssClass="small"></asp:TextBox>
        <asp:button id="btnValidate_Address" Visible="false" style="CURSOR:pointer; BACKGROUND-REPEAT: no-repeat"
									...
									Width="160px" CssClass="primaryBtn floatR" ></asp:button>
    </td>
