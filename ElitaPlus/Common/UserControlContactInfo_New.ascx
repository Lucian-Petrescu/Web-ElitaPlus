...
<tr>
    ...
    <td style="white-space: nowrap">
        <asp:TextBox ID="moAddressTypeText" runat="server" ReadOnly="True" TabIndex="5" CssClass="medium"></asp:TextBox>
        <asp:DropDownList ID="moAddressTypeDrop_WRITE" TabIndex="6" runat="server" CssClass="medium">
        </asp:DropDownList>
    </td>
</tr>
<tr>
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moSalutationText" TabIndex="1" runat="server" CssClass="medium"></asp:TextBox>
        <asp:DropDownList ID="cboSalutationId" TabIndex="1" runat="server" CssClass="medium">
        </asp:DropDownList>
    </td>
    <td nowrap="nowrap" align="right">
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moHomePhoneText" TabIndex="1" runat="server" CssClass="medium"></asp:TextBox>
    </td>
</tr>
<tr>
    <td nowrap="nowrap" align="right">
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moContactNameText" TabIndex="1" runat="server" CssClass="medium"></asp:TextBox>
    </td>
    <td nowrap="nowrap" align="right">
        <asp:Label ID="moWorkPhoneLabel" runat="server">WORK_PHONE</asp:Label>
    </td>
    <td nowrap="nowrap">
        <asp:TextBox ID="moWorkPhoneText" TabIndex="1" runat="server" CssClass="medium"></asp:TextBox>
    </td>
</tr>
<tr>
    <td nowrap="nowrap" align="right">
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moEmailAddressText" TabIndex="1" runat="server" CssClass="medium"></asp:TextBox>
    </td>
    <td nowrap="nowrap" align="right">
        <asp:Label ID="moCellPhoneLabel" runat="server">CELL_PHONE</asp:Label>
    </td>
    <td nowrap="nowrap">
        <asp:TextBox ID="moCellPhoneText" runat="server" TabIndex="1" CssClass="medium"></asp:TextBox>
    </td>
</tr>
<tr>
    <td nowrap="nowrap" align="right">
    ...
    <td nowrap="nowrap">
        <asp:TextBox ID="moCompanyText" TabIndex="1" runat="server" CssClass="medium"></asp:TextBox>
    </td>
    <td nowrap="nowrap" align="right">
        <asp:Label ID="moJobTitleLabel" runat="server">JOB_TITLE</asp:Label>
    </td>
    <td nowrap="nowrap">
        <asp:TextBox ID="moJobTitleText" runat="server" TabIndex="1" CssClass="medium"></asp:TextBox>
    </td>
</tr>
