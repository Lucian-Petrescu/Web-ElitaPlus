				...
				<tr>
						...
						<table cellSpacing="0" cellPadding="0" height="100%" width="209">
							...
							<tr>
								<td height="464" width="209" background="images/home_left_back.gif" style="text-align:center">
									<asp:button id="btnExit" CssClass="HOMEFLATBUTTON" style="BACKGROUND-POSITION: left center; Z-INDEX: 101; LEFT: 55px; BACKGROUND-IMAGE: url(./images/icons/exitIcon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat; POSITION: absolute; TOP: 288px; BACKGROUND-COLOR: #d3d5e2; border-style:outset"
										runat="server" Width="89" Height="25" Text="EXIT"></asp:button>
									<asp:dropdownlist id="cboLanguage" style="Z-INDEX: 102; LEFT: 30px; POSITION: absolute; TOP: 128px"
										runat="server"  AutoPostBack="True" ForeColor="#5d7ba5"></asp:dropdownlist>
									<asp:label id="lblLanguageTitle" style="Z-INDEX: 103; LEFT: 35px; POSITION: absolute; TOP: 104px"
										runat="server" Visible="True" >CHANGE MY LANGUAGE</asp:label>
									<asp:label id="lblEnvTitle" style="Z-INDEX: 123; LEFT: 13px; POSITION: absolute; TOP: 210px"
										runat="server" Visible="True" >Environment:</asp:label>
									<asp:label id="lblEnvValue" style="Z-INDEX: 113; LEFT: 110px; POSITION: absolute; TOP: 210px"
										runat="server" Visible="True" ></asp:label>
                                    <asp:label id="lblBuildTitle" style="Z-INDEX: 123; LEFT: 13px; POSITION: absolute; TOP: 230px"
										runat="server" Visible="True" >Build:</asp:label>
									<asp:label id="lblBuildValue" style="Z-INDEX: 113; LEFT: 110px; POSITION: absolute; TOP: 230px"
										runat="server" Visible="True" ></asp:label>
					...
					<td width="100%" nowrap valign="top">
						<table cellSpacing="0" cellPadding="0" border="0" width="100%">
							...
							<tr>
								<td width="100%" align="center" nowrap><img src="./images/trans_spacer.gif" height="1" width="210"><asp:label width="123" id="Label12" style="color:#000;Z-INDEX:101;BACKGROUND-COLOR:white;"
										Runat="server">Extended Service Contract System</asp:label></td>
							</tr>
							<tr>
							...
							<tr>
								<td align="center"><div style="MARGIN-TOP: 5px; MARGIN-BOTTOM: 15px; MARGIN-LEFT: 10px"><br>
                                    ...
                                    <a target="_blank" href="http://www.assurant.com/inc/assurant/notice.html" rel="noopener noreferrer">
											<span style="color: #0066cc;">Notice</span></a> | <a target="_blank" href="http://www.assurant.com/inc/assurant/privacy.html" rel="noopener noreferrer">
											<span style="color: #0066cc;">Privacy Policy</span></a></div>
									<DIV></DIV>
								</td>
							</tr>
						</table>
						<asp:label width="123" id="Label1" ForeColor="#5b467f" style="FONT-WEIGHT:900;FONT-SIZE:18px;Z-INDEX:101;LEFT:-78px;POSITION:absolute;TOP:-45px;"
