...
function DisableReportControls() {
    try {
        ...
        var chk = document.getElementById("ctl00_BodyPlaceHolder_rdealer");
        var dlrCode = document.getElementById("ctl00_BodyPlaceHolder_multipleDropControl_moMultipleColumnDrop");
        var dlrDesc = document.getElementById("ctl00_BodyPlaceHolder_multipleDropControl_moMultipleColumnDropDesc");
        var dlrGroup = document.getElementById("ctl00_BodyPlaceHolder_moDealerGroupList");
        chk.checked = false;
