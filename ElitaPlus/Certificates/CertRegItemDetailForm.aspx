<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CertRegItemDetailForm.aspx.vb"
    Theme="Default" MasterPageFile="../Navigation/masters/ElitaBase.Master" EnableSessionState="True"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Certificates.CertRegItemDetailForm" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
            ...
            <asp:Panel ID="EditPanel_WRITE" runat="server" Width="100%">
                <table id="Table1" class="formGrid">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="PurchasePriceText" runat="server" SkinID="MediumTextBox" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="ItemRegistrationStatusLabel" runat="server">ITEM_REGISTRATION_STATUS</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="cboItemRegistrationStatus" runat="server" SkinID="MediumDropDown">
                            </asp:DropDownList>
                        </td>
                        <td align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="ExpirationDateText" runat="server" SkinID="MediumTextBox" ></asp:TextBox>
                        </td>
                        <td>
    ...
    <div class="btnZone">
        ...
        <asp:Button ID="btnHistory_WRITE" SkinID="AlternateLeftButton" runat="server" Text="REGISTER_ITEM_HISTORY" ></asp:Button>&nbsp;
