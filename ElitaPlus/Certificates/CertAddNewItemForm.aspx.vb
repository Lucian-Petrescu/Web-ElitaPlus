...
#Region "Controlling Logic"
        ...
        Protected Sub CheckIfComingFromSaveConfirm()
            ...
            Try
                ...
                If confResponse IsNot Nothing AndAlso confResponse = Me.MSG_VALUE_YES Then
                    ...
                    Select Case Me.State.ActionInProgress
                        ...
                        Case ElitaPlusPage.DetailPageCommand.BackOnErr
                            ...
                            Me.NavController.Navigate(Me, "back", retObj)
                    End Select
                ElseIf confResponse IsNot Nothing AndAlso confResponse = Me.MSG_VALUE_NO Then
                    Select Case Me.State.ActionInProgress
                        Case ElitaPlusPage.DetailPageCommand.Back
                            Dim retObj As ReturnType = New ReturnType(ElitaPlusPage.DetailPageCommand.Back, Me.State._moCertificate, Me.State.boChanged)
                            Me.NavController.Navigate(Me, "back", retObj)
                    ...
                    End Select
                ElseIf confResponse IsNot Nothing AndAlso confResponse = Me.MSG_VALUE_OK Then
                    Select Case Me.State.ActionInProgress
                        Case ElitaPlusPage.DetailPageCommand.Back
                            Dim retObj As ReturnType = New ReturnType(ElitaPlusPage.DetailPageCommand.Back, Me.State._moCertificate, Me.State.boChanged)
                            Me.NavController.Navigate(Me, "back", retObj)
