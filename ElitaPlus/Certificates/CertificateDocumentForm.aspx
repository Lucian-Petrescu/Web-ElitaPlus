<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CertificateDocumentForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.CertificateDocumentForm" Theme="Default"
...
<asp:Content ID="Content2" ContentPlaceHolderID="SummaryPlaceHolder" runat="server">
    <table border="0" class="summaryGrid" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="right" nowrap="nowrap">
                <asp:Label ID="lblCertificateNumber" runat="server" SkinID="SummaryLabel">CERTIFICATE NUMBER</asp:Label>:
            </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <div id="modalCertificateImages" class="overlay">
