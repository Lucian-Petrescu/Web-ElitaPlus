<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SerialNumberListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Certificates.SerialNumberListForm"%>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="moTitle2Label" runat="server" CssClass="TITLELABELTEXT">SERIAL_NUMBER</asp:label>&nbsp;<asp:label id="Label1a" runat="server"  CssClass="TITLELABELTEXT">Search</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
																...
																<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																	<TR>
																		<TD style="HEIGHT: 12px" noWrap align="left" width="1%">
																			<asp:label id="moSerialNumberLabel" runat="server">Serial_Number</asp:label>:</TD>
																		<TD style="HEIGHT: 12px" noWrap align="left" width="1%"></TD>
																		<TD style="HEIGHT: 12px" noWrap align="left" width="1%"></TD>
																	</TR>
																	<TR>
																		<TD noWrap align="left">
																			<asp:textbox id="moSerialNumberText" runat="server" Width="100%" AutoPostBack="False" CssClass="FLATTEXTBOX_TAB"></asp:textbox></TD>
																	...
																	<TR>
																		...
																		<TD noWrap align="right" colSpan="3">
																			...
																			<asp:button id="btnSearch" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/search_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
																				runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Text="Search" height="20px"></asp:button></TD>
																	</TR>
																</TABLE>
															</TD>
														</TR>
												...
												<TD vAlign="top" align="center" colSpan="2" height="100%"><!--<DIV id="scroller" style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 400px" align="center">-->
													<asp:datagrid id="Grid" runat="server" Width="100%" height="100%" OnItemCreated="ItemCreated"
														...
														<Columns>
															...
															<asp:BoundColumn SortExpression="serial_number" HeaderText="serial_number">
																<HeaderStyle Wrap="False" HorizontalAlign="Center" ForeColor="#12135B" Width="30%"></HeaderStyle>
															...
															<asp:BoundColumn SortExpression="Dealer" HeaderText="Dealer">
															...
															<asp:BoundColumn HeaderText="Product_code">
