...
<asp:Content ContentPlaceHolderID="BodyPlaceHolder" runat="server">
                ...
                <tbody>
                    <tr>
                        <td align="right" nowrap="noWrap">
                            <asp:Label runat="server" ID="moSourceLabel" Text="SOURCE"></asp:Label>
                        </td>
                        <td nowrap="noWrap">
                            <asp:DropDownList runat="server" ID="moSourceDropDown" SkinID="MediumDropDown">
                            </asp:DropDownList>
                            <asp:TextBox runat="server" ID="moSourceTextBox" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td align="right" nowrap="noWrap">
                            <asp:Label runat="server" ID="moSourceCodeLabel" Text="SOURCE_CODE"></asp:Label>
                        </td>
                        <td nowrap="noWrap">
                            <asp:TextBox runat="server" ID="moSourceCode" SkinID="MediumTextBox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
    ...
    <div class="dataContainer">
        <div class="Page" runat="server" id="moRulesPage" style="height: 300px; overflow: auto">
            <asp:GridView runat="server" ID="ChildGrid" SkinID="DetailPageGridView" AllowPaging="false" AllowSorting="false" Width="100%">
                <Columns>
                    <asp:TemplateField HeaderText="FIELD NAME">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="moFieldName"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:DropDownList runat="server" ID="moFieldNameDropDown" Visible="false" SkinID="MediumDropDown"></asp:DropDownList>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="OPERATOR">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="moOperator"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:DropDownList runat="server" ID="moOperatorDropDown" Visible="false" SkinID="SmallDropDown"></asp:DropDownList>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="FIELD VALUE">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="moFieldValue"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox runat="server" ID="moFieldValueTextBox" Visible="false" SkinID="MediumTextBox"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="SOURCE_CODE">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="moSourceCode"></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox runat="server" ID="moSourceCodeTextBox" Visible="false" SkinID="MediumTextBox"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Right">
                        ...
                        <table><tr><td>
                            ...
                            <asp:LinkButton ID="btnCancel" runat="server" Text="Cancel" CommandName="CancelRecord" SkinID="AlternateRightButton"></asp:LinkButton></td></tr>
                        </table>
                        </EditItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <table class="tabBtnAreaZone" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <asp:Button runat="server" ID="btnAddNewRule" SkinID="PrimaryLeftButton" Text="ADD_NEW"></asp:Button>
                        </td>
                    </tr>
                </tbody>
            </table>
