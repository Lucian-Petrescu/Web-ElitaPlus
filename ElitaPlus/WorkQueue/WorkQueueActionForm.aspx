...
<asp:Content ID="Content3" ContentPlaceHolderID="MessagePlaceHolder" runat="server">
    <Elita:MessageController runat="server" ID="mcWorkQueueAction" Visible="false" />
</asp:Content>
...
<asp:PlaceHolder ID="PlaceHolder2" runat="server">
    ...
    <div class="btnZone" runat="server" id="btnZone"  >
        <asp:Button ID="btnRedirect" runat="server" Text="REDIRECT" SkinID="PrimaryRightButton" 
            OnClientClick="return revealModal('ModalRedirectReason');" />
        <asp:Button ID="btnRequeue" runat="server" Text="REQUEUE" SkinID="PrimaryRightButton" 
            OnClientClick="return revealModal('ModalRequeueReasons');" />
        <asp:Button ID="btnProceed" runat="server" SkinID="PrimaryRightButton" Text="PROCEED" />
    </div>
    <div id="ModalRequeueReasons" class="overlay">
        <div id="light" class="overlay_message_content" style="width: 500px">
            <p class="modalTitle">
                ...
                <a href="javascript:void(0)" onclick="hideModal('ModalRequeueReasons');">
            ...
            <div class="dataContainer" style="margin-bottom: 0px">
                <div runat="server" id="modalMessageBoxRequeue" class="errorMsg" style="display: none;
                    width: 80%">
                    <p>
                        <img id="imgRequeueReasonMsg" width="16" height="13" align="middle" runat="server"
                            src="~/App_Themes/Default/Images/icon_error.png" />
                        <asp:Literal runat="server" ID="msgRequeueReasons" />
                    </p>
                </div>
            </div>
            <table width="100%" border="0" class="formGrid" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <asp:RadioButtonList ID="rdbtlstRequeueReasons" runat="server" CssClass="formGrid" />
                    </td>
                </tr>
            </table>
            <table width="100%" border="0" class="formGrid" cellpadding="0" cellspacing="0">
        ...
        <div id="light" class="overlay_message_content" style="width: 500px">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" RenderMode="inline"
                ...
                <ContentTemplate>
                    <p class="modalTitle">
                        ...
                        <a href="javascript:void(0)" onclick="hideModal('ModalRedirectReason');">
            ...
            <table width="100%" border="0" class="formGrid" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnRedirectContinue" runat="server" CssClass="primaryBtn floatR"
                            Text="Continue" CausesValidation="false" />
                        <input id="btnRedirectCancel" runat="server" type="button" name="Cancel" value="Cancel"
                            class='popWindowCancelbtn floatR' />
                    </td>
                </tr>
            </table>
