<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PostalCodeFormatList.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.PostalCodeFormatList" %>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" Cssclass="TITLELABELTEXT">PostalCodeFormat</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD vAlign="top" colSpan="2">
													<TABLE id="tblSearch" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; WIDTH: 98%; BORDER-BOTTOM: #999999 1px solid; HEIGHT: 45px"
												...
												<TD colSpan="3">
													<asp:datagrid id="Grid" runat="server" Width="100%" OnItemCommand="ItemCommand" OnItemCreated="ItemCreated"
														...
														<Columns>
															...
															<asp:BoundColumn HeaderText="Sample Format">
																<HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="40%"></HeaderStyle>
																<ItemStyle HorizontalAlign="Center"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn Visible="False" HeaderText="postal_code_format_id"></asp:BoundColumn>
														</Columns>
