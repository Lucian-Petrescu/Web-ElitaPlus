                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" rowspan="1" align="left">
                                        <asp:DropDownList ID="moProductDrop" TabIndex="4" runat="server" SkinID="SmallDropDown" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <td colspan="1" align="left">
                                        <asp:DropDownList ID="moCoverageTypeDrop" TabIndex="5" runat="server" SkinID="SmallDropDown" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="1" align="left">
                                        <asp:DropDownList ID="moRiskDrop" TabIndex="6" runat="server" SkinID="SmallDropDown" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" colspan="1">&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" align="left">
                                        <asp:TextBox ID="moItemNumberText" TabIndex="9" runat="server" SkinID="SmallTextBox" Enabled="False" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="5">
                                        ...
                                        <asp:Label ID="moIsNewRateLabel" runat="server" Visible="False"></asp:Label><input id="HiddenSaveChangesPromptResponse" type="hidden" name="HiddenSaveChangesPromptResponse" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="moOffsetText" TabIndex="11" runat="server" SkinID="exSmallTextBox" MaxLength="2"></asp:TextBox>
                                        <asp:Label ID="lblOffsetMonths" runat="server">MONTH(S)</asp:Label>
                                        <asp:TextBox ID="txtOffsetDays" TabIndex="40" runat="server" SkinID="exSmallTextBox" MaxLength="4"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="" colspan="1" align="left">
                                        <asp:TextBox ID="moEffectiveText" TabIndex="13" runat="server" AutoPostBack="true" SkinID="SmallTextBox"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="" colspan="1" align="left">
                                        <asp:TextBox ID="moClaimLimitCountText" TabIndex="15" AutoPostBack="true" runat="server" SkinID="SmallTextBox" Enabled="true"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 1px" width="1"></td>
                                    ...
                                    <td nowrap="" colspan="1" align="left">
                                        <asp:TextBox ID="moCovDeductibleText" TabIndex="15" AutoPostBack="true" runat="server" SkinID="SmallTextBox" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 1px" width="1"></td>
                                    ...
                                    <td style="height: 17px" nowrap="" align="left">
                                        <p>
                                            <asp:DropDownList ID="cboDeductibleBasedOn" TabIndex="18" runat="server" AutoPostBack='true' SkinID="SmallDropDown">
                                            </asp:DropDownList>
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" align="left">
                                        <asp:TextBox ID="moCoveragePricingText" runat="server" SkinID="SmallTextBox" Enabled="False" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 1px" width="1"></td>
                                    ...
                                    <td style="height: 17px" align="left">
                                        <div id="currTextBoxDiv" runat="server">
                                            <asp:TextBox ID="TextBoxCurrencyOfCoverage" runat="server" SkinID="SmallTextBox" Enabled="False" ReadOnly="True"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="height: 17px" colspan="1" align="left">
                                        <p>
                                            <asp:TextBox ID="moRetailText" TabIndex="20" runat="server" SkinID="SmallTextBox" Enabled="False" ReadOnly="True"></asp:TextBox>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
        ...
        <div id="tabs" class="style-tabs">
            ...
            <div id="tabsCoverageRate">
                <table id="tblOpportunities" class="dataGrid" border="0" rules="cols" width="98%">
                    <tr>
                        <td colspan="2">
                            <Elita:MessageController runat="server" ID="moMsgControllerRate" Visible="false"></Elita:MessageController>
                        </td>
                    </tr>
                    <tr>
                        <td align="Center" colspan="2">
                            <div id="scroller" style="overflow: auto; width: 96%; height: 125px" align="center">
                                <asp:GridView ID="moGridView" runat="server" OnRowCreated="ItemCreated" OnRowCommand="ItemCommand" AllowPaging="False" PageSize="50" AllowSorting="True" CellPadding="1" AutoGenerateColumns="False" SkinID="DetailPageGridView">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="moCOVERAGE_RATE_ID" Text='<%# GetGuidStringFromByteArray(Container.DataItem("COVERAGE_RATE_ID"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="True" HeaderText="Low_Price">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="moLowPriceLabel" Text='<%# GetAmountFormattedToVariableString(Container.DataItem("LOW_PRICE"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="High_Price">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moHigh_PriceLabel" Text='<%# GetAmountFormattedToVariableString(Container.DataItem("HIGH_PRICE"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="GROSS_AMT_NET">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moGross_AmtLabel" Text='<%# GetAmountFormattedToVariableString(Container.DataItem("GROSS_AMT"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Commission_Percent">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moCommission_PercentLabel" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("COMMISSIONS_PERCENT"), "N4")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Marketing_Percent">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moMarketing_PercentLabel" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("MARKETING_PERCENT"), "N4")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="ADMINISTRATIVE_EXPENSE">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moAdmin_ExpenseLabel" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("ADMIN_EXPENSE"), "N4")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Profit_Percent">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moProfit_ExpenseLabel" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("PROFIT_EXPENSE"), "N4")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Loss_Cost_Percent">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moLoss_Cost_PercentLabel" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("LOSS_COST_PERCENT"), "N4")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="GROSS_AMOUNT_PERCENTAGE">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moGross_Amount_PercentLabel" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("GROSS_AMOUNT_PERCENT"), "N4")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="RENEWAL_NUMBER">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moRenewal_NumberLabel" Text='<%# GetAmountFormattedToString(Container.DataItem("RENEWAL_NUMBER"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
            ...
            <div id="tabsDeductible">
                <table id="tblDeduct" border="0" class="dataGrid" rules="cols" width="98%">
                    <tr>
                        <td colspan="2">
                            <Elita:MessageController runat="server" ID="moMsgControllerDeductible" Visible="false"></Elita:MessageController>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            ...
                            <div id="scroller1" style="overflow: auto; width: 98%; height: 125px" align="center" runat="server">
                                <asp:GridView ID="dedGridView" runat="server" Width="97%" OnRowCreated="DeductibleItemCreated" OnRowCommand="DeductibleItemCommand" AllowPaging="False" PageSize="50" AllowSorting="True" CellPadding="1" AutoGenerateColumns="False" SkinID="DetailPageGridView">
                                    <SelectedRowStyle Wrap="false"></SelectedRowStyle>
                                    <EditRowStyle Wrap="false"></EditRowStyle>
                                    <AlternatingRowStyle Wrap="False"></AlternatingRowStyle>
                                    <RowStyle Wrap="false"></RowStyle>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="moCOVERAGE_DED_ID" Text='<%# GetGuidStringFromByteArray(Container.DataItem("COVERAGE_DED_ID"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="moMETHOD_OF_REPAIR_ID" Text='<%# GetGuidStringFromByteArray(Container.DataItem("METHOD_OF_REPAIR_ID"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="moDEDUCTIBLE_BASED_ON_ID" Text='<%# GetGuidStringFromByteArray(Container.DataItem("DEDUCTIBLE_BASED_ON_ID"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="True" HeaderText="Method_of_Repair">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moMethodOfRepair_Label" Text='<%# Container.DataItem("METHOD_OF_REPAIR")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Compute_Deductible_Based_On">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moDeductibleBasedOn_Label" Text='<%# Container.DataItem("DEDUCTIBLE_BASED_ON")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Deductible">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moLabelDeductible" Text='<%# GetAmountFormattedDoubleString(Container.DataItem("DEDUCTIBLE"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                    ...
                    <tr>
                        <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <asp:Button ID="btnCancel_Deductible" runat="server" SkinID="AlternateLeftButton" Text="Cancel"></asp:Button>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div id="tabsCoverageConseqDamage">
                <table id="tblCovConseqDamage" class="dataGrid" border="0" rules="cols" width="98%">
                    <tr>
                        <td colspan="2">
                            <Elita:MessageController runat="server" ID="moMsgControllerConseqDamage" Visible="false"></Elita:MessageController>
                        </td>
                    </tr>
                    <tr>
                        <td align="Center" colspan="2">
                            <div id="scrollerCovConseqDamage" style="overflow: auto; width: 96%; height: 125px" align="center">
                                <asp:GridView ID="moGridViewConseqDamage" runat="server" OnRowCommand="ConseqDamageRowCommand" AllowPaging="False" PageSize="50" AllowSorting="True" CellPadding="1" AutoGenerateColumns="False" SkinID="DetailPageGridView">
                                    <SelectedRowStyle Wrap="False"></SelectedRowStyle>
                                    <EditRowStyle Wrap="False"></EditRowStyle>
                                    <AlternatingRowStyle Wrap="False"></AlternatingRowStyle>
                                    <RowStyle Wrap="False"></RowStyle>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="moCoverageConseqDamageIdLabel" Text='<%# GetGuidStringFromByteArray(Container.DataItem("coverage_conseq_damage_id"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="LIABILITY_LIMIT_PER_INCIDENT">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moLiabilityLimitPerIncidentLabel" Text='<%# GetAmountFormattedToVariableString(Container.DataItem("liability_limit_per_incident"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="LIABILITY_LIMIT_CUMULATIVE">
                                            <ItemStyle HorizontalAlign="center"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="moLiabilityLimitCumulativeLabel" Text='<%# GetAmountFormattedToVariableString(Container.DataItem("LIABILITY_LIMIT_CUMULATIVE"))%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="Effective_Date">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="moConseqDamageEffectiveDateText" runat="server" Visible="True" SkinID="SmallTextBox"></asp:TextBox>
                                                <asp:ImageButton ID="btnConseqDamageEffectiveDate" runat="server" ImageUrl="~/App_Themes/Default/Images/calendar.png"></asp:ImageButton>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="True" HeaderText="Expiration_Date">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="moConseqDamageExpirationDateText" runat="server" Visible="True" SkinID="SmallTextBox"></asp:TextBox>
                                                <asp:ImageButton ID="btnConseqDamageExpirationDate" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png"></asp:ImageButton>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <tr>
                        <td colspan="2" width="96%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnNewConseqDamage_WRITE" runat="server" SkinID="AlternateLeftButton" Text="New"></asp:Button>&nbsp
        ...
        <table width="100%">
            <tr>
                <td width="60%">
                    ...
                    <asp:Button ID="btnUndo_WRITE" SkinID="AlternateLeftButton" runat="server" Text="UNDO"></asp:Button>
                    <asp:Button ID="btnDelete_WRITE" runat="server" SkinID="AlternateLeftButton" Text="Delete"></asp:Button>
                </td>
                <td width="30%" align="right">
                    <asp:Button ID="btnApply_WRITE" runat="server" SkinID="PrimaryLeftButton" Text="SAVE"></asp:Button>
                </td>
                <td width="10%"></td>
            </tr>
        </table>
    </div>
    <asp:HiddenField ID="hdnGrossAmtOrPercent" runat="server"></asp:HiddenField>
    <asp:HiddenField ID="hdnGrossAmtOrPercentValue" runat="server"></asp:HiddenField>
</asp:Content>
