<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AccountingCloseInfoForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.AccountingCloseInfoForm" %>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label40" runat="server" CssClass="TITLELABELTEXT">ACCOUNTING_CLOSING_DATES</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                             ...
                             <table>
                                <tr>                                   
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:Label ID="moYearLabel" runat="server" Visible="True">ACCOUNTING_CLOSE_YEAR</asp:Label>:
                                                        ...
                                                        <td nowrap>
                                                            <asp:DataGrid ID="moDataGrid" runat="server" Width="100%" PageSize="12" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn SortExpression="Closing_Date" HeaderText="CLOSING_DATE">
