...
#Region "Controlling Logic"
    ...
    Public Sub PopulateGrid()
        ...
        SetPageAndSelectedIndexFromGuid(State.searchDV, State.CompanyGroupId, Grid, State.PageIndex)
        SortAndBindGrid()
    End Sub
...
#Region " Datagrid Related "
    ...
    Public Sub ItemCommand(source As System.Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        Try
            If e.CommandName = "SelectAction" Then
                ...
                State.CompanyGroupId = New Guid(Grid.Rows(index).Cells(GRID_COL_COMPANY_GROUP_IDX).Text)
                'UpdateUserCompany()
                callPage(CoverageByCompanyGroupForm.URL, State.CompanyGroupId)
            End If
    ...
    Private Sub Grid_PageIndexChanged(source As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles Grid.PageIndexChanging
        Try
            ...
            State.CompanyGroupId = Guid.Empty
            PopulateGrid()
        Catch ex As Exception
            HandleErrors(ex, ErrorCtrl)
        End Try
...
#Region " Button Clicks "
    ...
    Private Sub btnAdd_WRITE_Click(sender As System.Object, e As System.EventArgs) Handles btnAdd_WRITE.Click
        'UpdateUserCompany()
        callPage(CoverageByCompanyGroupForm.URL)
    End Sub
