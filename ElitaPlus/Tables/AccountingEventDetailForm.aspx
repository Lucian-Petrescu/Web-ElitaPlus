                                ...
                                <asp:GridView ID="moGridView" runat="server" OnRowCreated="ItemCreated" OnRowCommand="ItemCommand" AllowPaging="False" AllowSorting="false" CellPadding="1" AutoGenerateColumns="False" SkinID="DetailPageGridView" Width="100%">
                                    ...
                                    <Columns>
                                        <asp:TemplateField Visible="True" HeaderText="DEALER">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDealer" Text='<%# DataBinder.Eval(Container.DataItem, "DealerDescription")%>' runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemStyle HorizontalAlign="Center" Width="30px"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:ImageButton Style="cursor: hand;" ID="DeleteButton_WRITE" ImageUrl="../Navigation/images/icon_delete.png" runat="server" CommandName="DeleteRecord" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>'>
                                                </asp:ImageButton>
                                            </ItemTemplate>
                                            <EditItemTemplate>
