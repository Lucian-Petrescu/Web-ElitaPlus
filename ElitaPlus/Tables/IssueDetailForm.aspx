                                        ...
                                        <td valign="top">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="moCodeText" runat="server" Width="80%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:TextBox>
                                                    </td>
                                                    <td nowrap="" align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="moDescriptionText" runat="server" Width="80%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:TextBox>
                                                    </td>
                                                    <td nowrap="" align="right">
                                                        <asp:Label ID="moEffectiveDateLabel" runat="server">EFFECTIVE_DATE</asp:Label>&nbsp;
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="moEffectiveDateText" runat="server" CssClass="FLATTEXTBOX" TabIndex="2" Width="175px"></asp:TextBox>
                                                        &nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="moAsOfDateText" runat="server" Width="80%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False" Enabled="false"></asp:TextBox>
                                                    </td>
                                                    <td nowrap="" align="right">
                                                        <asp:Label ID="moExpirationDateLabel" runat="server">EXPIRATION_DATE</asp:Label>&nbsp;
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="moExpirationDateText" runat="server" CssClass="FLATTEXTBOX" TabIndex="2" Width="175px"></asp:TextBox>
                                                        &nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="moPreConditionsTextBox" runat="server" Width="80%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:TextBox>
                                                    </td>
                                                      <td nowrap="" align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="moClaimValueTextBox" runat="server" Width="80%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:TextBox>
                                                    </td>
                                        ...
                                        <td valign="middle" align="left">
                                            ...
                                            <div id="tabs" class="style-tabs-old" style="border:none;">
                                                ...
                                                <div id="tabQuestions" style="background:#d5d6e4">
                                                    <asp:Panel ID="PanelQuestionsEditDetail" runat="server" Width="100%" Height="100%">
                                                        <div id="commentScroller" align="center" style="overflow: auto; width: 99.53%; height: 100%">
                                                            <table id="tblCommentDetail" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 100%; height: 100%"><tr><td align="left" valign="top"><ur2:UserControlQuestionsAvailable ID="UserControlQuestionsAvailable" runat="server" tabindex="12"></ur2:UserControlQuestionsAvailable></td></tr>
                                                            </table>
                                                        </div>
                                                    </asp:Panel>
                                                ...
                                                <div id="tabRules" style="background:#d5d6e4">
                                                    <asp:Panel ID="PanelRulesEditDetail" runat="server" Width="100%" Height="100%"><div id="Div1" align="center" style="overflow: auto; width: 99.53%; height: 100%"><table id="Table2" background="" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 100%; height: 100%"><tr><td align="left" valign="top"><url:UserControlRulesAvailable ID="UserControlRulesAvailable" runat="server" background="#d5d6e4" tabindex="12"></url:UserControlRulesAvailable></td></tr></table></div>
                                                    ...
                                                    <asp:Panel ID="plnQueue" runat="server" Width="100%" Height="100%"><div id="Div2" align="center" style="overflow: auto; width: 99.53%; height: 100%">
                                                                ...
                                                                <ur3:UCAvailableSelected ID="UC_QUEUE_AVASEL" runat="server" tabindex="12"></ur3:UCAvailableSelected>
                                                                        ...
                                                                        <tr><td style="vertical-align: top; text-align: left;">&nbsp;&nbsp;
                                                                            ...
                                                                            cursor: hand; background-repeat: no-repeat" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Save"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btnCancel_WQ" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif);
                                                                            cursor: hand; background-repeat: no-repeat" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Cancel"></asp:Button>
                                                                        </td></tr>
                                                                        </table>
                                                                </div></asp:Panel>
                                                </div>
                        ...
                        <tr>
                            <td valign="bottom" nowrap="" align="left" height="20">
                                ...
                                <asp:Button ID="btnNew_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                    cursor: hand; background-repeat: no-repeat" TabIndex="200" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="New"></asp:Button>&nbsp;
                                <asp:Button ID="btnCopy_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                    cursor: hand; background-repeat: no-repeat" TabIndex="205" runat="server" Width="90px" Height="20px" CssClass="FLATBUTTON" Text="NEW_WITH_COPY" CausesValidation="False">
                                </asp:Button>&nbsp;
                                <asp:Button ID="btnDelete_WRITE" Style="background-image: url(../Navigation/images/icons/clear_icon.gif);
                                    cursor: hand; background-repeat: no-repeat" TabIndex="210" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Delete"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
