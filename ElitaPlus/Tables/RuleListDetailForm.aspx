...
<body leftmargin="0" topmargin="0" onload="changeScrollbarColor();" border="0" ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        ...
        <!--d5d6e4-->
        <table id="tblOuter2" style="border: black 1px solid; margin: 5px;" height="93%" cellspacing="0" cellpadding="0" rules="none" width="98%" bgcolor="#d5d6e4" border="0">
            <tr>
                <td>&nbsp;
                </td>
            </tr>
                                                ...
                                                <td style="vertical-align:bottom;" align="left" colspan="2">
                                                    ...
                                                    <div id="tabs" class="style-tabs-old style-tabs-oldBG" style="border: none;">
                                                            ...
                                                            <table id="tblCommentDetail" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 97%; height: 100%">
                                                                <tr>
                                                                    <td align="left" style="vertical-align:top;">
                                                                        <ur2:UserControlQuestionsAvailable ID="UC_AvaSel_Rule" runat="server" tabindex="12"></ur2:UserControlQuestionsAvailable>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                        <div id="tabDealer" style="background: #d5d6e4">
                                                            <table id="tblDealer" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 97%; height: 100%">
                                                                <tr>
                                                                    <td align="left" style="vertical-align:top;">
                                                        ...
                                                        <div id="tabCompany" style="background: #d5d6e4">
                                                            <table id="Table3" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 97%; height: 100%">
                                                                <tr>
                                                                    <td align="left" style="vertical-align:top;">
