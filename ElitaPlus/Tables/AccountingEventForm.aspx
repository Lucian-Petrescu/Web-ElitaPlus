...
<asp:Content ContentPlaceHolderID="ContentPanelMainContentBody" runat="server">
    ...
    <table id="Table1" style="width: 100%; height: 168px" cellspacing="1" cellpadding="0" width="100%" border="0">
        <tr>
            ...
            <td>
                &nbsp;
                <asp:DropDownList ID="moAccountingCompanyDropDown" Width="246px" AutoPostBack="false" runat="server">
                </asp:DropDownList>
            </td>
            <td class="LABELCOLUMN">
            </td>
        ...
        <tr>
            ...
            <td>
                &nbsp;
                <asp:DropDownList ID="moAllowPostToSuspendedDDL" Width="246px" AutoPostBack="false" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                &nbsp;
                <asp:DropDownList ID="moSuppressSubstitutedMessagesDDL" Width="246px" AutoPostBack="false" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="4">
                <div id="tabs" class="style-tabs-old" style="border:none;">
                  ...
                  <div id="tabsLineItems" style="background:#d5d6e4">
                    <asp:DataGrid ID="moAccountingEventGrid" runat="server" AllowSorting="True" AllowPaging="True" CellPadding="1" BorderColor="#999999" BackColor="#DEE3E7" BorderWidth="1px" BorderStyle="Solid" AutoGenerateColumns="False" Width="100%">
                            ...
                            <Columns>
                                <asp:TemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton Style="cursor: hand;" ID="btnEdit" ImageUrl="../Navigation/images/icons/edit2.gif" runat="server" CommandName="SelectAction"></asp:ImageButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn>
...
<asp:Content ContentPlaceHolderID="ContentPanelButtons" runat="server">
    <asp:Button ID="btnBack" Style="background-image: url(../Navigation/images/icons/back_icon.gif);
        cursor: hand; background-repeat: no-repeat" TabIndex="185" runat="server" Width="90px" Font-Bold="false" CssClass="FLATBUTTON" Height="20px" Text="Back"></asp:Button>&nbsp;
    <asp:Button ID="btnSave_WRITE" Style="background-image: url(../Navigation/images/icons/save_icon.gif);
        cursor: hand; background-repeat: no-repeat" TabIndex="190" runat="server" Width="90px" Font-Bold="false" CssClass="FLATBUTTON" Height="20px" Text="Save"></asp:Button>&nbsp;
    <asp:Button ID="btnUndo_Write" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif);
        cursor: hand; background-repeat: no-repeat" TabIndex="195" runat="server" Width="90px" Font-Bold="false" CssClass="FLATBUTTON" Height="20px" Text="Undo"></asp:Button>&nbsp;
    <asp:Button ID="btnDelete_WRITE" Style="background-image: url(../Navigation/images/icons/clear_icon.gif);
        cursor: hand; background-repeat: no-repeat" TabIndex="210" runat="server" Width="116px" Font-Bold="false" CssClass="FLATBUTTON" Height="20px" Text="Delete"></asp:Button>
...
tton ID="btnCopy_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
