<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Navigation/masters/content_default.Master"
    CodeBehind="LanguageForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.LanguageForm" %>
        ...
        <tr>
            <td colspan="4" style="text-align: center; width: 100%">
                <table cellpadding="4" cellspacing="0" border="0" style="border: #999999 1px solid;
                    ...
                    <tr>
                        <td style="text-align: right; white-space: nowrap; vertical-align: middle; width: 1%">
                            <asp:Label ID="CultureLabel" runat="server">CULTURE</asp:Label>:&nbsp;
                        </td>
                        <td style="text-align: Left; white-space: nowrap; vertical-align: middle; width: 20%">
                            <asp:TextBox ID="SearchCultureTextBox" runat="server" Width="99px" AutoPostBack="False"
                                CssClass="FLATTEXTBOX"></asp:TextBox>
                        </td>
                        <td style="text-align: right; white-space: nowrap; vertical-align: middle; width: 1%">
                            <asp:Label ID="TerritoryLabel" runat="server">TERRITORY</asp:Label>:
                        </td>
                        <td style="text-align: left; white-space: nowrap; vertical-align: middle; width: 40%">
                            <asp:TextBox ID="SearchTerritoryTextBox" runat="server" Width="20%" AutoPostBack="False"
                                CssClass="FLATTEXTBOX"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr>
                ...
                <asp:GridView ID="Grid" runat="server" Width="100%" OnRowCreated="RowCreated" OnRowCommand="RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="moLanguageId" Text='<%# GetGuidStringFromByteArray(Container.DataItem("LANGUAGE_ID")) %>'
                                    runat="server">
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField Visible="True" HeaderText="CULTURE">
                            <ItemStyle HorizontalAlign="Left" Width="15%"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="moCultureLabel" Text='<%#Container.DataItem("CULTURE_CODE")%>' runat="server">
                                </asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="moCultureText" runat="server" Visible="True" Width="35%"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField Visible="True" HeaderText="TERRITORY">
                            <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="moTerritoryLabel" Text='<%#Container.DataItem("TERRITORY")%>' runat="server">
                                </asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="moTerritoryText" runat="server" Visible="True" Width="75%"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                    </Columns>
