                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="moEffectiveDateText" runat="server" CssClass="FLATTEXTBOX" TabIndex="2" Width="176px"></asp:TextBox>
                                                            &nbsp;
                                    ...
                                    <tr>
                                        <td valign="middle" align="left" colspan="2">
                                            ...
                                            <div id="tabs" class="style-tabs-old" style="border:none;">
                                              <ul>
                                                <li><a href="#tabQuestion" rel="noopener noreferrer"><asp:Label ID="Label4" runat="server" CssClass="tabHeaderTextOld">Question</asp:Label></a></li>
                                                <li><a href="#tabDealer" rel="noopener noreferrer"><asp:Label ID="Label6" runat="server" CssClass="tabHeaderTextOld">Dealer</asp:Label></a></li>
                                              </ul>
                                                            ...
                                                            <table id="tblCommentDetail" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 100%; height: 100%">
                                                                <tr>
                                                                    <td align="left" valign="top">
                                                                        <ur2:UserControlQuestionsAvailable ID="UserControlQuestionsAvailable" runat="server" tabindex="12">
                                              ...
                                              <div id="tabDealer" style="background:#d5d6e4">
                                                  <asp:Panel ID="PanelDealerEditDetail" runat="server" Width="100%" Height="100%">
                                                        <div id="Div1" align="center" style="overflow: auto; width: 99.53%; height: 100%">
                                                            <table id="Table2" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 100%; height: 100%">
                                                                <tr>
                                                                    <td align="left" valign="top">
