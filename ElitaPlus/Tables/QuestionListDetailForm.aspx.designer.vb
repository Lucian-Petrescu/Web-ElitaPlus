...
Namespace Tables
    ...
    Partial Public Class QuestionListDetailForm
        ...
        '''<summary>
        '''PanelDealerEditDetail control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents PanelDealerEditDetail As Global.System.Web.UI.WebControls.Panel
        
        '''<summary>
        '''UserControlDealerAvailable control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents UserControlDealerAvailable As Global.Assurant.ElitaPlus.ElitaPlusWebApp.SearchAvailableDealer
