...
<asp:Content ID="Content2" ContentPlaceHolderID="SummaryPlaceHolder" runat="server">
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" border="0" class="formGrid"
        ...
        <tr>
            ...
            <td style="width: 23%;">&nbsp;
                    <asp:TextBox ID="TextboxStartDate_WRITE" TabIndex="3" runat="server" SkinID="MediumTextBox"
                        Width="150px"></asp:TextBox>
                <asp:ImageButton ID="ImageButtonStartDate" ImageAlign="AbsMiddle" runat="server"
            ...
            <td style="width: 25%;">&nbsp;
                    <asp:TextBox ID="TextboxEndDate_WRITE" TabIndex="9" runat="server" SkinID="MediumTextBox"
                        Width="150px"></asp:TextBox>
        ...
        <tr>
            ...
            <td style="width: 23%;">&nbsp;
                    <asp:DropDownList ID="cboContractType" TabIndex="4" runat="server" SkinID="SmallDropDown"
                        Width="179px">
                    </asp:DropDownList>
            </td>
            ...
            <td style="width: 25%;">&nbsp;
                    <asp:DropDownList ID="cboPolicyType" TabIndex="4" runat="server" SkinID="ExtraSmallDropDown" AutoPostBack="True"
                        Width="179px">
                    </asp:DropDownList>
            </td>
        </tr>
         ...
         <tr>
            ...
            <td style="width: 25%;">&nbsp;
                    ...
                    <asp:DropDownList ID="cboCollectivePolicyGeneration" TabIndex="4" runat="server" SkinID="SmallDropDown"
                      AutoPostBack="True"  Width="179px">
                    </asp:DropDownList>
            </td>
          </tr>
        ...
        <tr>
            ...
            <td style="width: 25%;">&nbsp;
                    <asp:DropDownList ID="cboLineOfBusiness" TabIndex="4" runat="server" SkinID="SmallDropDown" AutoPostBack="True" 
                        Width="179px">
                    </asp:DropDownList>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboReplacementPolicy" TabIndex="5" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="false" onchange="showRepPolicyClaimCnt();">
                    </asp:DropDownList>
            </td>
            ...
            <td>&nbsp;&nbsp;<asp:TextBox ID="TextboxPolicyNumber" TabIndex="10" runat="server" SkinID="MediumTextBox"
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtReplacementPolicyCliamCount" runat="server" SkinID="MediumTextBox"
                        Width="178px" MaxLength="2"></asp:TextBox>
            </td>
             <td align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxLayout" TabIndex="11" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboCancellationReason" TabIndex="6" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxFullRefundDays" TabIndex="12" runat="server" SkinID="MediumTextBox"
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboAcctBusinessUnit" TabIndex="6" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="False">
                    </asp:DropDownList>
            </td>
            <td align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtAuthorizedAmountMaxUpdates" TabIndex="12" runat="server" SkinID="MediumTextBox"
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtDaysToReportClaim" TabIndex="7" runat="server" SkinID="MediumTextBox"
                        Width="178px" MaxLength="3"></asp:TextBox>
            </td>
            <td align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtNumOfClaims" TabIndex="12" runat="server" SkinID="MediumTextBox"
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtPenaltyPct" runat="server" SkinID="MediumTextBox" TabIndex="8"
                        Width="178px"></asp:TextBox>
            </td>
            <td align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtNumOfRepairClaims" TabIndex="12" runat="server" SkinID="MediumTextBox"
        ...
        <tr>
            ...
            <td>&nbsp
                    ...
                    <asp:TextBox ID="txtbxDaysToReactivate" TabIndex="12" runat="server" SkinID="MediumTextBox"
                        Width="178px" />
            </td>
            <td align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtNumOfReplClaims" TabIndex="12" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboReplacementBasedOn" TabIndex="13" runat="server" Width="179px"
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboCovDeductible" TabIndex="139" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxRepairDiscountPct" TabIndex="22" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboDeductibleBasedOn" TabIndex="140" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxReplacementDiscountPct" TabIndex="23" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDeductible" TabIndex="141" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboCURRENCY_OF_COVERAGES" TabIndex="24" runat="server" Width="179px"
                        SkinID="SmallDropDown">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDeductiblePercent" TabIndex="142" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboCURRENCY_CONVERSION" TabIndex="25" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboDeductible_By_Manufacturer" TabIndex="143" runat="server"
                        SkinID="SmallDropDown" Width="179px">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxMinRepCost" TabIndex="144" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxWaitingPeriod" TabIndex="145" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboFixedEscDurationFlag" TabIndex="28" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
            <td align="right">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboIgnoreWaitingPeriodWhen_WSD_Equal_PSD" TabIndex="146" runat="server"
                        Width="179px" SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxWarrantyMaxDelay" TabIndex="147" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboDealerMarkup_WRITE" TabIndex="30" runat="server" Width="179px"
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextBoxRemainingMFGDays" TabIndex="148" runat="server" SkinID="MediumTextBox"
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboRestrictMarkup_WRITE" TabIndex="31" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboFundingSource" TabIndex="149" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="ddlAllowCoverageMarkupDistribution" TabIndex="171" runat="server"
                        Width="179px" SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboClaimControlID" TabIndex="32" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboRecurringPremium" TabIndex="33" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboTypeOfMarketing" TabIndex="151" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboIncludeFirstPmt" TabIndex="34" runat="server" Width="179px"
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboTypeOfEquipment" TabIndex="152" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtFirstPaymentMonths" TabIndex="35" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtPeridiocBillingWarntyPeriod" TabIndex="35" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDaysToSuspend" TabIndex="36" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
            <td valign="middle" align="right">
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDaysToCancel" TabIndex="37" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboNetCommission" TabIndex="155" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboExtendCoverage" TabIndex="38" SkinID="SmallDropDown" runat="server"
                        Width="179px" onchange="showExtendCovField();">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboNetMarketing" TabIndex="156" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td style="white-space: nowrap">&nbsp;
                    <asp:TextBox ID="txtExtendCoverageByExtraMonths" TabIndex="39" runat="server" SkinID="MediumTextBox"
                        MaxLength="2" Width="35px"></asp:TextBox>
                <asp:Label ID="lblExtendCoverageByExtraMonths" runat="server">MONTH(S)</asp:Label>
                <asp:TextBox ID="txtExtendCoverageByExtraDays" TabIndex="40" runat="server" SkinID="MediumTextBox"
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboIsCommPCodeId" TabIndex="157" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboPayOutstandingAmount" TabIndex="39" runat="server" Width="179px"

                        SkinID="SmallDropDown">
                    </asp:DropDownList>
                <asp:DropDownList ID="ddlAllowPymtSkipMonths" TabIndex="39" runat="server" Width="179px"
                    SkinID="SmallDropDown">
                </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
        ...
        <tr>
            ...
            <td style="width: 25%; height: 8px">&nbsp;
                    <asp:DropDownList ID="cboAutoSetLiability" TabIndex="41" runat="server" Width="179px"
                        SkinID="SmallDropDown">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboID_VALIDATION" TabIndex="157" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboIgnorePremium" TabIndex="42" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboAcselProdCode" TabIndex="158" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="True">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboIgnoreCovAmt" TabIndex="43" runat="server" Width="179px"
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboBackEndClaimAllowed" TabIndex="159" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboAllowDifferentCoverage" TabIndex="159" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboInstallmentPayment" TabIndex="45" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="true">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDaysOfFirstPymt" TabIndex="160" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr id="moInstallmentBillingInformation0" runat="server">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDaysToSendLetter" TabIndex="46" runat="server" SkinID="MediumTextBox"
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxDaysToCancelCert" TabIndex="161" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr id="moInstallmentBillingInformation1" runat="server">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboBaseInstallments" TabIndex="47" runat="server" Width="179px"
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxMaxNumofInstallments" TabIndex="162" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr id="moInstallmentBillingInformation2" runat="server">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboBillingCycleFrequency" TabIndex="48" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxInstallmentsBaseReducer" TabIndex="163" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr id="moInstallmentBillingInformation3" runat="server">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtCollectionReAttempts" TabIndex="49" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtPastDueMonthsAllowed" TabIndex="164" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr id="moInstallmentBillingInformation4" runat="server">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboCollectionCycleType" TabIndex="50" runat="server" Width="179px"
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxOffsetBeforeDueDate" TabIndex="165" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr id="moInstallmentBillingInformation5" runat="server">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="TextboxCycleDay" TabIndex="51" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
        ...
        <tr>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtCLIPPct" TabIndex="166" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboEDIT_MFG_TERM" TabIndex="52" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="true">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtInsPremFactor" TabIndex="168" runat="server" SkinID="MediumTextBox"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboOverrideEditMfgTerm" TabIndex="53" runat="server" Width="179px"
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboMarketingPromo" TabIndex="170" runat="server" SkinID="SmallDropDown"
                        Width="179px">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboAllowNoExtended" TabIndex="54" runat="server" Width="179px"
                        SkinID="SmallDropDown" AutoPostBack="true">
                    </asp:DropDownList>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboAllowMultipleRejections" TabIndex="170" runat="server" SkinID="SmallDropDown"
                        Width="179px">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboProRataMethodId" TabIndex="171" runat="server" AutoPostBack="true"
                        Width="179px" SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboCustAddressRequired" TabIndex="56" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="ddlDailyRateBasedOn" TabIndex="56" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="cboFutureDateAllowFor" TabIndex="57" runat="server" Width="179px"
                        SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
            <td valign="middle" align="right">
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="ddlAllowBillingAfterCancellation" TabIndex="171" runat="server"
                        Width="179px" SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
           ...
           <td>&nbsp;
            ...
            <td>&nbsp;
                    <asp:DropDownList ID="ddlAllowCollectionAfterCancellation" TabIndex="171" runat="server"
                        Width="179px" SkinID="SmallDropDown">
                    </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp
                    <asp:TextBox ID="txtRdoName" runat="server" SkinID="MediumTextBox"
                        Width="178px" />
            </td>
        ...
        <tr>
            ...
            <td>&nbsp
                     <asp:TextBox ID="txtRdoPercent" runat="server" SkinID="MediumTextBox"
                         Width="178px" />
            </td>
            ...
            <td>&nbsp
                    <asp:TextBox ID="txtThirdPartyName" runat="server" SkinID="MediumTextBox" Visible="False"
                        Width="178px" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>&nbsp
                   <asp:TextBox ID="txtRdoTaxId" runat="server" SkinID="MediumTextBox"
                       Width="178px"></asp:TextBox>
            </td>
            ...
            <td>&nbsp;
                    <asp:TextBox ID="txtThirdPartyTaxId" runat="server" SkinID="MediumTextBox" Visible="False"
                        Width="178px"></asp:TextBox>
            </td>
        </tr>
    </table>

    <table id="Table3" cellspacing="0" cellpadding="0" width="100%" border="0" class="formGrid"
        style="padding: 0px; margin: 0px">
        <tr>
        ...
        <tr>
            ...
            <td style="height: 19px" width="16.66%">&nbsp;
                    <asp:TextBox ID="TextboxRatingPlan" TabIndex="275" runat="server" Width="60px" SkinID="MediumTextBox"
            ...
            <td style="height: 19px" width="16.66%">&nbsp;
                    <asp:DropDownList ID="cboCOINSURANCE" TabIndex="276" runat="server" Width="70px"
                        SkinID="SmallDropDown" onchange="SetCodeDropDownValue();">
                    </asp:DropDownList>
            </td>
            <td style="height: 19px" align="right" width="16.66%">
            ...
            <td style="height: 19px" width="16.66%">&nbsp;
                    <asp:TextBox ID="TextboxPARTICIPATION_PERCENT" TabIndex="277" runat="server" Width="60px"
                        SkinID="MediumTextBox"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="4" class="borderLeft">
                <asp:DropDownList ID="cboCOINSURANCE_Code" TabIndex="278" runat="server" Width="64px"
                    SkinID="SmallDropDown">
                </asp:DropDownList>
            </td>
        </tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
                                    ...
                                    <asp:GridView ID="moGridView" runat="server" OnRowCreated="ItemCreated" OnRowCommand="ItemCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField Visible="True" HeaderText="CERTIFICATE_DURATION" ItemStyle-Width="20%">
                                                <ItemStyle HorizontalAlign="center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCertDuration" Text='<%# DataBinder.Eval(Container.DataItem, "CertDuration")%>'
                                                        runat="server">
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                            ...
                                            <asp:TemplateField Visible="True" HeaderText="REPLACEMENT_POLICY_CLAIM_COUNT" ItemStyle-Width="20%">
                                                <ItemStyle HorizontalAlign="center"></ItemStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblClaimCount" Text='<%# DataBinder.Eval(Container.DataItem, "ReplacementPolicyClaimCount")%>'
                                                        runat="server">
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <div id="scrollerDepreciationSchedule" style="overflow: auto; width: 96%; height: 125px" align="center">
                                <asp:GridView ID="GridViewDepreciationSchedule" runat="server" OnRowCreated="GridViewDepreciationSchedule_RowCreated" OnRowCommand="GridViewDepreciationSchedule_RowCommand"
                                    ...
                                    <Columns>
                                        <asp:TemplateField Visible="True" HeaderText="DEPRECIATION_SCHEDULE">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblDepreciationSchedule" Text='<%# DataBinder.Eval(Container.DataItem, "DepreciationScheduleCode")%>'
                                                    runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField Visible="True" HeaderText="EFFECTIVE_DATE">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEffectiveDate" runat="server" Visible="True" SkinID="SmallTextBox" />
                                                <asp:ImageButton ID="btnEffectiveDate" runat="server" ImageUrl="~/App_Themes/Default/Images/calendar.png" />
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="True" HeaderText="EXPIRATION_DATE">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtExpirationDate" runat="server" Visible="True" SkinID="SmallTextBox" />
                                                <asp:ImageButton ID="btnExpirationDate" runat="server" ImageUrl="~/App_Themes/Default/Images/calendar.png" />
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField Visible="True" HeaderText="DEPRECIATION_SCHEDULE_USAGE">
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblDepreciationScheduleUsage" Text='<%# DataBinder.Eval(Container.DataItem, "DepreciationScheduleUsage")%>'
                                                    runat="server">
                                                </asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
    ...
    <div class="btnZone">
        ...
        <asp:Button ID="btnCopy_WRITE" runat="server" SkinID="AlternateLeftButton" Text="NEW_WITH_COPY"
