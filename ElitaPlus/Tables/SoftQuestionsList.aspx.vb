...
#Region "Page Controls"
    ...
    Protected WithEvents NodeModifyPanel As Panel
    Protected WithEvents lbSoftQuestionGroup As Label
...
#Region "Page State"
    ...
    Protected Shadows ReadOnly Property State() As MyState
        Get
            If Me.NavController IsNot Nothing Then
...
#Region "PageEvents"
    ...
    Function isNavStateSet() As Boolean
        If Me.NavController IsNot Nothing Then
            If Me.NavController.State IsNot Nothing Then
...
#Region "Button Handlers"
    ...
    Private Sub GetGroupNode(SelectedNode As TreeNode, ByRef blnIsRoot As Boolean, ByRef GroupNode As TreeNode)
        Dim rootNode As TreeNode = tvQuestion.Nodes(0)
    ...
    Private Function FindSelectedNode(objStart As TreeNode, ByRef objSelectedNode As TreeNode) As Boolean
        Dim objNode As TreeNode, blnFound As Boolean = False
    ...
    Private Sub btnNew_WRITE_Click(sender As Object, e As EventArgs) Handles btnNew_WRITE.Click
        Try
            Dim parentNode As TreeNode = tvQuestion.SelectedNode
            Dim groupNode As TreeNode, blnIsRoot As Boolean
            ...
            Else
                ...
                cboSoftQuestionGroup.Items.Clear()
                cboSoftQuestionGroup.Items.Add(New WebControls.ListItem(groupNode.Text, groupid.ToString()))
    ...
    Private Sub btnModify_WRITE_Click(sender As Object, e As EventArgs) Handles btnModify_WRITE.Click
        Try
            cboSoftQuestionGroup.Items.Clear()
            ControlMgr.SetEnableControl(Me, cboSoftQuestionGroup, False)
            ControlMgr.SetEnableControl(Me, tvQuestion, False)

            Dim objNode As TreeNode = tvQuestion.SelectedNode
            ...
            Else
                ...
                Me.DisplayMessage(Message.MSG_CANNOTMODIFY_SOFTQUESTION, "", MSG_BTN_OK, MSG_TYPE_ALERT)
            End If
        ...
        Try
            ...
            ElseIf State.softQuestionAction = ACTION_NEW Then
                ...
                Else
                    FindSelectedNode(tvQuestion.Nodes(0), objNode)
                End If
                Dim obj As TreeNode = New TreeNode(strSoftQuestion, State.SoftQuestionBO.Id.ToString & "|" & State.SoftQuestionBO.SoftQuestionGroupId.ToString & "|0")
        ...
        Try
            ...
            If objNode.Value <> tvQuestion.Nodes(0).Value Then
                ...
                If intChildCnt = 0 Then
                    ...
                    objSQ.Delete()
                    objSQ.Save()
                    Dim parentNode As TreeNode = objNode.Parent
