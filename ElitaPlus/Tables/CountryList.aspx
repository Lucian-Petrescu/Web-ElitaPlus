<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CountryList.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.CountryList" MasterPageFile="../Navigation/masters/ElitaBase.Master"
    Theme="Default" %>
        ...
        <tr>
            <td align="left" style="height: 40 px" width="30%" nowrap="nowrap">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="LabelDescription" runat="server">Description:</asp:Label><br />
                            <asp:TextBox ID="TextboxDescription" runat="server" SkinID="MediumTextBox" AutoPostBack="False"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="LabelCode" runat="server">Code:</asp:Label><br />
                            <asp:TextBox ID="TextboxCode" runat="server" SkinID="MediumTextBox" AutoPostBack="False"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <div class="dataContainer">
        <h2 class="dataGridHeader">
            <asp:Label runat="server" ID="moSearchResultsHeader">SEARCH_RESULTS_FOR_COUNTRY</asp:Label>
        </h2>
        <div>
        ...
        <div style="width: 100%">
            <asp:GridView ID="Grid" runat="server" Width="100%" OnRowCreated="RowCreated" OnRowCommand="RowCommand"
                ...
                <Columns>
                    <asp:TemplateField SortExpression="CODE" HeaderText="Country Code">
                    ...
                    <asp:TemplateField SortExpression="DESCRIPTION" HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField Visible="False" HeaderText="country_id"></asp:TemplateField>
                </Columns>
