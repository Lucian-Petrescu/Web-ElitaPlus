                                                ...
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlRuleType" runat="server" AutoPostBack="True"
                                                                CssClass="FLATTEXTBOX_TAB" Width="80%">
                                                            </asp:DropDownList>
                                                            &nbsp;</td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;<asp:TextBox ID="moDescriptionText" runat="server" AutoPostBack="False"
                                                                CssClass="FLATTEXTBOX_TAB" Width="80%"></asp:TextBox>
                                                            </td>
                                                            <td nowrap align="right">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="moEffectiveDateText" runat="server" CssClass="FLATTEXTBOX"
                                                                    TabIndex="2" Width="170px"></asp:TextBox>
                                                                &nbsp;<asp:ImageButton ID="imgEffectiveDate" runat="server"
                                                                    ImageUrl="../Common/Images/calendarIcon2.jpg" TabIndex="2" Visible="True" />
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;<asp:DropDownList ID="ddlRuleCategory" runat="server" AutoPostBack="True"
                                                                CssClass="FLATTEXTBOX_TAB" Width="80%">
                                                            </asp:DropDownList>
                                                                &nbsp;</td>
                                                            <td nowrap align="right">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="moExpirationDateText" runat="server" CssClass="FLATTEXTBOX"
                                                                    TabIndex="2" Width="170px"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;<asp:TextBox ID="moRuleExecutionPointText" runat="server"
                                                                AutoPostBack="False" CssClass="FLATTEXTBOX_TAB" Width="80%"></asp:TextBox>
                                                                &nbsp;</td>
                                                            <td nowrap align="right">&nbsp;
                                                            </td>
                                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td valign="middle" align="left" colspan="2">
                                                ...
                                                <div id="tabs" class="style-tabs-old" style="border: none;">
                                                    <ul>
                                                        <li style="background: #d5d6e4"><a href="#tabIssues">
                                                            <asp:Label ID="Label4" runat="server" CssClass="tabHeaderTextOld">Issues</asp:Label></a></li>
                                                        <li style="background: #d5d6e4"><a href="#tabProcesses">
                                                        ...
                                                        <table id="tblCommentDetail" border="0" cellpadding="2" cellspacing="2"
                                                            ...
                                                            <tr>
                                                                <td align="left" valign="top">
                                                                    <uc1:UserControlAvailableSelected ID="IssueAvailableSelected" runat="server" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                    <div id="tabProcesses" style="background: #d5d6e4">
                                                        <table id="Table2" border="0" cellpadding="2" cellspacing="2" rules="cols"
                                                            ...
                                                            <tr>
                                                                <td align="left" valign="top">
                                                                    <uc1:UserControlAvailableSelected ID="ProcessAvailableSelected" runat="server" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
