...
Namespace Tables
    ...
    '''<summary>
    '''EarningPatternCodeForm class.
    '''</summary>
    '''<remarks>
    '''Auto-generated class.
    '''</remarks>
    Partial Public Class EarningPatternCodeForm
        ...
        '''<summary>
        '''MaintainEarningCodeLabel control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents MaintainEarningCodeLabel As Global.System.Web.UI.WebControls.Label
