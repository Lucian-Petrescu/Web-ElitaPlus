...
<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Navigation/masters/content_default.Master"
    Codebehind="DeductByMfgForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.DeductByMfgForm"
   %>
        ...
        <tr>
            <td valign="top">
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td>
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                            ...
                                            <tr CssClass="stylerightalignment" >
                                                <td>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td nowrap align="left" style="width: 1%; vertical-align: middle">
                                                ...
                                                <td colspan="1"  class="stylerightalignment" style="text-align: right"   >
                    ...
                    <tr>
                        <TD style="WIDTH: 100%" colSpan="2" height="100%"><asp:DataGrid ID="Grid" runat="server" Width="100%" OnItemCommand="ItemCommand" OnItemCreated="ItemCreated"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn SortExpression="dealer_name" HeaderText="DEALER_NAME">
                                        ...
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="cboDealerInGrid" runat="server" style="width:195px; overflow:hidden">
                                            </asp:DropDownList>
                                        </EditItemTemplate>
                                    </asp:TemplateColumn> 
                                    <asp:TemplateColumn SortExpression="manufacturer_name" HeaderText="MANUFACTURER">
                                        ...
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="cboManufacturerInGrid" runat="server" style="width:135px; overflow:hidden">
                                            </asp:DropDownList>
                                        </EditItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn SortExpression="model" HeaderText="MODEL">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBoxGridModel" CssClass="FLATTEXTBOX_TAB" runat="server" MaxLength="30" style="width:155px; overflow:hidden"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateColumn>
                                   
                                    <asp:TemplateColumn HeaderText="DEDUCTIBLE" SortExpression="deductible" >
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center" Width="20%"></ItemStyle>
                                        <ItemTemplate>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBoxGridDeductible" CssClass="FLATTEXTBOX_TAB" runat="server" style="width:45px; overflow:hidden"
