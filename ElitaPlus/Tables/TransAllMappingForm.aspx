...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPanelMainContentBody" runat="server">
    ...
    <table cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="moLogEmailsTEXT" runat="server" TextMode="MultiLine" Height="50"
        ...
        <tr>
            <td colspan="2">
                ...
                <div id="tabs" class="style-tabs-old" style="border:none;">
                    ...
                    <li style="background:#d5d6e4"><a href="#tabsOutput"><asp:Label ID="Label4" runat="server" CssClass="tabHeaderTextOld">OUTPUT</asp:Label></a></li>
                    </ul>
