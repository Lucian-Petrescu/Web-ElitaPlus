...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <div class="dataContainer">
        ...
        <div id="tabs" class="style-tabs">
	        <ul>
		        <li><a href="#tab_Dealers"><asp:Label ID="lblDealersTab" runat="server" CssClass="tabHeaderText">DEALERS_TAB</asp:Label></a></li>
		        <li><a href="#tab_Templates"><asp:Label ID="lblTemplatesTab" runat="server" CssClass="tabHeaderText">TEMPLATES_TAB</asp:Label></a></li>
	        </ul>
            <div id="tab_Dealers">
            ...
            <div id="tab_Templates">
                <div class="Page" runat="server" style="height: 100%; overflow: auto">
                    <asp:GridView ID="TemplatesGrid" runat="server" Width="100%" OnRowCreated="Grid_RowCreated"
                        OnRowCommand="Grid_RowCommand" AllowPaging="True" AllowSorting="False" CellPadding="1"
                ...
                <br />
                <asp:Button ID="btnNewTemplate_WRITE" runat="server" CausesValidation="False" Text="NEW_TEMPLATE"
