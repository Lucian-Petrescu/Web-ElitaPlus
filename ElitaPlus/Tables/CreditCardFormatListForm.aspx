<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Navigation/masters/content_default.Master"
    CodeBehind="CreditCardFormatListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.CreditCardFormatListForm" %>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td align="left" valign="middle" colspan="2">
                                                    <asp:Label ID="moCreditCardTypesLabel" runat="server">CREDIT_CARD_TYPE</asp:Label>:&nbsp;
                                                    <asp:dropdownlist id="moCreditCardTypesDrop" runat="server" Width="60%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:dropdownlist>
                                                </td>
                                                <td align="left" valign="middle" colspan="2">
                                                    &nbsp;
                                                </td>
                ...
                <asp:GridView ID="Grid" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField Visible="False">
                            ...
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="moCreditCardFormatId" Text='<%# GetGuidStringFromByteArray(Container.DataItem("credit_card_format_id")) %>'
                                    runat="server">
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        
                        <asp:TemplateField SortExpression="Credit_Card_Type" HeaderText="Credit_Card_Type">
