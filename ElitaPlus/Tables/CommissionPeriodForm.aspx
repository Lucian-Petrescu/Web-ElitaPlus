...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
    ...
    <style type="text/css">
        .style-tabs-old .ui-widget-header{background: white; border:none;}
        .style-tabs-old {background-color:white;}
        .tabHeaderTextOld{font-size:12px; color:black; font-style:normal;}
    </style>
</asp:Content>
                ...
                <div class="Page" runat="server" id="moCommBreakPanel" style="display: block; height: 370px; overflow: auto">
                    ...
                    <asp:Panel ID="moDetailPanel_WRITE" runat="server" Visible="False">
                      <table width="100%" class="formGrid" border="0" style="padding: 0px; margin: 0px;">
                            ...
                            <table width="100%" class="formGrid" border="0" style="padding: 0px; margin: 0px">
                            <tr>
                                <td align="center" valign="middle" style="width: 55%; height: 11px">
                            ...
                            <tr>
                                <td valign="middle" style="width: 35%; height: 11px" align="right">
