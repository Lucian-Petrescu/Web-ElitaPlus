        ...
        Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
            ...
            Try
                If Not IsPostBack Then
                    SortDirection = Language.LanguageSearchDV.COL_NAME_CODE
        ...
        Public Sub RowCommand(source As System.Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs)
            ...
            Try
                ...
                If (e.CommandName = EDIT_COMMAND) Then
                    ...
                    State.LanguageID = New Guid(CType(Grid.Rows(index).Cells(GRID_COL_LANGUAGE_ID_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CODE_ID), Label).Text)
                    State.MyBO = New Language(State.LanguageID)
                    ...
                    SetFocusOnEditableFieldInGrid(Grid, GRID_COL_LANGUAGE_CODE_IDX, GRID_CTRL_NAME_LANGUAGE_CODE_TXT, index)
                ...
                If dvRow IsNot Nothing And Not State.searchDV.Count > 0 Then
                    ...
                    If itemType = ListItemType.Item Or itemType = ListItemType.AlternatingItem Or itemType = ListItemType.SelectedItem Then
                        ...
                        If (State.IsEditMode = True _
                                AndAlso State.LanguageID.ToString.Equals(GetGuidStringFromByteArray(CType(dvRow(Language.LanguageSearchDV.COL_NAME_LANGUAGE_ID), Byte())))) Then
                            CType(e.Row.Cells(GRID_COL_LANGUAGE_CODE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CODE_TXT), TextBox).Text = dvRow(Language.LanguageSearchDV.COL_NAME_DESCRIPTION).ToString
                            CType(e.Row.Cells(GRID_COL_DESCRIPTION_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_TXT), TextBox).Text = dvRow(Language.LanguageSearchDV.COL_NAME_CODE).ToString
                            CType(e.Row.Cells(GRID_COL_CULTURE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_TXT), TextBox).Text = dvRow(Language.LanguageSearchDV.COL_NAME_CULTURE).ToString
                            CType(e.Row.Cells(GRID_COL_TERRITORY_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_TXT), TextBox).Text = dvRow(Language.LanguageSearchDV.COL_NAME_TERRITORY).ToString

                        Else
                            CType(e.Row.Cells(GRID_COL_LANGUAGE_CODE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CODE_LABLE), Label).Text = dvRow(Language.LanguageSearchDV.COL_NAME_CODE).ToString
                            CType(e.Row.Cells(GRID_COL_DESCRIPTION_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_LABEL), Label).Text = dvRow(Language.LanguageSearchDV.COL_NAME_DESCRIPTION).ToString
                            CType(e.Row.Cells(GRID_COL_CULTURE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_LABEL), Label).Text = dvRow(Language.LanguageSearchDV.COL_NAME_CULTURE).ToString
                            CType(e.Row.Cells(GRID_COL_TERRITORY_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_LABEL), Label).Text = dvRow(Language.LanguageSearchDV.COL_NAME_TERRITORY).ToString
                        End If
...
#Region "Button click Handler"
        Protected Sub btnClearSearch_Click(sender As Object, e As EventArgs) Handles btnClearSearch.Click
            Try
                ...
                SearchCultureTextBox.Text = String.Empty
                SearchTerritoryTextBox.Text = String.Empty
                State.searchLanguageCode = String.Empty
                State.searchLanguageDescription = String.Empty
                State.SearchCulture = String.Empty
                State.SearchTerritory = String.Empty
        ...
        Protected Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
            Try
                With State
                    ...
                    .searchLanguageCode = SearchCodeTextBox.Text.Trim
...
#Region "Control"
        ...
        Private Sub DoDelete()
            ...
            Dim LanguageBO As Language = New Language(State.LanguageID)
...
#Region "Helper functions"
        ...
        Protected Sub BindBoPropertiesToGridHeaders()
            ...
            BindBOPropertyToGridHeader(State.MyBO, "Code", Grid.Columns(GRID_COL_LANGUAGE_CODE_IDX))
            BindBOPropertyToGridHeader(State.MyBO, "CultureCode", Grid.Columns(GRID_COL_CULTURE_IDX))
            BindBOPropertyToGridHeader(State.MyBO, "Territory", Grid.Columns(GRID_COL_TERRITORY_IDX))
            ...
            Try
                With State.MyBO
                    If (.Code IsNot Nothing) Then
                        CType(Grid.Rows(gridRowIdx).Cells(GRID_COL_LANGUAGE_CODE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CODE_TXT), TextBox).Text = .Code
                    End If
                    If (.Description IsNot Nothing) Then
                        CType(Grid.Rows(gridRowIdx).Cells(GRID_COL_DESCRIPTION_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_TXT), TextBox).Text = .Description
                    End If

                    If (.CultureCode IsNot Nothing) Then
                        CType(Grid.Rows(gridRowIdx).Cells(GRID_COL_CULTURE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CULTURE_TXT), TextBox).Text = .CultureCode
                    End If

                    If (.Territory IsNot Nothing) Then
                        CType(Grid.Rows(gridRowIdx).Cells(GRID_COL_TERRITORY_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_TERRITORY_TXT), TextBox).Text = .Territory
                    End If

                    CType(Grid.Rows(gridRowIdx).Cells(GRID_COL_LANGUAGE_ID_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CODE_ID), Label).Text = .Id.ToString
                End With
            Catch ex As Exception
                HandleErrors(ex, ErrControllerMaster)
            End Try
        ...
        Private Function PopulateBOFromForm() As Boolean
            ...
            With State.MyBO
                .Code = CType(Grid.Rows((Grid.EditIndex)).Cells(GRID_COL_LANGUAGE_CODE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CODE_TXT), TextBox).Text.Trim.ToUpper
                .Description = CType(Grid.Rows((Grid.EditIndex)).Cells(GRID_COL_DESCRIPTION_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_DESCRIPTION_TXT), TextBox).Text.Trim
                .CultureCode = CType(Grid.Rows((Grid.EditIndex)).Cells(GRID_COL_CULTURE_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_CULTURE_TXT), TextBox).Text.Trim
                .Territory = CType(Grid.Rows((Grid.EditIndex)).Cells(GRID_COL_TERRITORY_IDX).FindControl(GRID_CTRL_NAME_LANGUAGE_TERRITORY_TXT), TextBox).Text.Trim.ToUpper
        ...
        Public Sub PopulateGrid()
            ...
            Try
                ...
                If (State.IsAfterSave) Then
                    ...
                    SetPageAndSelectedIndexFromGuid(State.searchDV, State.LanguageID, Grid, State.PageIndex)
                ElseIf (State.IsEditMode) Then
                    SetPageAndSelectedIndexFromGuid(State.searchDV, State.LanguageID, Grid, State.PageIndex, State.IsEditMode)
                Else
                    SetPageAndSelectedIndexFromGuid(State.searchDV, Guid.Empty, Grid, State.PageIndex)
                End If
                'If Me.State.searchDV.Count > 0 Then
                Grid.AutoGenerateColumns = False
                Grid.Columns(GRID_COL_LANGUAGE_CODE_IDX).SortExpression = Language.LanguageSearchDV.COL_NAME_CODE
                Grid.Columns(GRID_COL_DESCRIPTION_IDX).SortExpression = Language.LanguageSearchDV.COL_NAME_DESCRIPTION
                Grid.Columns(GRID_COL_CULTURE_IDX).SortExpression = Language.LanguageSearchDV.COL_NAME_CULTURE
                Grid.Columns(GRID_COL_TERRITORY_IDX).SortExpression = Language.LanguageSearchDV.COL_NAME_TERRITORY
                SortAndBindGrid()
                'End If
        ...
        Private Function GetDV() As Language.LanguageSearchDV
            ...
            State.searchDV = GetLanguageGridDataView()
        ...
        Private Sub SortAndBindGrid()
            ...
            If (State.searchDV.Count = 0) Then
                State.searchDV = Nothing
                State.MyBO = New Language
                State.MyBO.AddNewRowToLanguageSearchDV(State.searchDV, State.MyBO)
                Grid.DataSource = State.searchDV
                Grid.DataBind()
        ...
        Private Sub AddNew()
            ...
            State.MyBO = New Language
            State.LanguageID = State.MyBO.Id
            State.MyBO.AddNewRowToLanguageSearchDV(State.searchDV, State.MyBO)
            State.IsGridAddNew = True
            'SetGridControls(Me.Grid, False)
            PopulateGrid()
            'Set focus on the Code TextBox for the EditItemIndex row
            SetPageAndSelectedIndexFromGuid(State.searchDV, State.LanguageID, Grid, _
                                               State.PageIndex, State.IsEditMode)
            ControlMgr.DisableEditDeleteGridIfNotEditAuth(Me, Grid)
            SetGridControls(Grid, False)
        End Sub

        Private Function GetRowIndexFromSearchDVByID(LanguageID As Guid) As Integer
