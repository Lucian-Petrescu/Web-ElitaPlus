...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreditCardFormatForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.CreditCardFormatForm" %>
                    ...
                    <tr>
                        <td height="20">
                            <p>
                                ...
                                <asp:Label ID="Label40" runat="server" Cssclass="TITLELABELTEXT">Credit_Card_Format</asp:Label></p>
                        </td>
                                    ...
                                    <table id="Table1" style="width: 98%; height: 50%" cellspacing="1" cellpadding="0"
                                        ...
                                        <tr>
                                            <td style="width: 40%" valign="middle" align="right">
                                                <asp:Label ID="moCreditCardTypesLabel" runat="server" Font-Bold="false">Credit_card_type</asp:Label>
                                            </td>
                                            <td style="width: 50%" valign="middle" align="left">
                                                &nbsp;
                                                <asp:dropdownlist id="moCreditCardTypesDrop" runat="server" Width="50%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:dropdownlist>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td valign="middle" align="left" class="style2">
                                                &nbsp;
                                                <asp:TextBox ID="TextboxFormat" TabIndex="5" runat="server" Width="50%" CssClass="FLATTEXTBOX" />
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="width: 50%" valign="middle">
                                                &nbsp;
                                                <asp:TextBox ID="TextboxFormatManual" onclick="clearTextBox('TextboxFormat')" runat="server" CssClass="FLATTEXTBOX" 
                                                    TabIndex="5" Width="50%" />
                                            </td>
                                        </tr>
                                    </table>
