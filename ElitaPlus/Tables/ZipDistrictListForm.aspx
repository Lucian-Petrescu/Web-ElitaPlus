<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ZipDistrictListForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.ZipDistrictListForm" %>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label7" runat="server" CssClass="TITLELABELTEXT">Zip_District</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <tr>
                                        <td valign="top" colspan="2">
                                            <table id="tblSearch" style="border-right: #999999 1px solid; border-top: #999999 1px solid;
                                                ...
                                                height: 50px" cellspacing="0" cellpadding="6" rules="cols" width="98%" align="center"
                                                    ...
                                                    <td>
                                                        <table cellspacing="0" cellpadding="2" width="100%" border="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td nowrap align="left" width="25%">
                                                                    <asp:TextBox ID="TextBoxSearchCode" runat="server" Width="95%" CssClass="FLATTEXTBOX"
                                                                        AutoPostBack="False"></asp:TextBox>
                                                                </td>
                                                                <td nowrap align="left" width="1%">
                                                                    <asp:Label ID="LabelSearchDescription" runat="server">DESCRIPTION</asp:Label>:
                                                                </td>
                                                                <td width="50%">
                                                                ...
                                                                <td nowrap align="right" colspan="4">
                                                                    <asp:Button ID="btnClearSearch" Style="background-image: url(../Navigation/images/icons/clear_icon.gif);
                                                                        ...
                                                                        Width="90px" Text="Clear" CssClass="FLATBUTTON"></asp:Button>&nbsp;
                                                                    <asp:Button ID="btnSearch" Style="background-image: url(../Navigation/images/icons/search_icon.gif);
                                                                        cursor: hand; background-repeat: no-repeat" runat="server" Font-Bold="false"
                                                                        Width="90px" Text="Search" CssClass="FLATBUTTON"></asp:Button>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <tr>
                            <td align="left">
                                <asp:Button ID="btnAdd_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                    cursor: hand; background-repeat: no-repeat" runat="server" Font-Bold="false"
                                    Width="100px" Text="New" CssClass="FLATBUTTON" Height="20px"></asp:Button>&nbsp;
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
