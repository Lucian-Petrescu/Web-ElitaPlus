                                                ...
                                                <div id="tabs" class="style-tabs">
                                                    ...
                                                    <div id="tabsInstallmentFactor">
                                                        <table id="tblOpportunities" style="border-right: #999999 1px solid; border-top: #999999 1px solid; border-left: #999999 1px solid; border-bottom: #999999 1px solid" cellspacing="2" cellpadding="2" rules="cols" width="100%" background="" border="0">
                                                            ...
                                                            <tr>
                                                                <td align="middle" colspan="2">
                                                                    <div id="scroller" style="width: 98%" align="center">
                                                                        <asp:DataGrid ID="moDataGrid" runat="server" Width="97%" OnItemCommand="ItemCommand" AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="1px" BackColor="#DEE3E7" BorderColor="#999999" CellPadding="1" AllowPaging="True" AllowSorting="True" PageSize="15" OnItemCreated="ItemCreated">
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateColumn Visible="False">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="moInstallmentFactor_ID" Text='<%# GetGuidStringFromByteArray(Container.DataItem("INSTALLMENT_FACTOR_ID"))%>' runat="server">
                                                                                        </asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateColumn>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <asp:Button ID="BtnNew_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif); cursor: hand; background-repeat: no-repeat" runat="server" Width="100px" CssClass="FLATBUTTON" Height="20px" Text="New"></asp:Button>&nbsp;
                                                                    <asp:Button ID="BtnSave_WRITE" Style="background-image: url(../Navigation/images/icons/save_icon.gif); cursor: hand; background-repeat: no-repeat" runat="server" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Save"></asp:Button>&nbsp;
                                                                    <asp:Button ID="BtnCancel" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif); cursor: hand; background-repeat: no-repeat" runat="server" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Cancel"></asp:Button>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
...
nat="server" Width="140px" CssClass="FLATBUTTON"
