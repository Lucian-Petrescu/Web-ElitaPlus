...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QuestionListSearchForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.QuestionListSearchForm" %>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox ID="moActiveOnDateText" runat="server" Width="170px" 
                                                                                  style="text-align:left"  CssClass="FLATTEXTBOX_CURRENCY"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                &nbsp;
