...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IssueSearchForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.IssueSearchForm" %>
                                                    ...
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            <tr>
                                                                ...
                                                                <td style="height: 12px" nowrap align="left" width="1%">
                                                                    <asp:Label ID="Label1" runat="server">ISSUE_TYPE</asp:Label>:
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="1%">
                                                                    <asp:Label ID="moEffectiveDateLabel" runat="server">ACTIVE_ON</asp:Label>:
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="1%">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td nowrap align="left">
                                                                    <asp:DropDownList ID="cboIssueType" runat="server" Width="80%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td nowrap align="left">
                                                                    <table id="Table1" cellspacing="0" cellpadding="0" border="0">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox ID="moActiveOn" TabIndex="2" runat="server" Width="170px" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                &nbsp;
                                                                                <asp:ImageButton ID="imgActiveOn" TabIndex="2" runat="server" Visible="True" ImageUrl="../Common/Images/calendarIcon2.jpg">
                                                                                </asp:ImageButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                        ...
                                        <td colspan="2">
                                            <asp:DataGrid ID="Grid" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="Solid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn SortExpression="CODE" HeaderText="ISSUE_CODE">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="15%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn SortExpression="DESCRIPTION" HeaderText="ISSUE_DESCRIPTION">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="15%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn SortExpression="ISSUE_TYPE" HeaderText="ISSUE_TYPE">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="15%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn SortExpression="EFFECTIVE" HeaderText="EFFECTIVE_DATE">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="19%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn SortExpression="EXPIRATION" HeaderText="EXPIRATION_DATE">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="19%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                    </asp:BoundColumn>
                                                </Columns>
