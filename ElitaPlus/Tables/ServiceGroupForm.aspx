                ...
                <td style="text-align:center; vertical-align:top;">
                    <asp:Panel ID="WorkingPanel" runat="server" Width="100%" Height="98%">
                        <table id="tblMain1" style="border-right: #999999 1px solid; border-top: #999999 1px solid;
                            border-left: #999999 1px solid; border-bottom: #999999 1px solid; height: 95%" cellspacing="0" cellpadding="6" rules="cols" width="98%" align="center" bgcolor="#fef9ea" border="0">
                            <tr>
                                            ...
                                            <tr>
                                                <td valign="middle" align="left" colspan="4">
                                                    ...
                                                    <div id="tabs" class="style-tabs-old style-tabs-oldBG">
                                                        <ul>
                                                        <li style="background:#d5d6e4"><a href="#tabSGDetails" rel="noopener noreferrer"><asp:Label ID="Label4" runat="server" CssClass="tabHeaderTextOld">Service_Group_Detail</asp:Label></a></li>                                                                
                                                        </ul>
                                                        <div id="tabSGDetails" style="background:#d5d6e4">
                                                            <table id="tblDetail" style="width: 100%; height: 90%" cellspacing="2" cellpadding="2" rules="cols" border="0">
                                                                <tr>
                                                                    <td style="vertical-align:top;" colspan="2" width="50%">
                                                                        <asp:DataGrid ID="DataGridDetail" Width="100%" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" TabIndex="18" BorderWidth="1px" BackColor="#DEE3E7" BorderColor="#999999" CellPadding="1" AllowPaging="True" AllowSorting="True" OnItemCreated="ItemCreated" PageIndexChanged="DataGridDetail_PageIndexChanged" PageSize="10">
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="1%">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:ImageButton ID="btnDeleteRiskType_WRITE" Style="cursor: hand" runat="server" CommandName="DeleteRiskType" ImageUrl="../Navigation/images/icons/trash.gif"></asp:ImageButton>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateColumn>
                                                                    ...
                                                                    <td style="vertical-align:top;" colspan="2" width="50%">
                                                                        <table id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0" designtimedragdrop="94">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <p>
                                                                                        <asp:DropDownList ID="DropDownRiskType" runat="server" Width="158px" AutoPostBack="True" TabIndex="20">
                                                                                        </asp:DropDownList></p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:RadioButtonList ID="RadioButtonListManufacturer" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" TabIndex="30" RepeatLayout="Flow">
                            ...
                            <tr>
                                <td valign="bottom" nowrap="" align="left" height="20">
                                    ...
                                    <asp:Button ID="btnCopy_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                        cursor: hand; background-repeat: no-repeat" TabIndex="205" runat="server" Height="20px" Width="136px" CssClass="FLATBUTTON" Text="NEW_WITH_COPY" CausesValidation="False">
                                    </asp:Button>
                                    <asp:Button ID="btnDelete_WRITE" Style="background-image: url(../Navigation/images/icons/clear_icon.gif);
                                        cursor: hand; background-repeat: no-repeat" TabIndex="210" runat="server" Font-Bold="false" Width="100px" CssClass="FLATBUTTON" Text="Delete" Height="20px"></asp:Button></td>
                            </tr>
                        </table>
...
angesPromptResponse" type="hidden" name="HiddenSaveChangesPromptResponse"
