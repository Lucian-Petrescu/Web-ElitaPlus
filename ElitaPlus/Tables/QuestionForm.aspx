                                    ...
                                    <table id="Table4" style="width: 100%" cellspacing="1" cellpadding="0" width="710" border="0">
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        <tr>
                                                            ...
                                                            <td colspan="1" rowspan="1" align="left">
                                                                <asp:TextBox ID="txtCode" TabIndex="1" runat="server" Width="210px" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                            </td>
                                                            <td nowrap="" align="right" colspan="1">
                                                                &nbsp;
                                                            ...
                                                            <td colspan="1" rowspan="1" align="left">
                                                                <asp:TextBox ID="txtDescription" TabIndex="2" runat="server" Width="210px" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="1" align="left">
                                                                ...
                                                                <asp:imagebutton id="btneffective" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton>
                                                            </td>
                                                            <td align="right">
                                                                &nbsp;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="1" align="left">
                                                                <asp:DropDownList ID="ddlanswerType" runat="server" TabIndex="5" Width="210px">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="vertical-align: top">
                                                                <asp:TextBox ID="txtSearchTags" TabIndex="9" runat="server" Width="210px" Height="100px" TextMode="MultiLine" Rows="5" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4">
                                        ...
                                        <tr>
                                            <td colspan="4" valign="top">
                                                ...
                                                <asp:HiddenField ID="hdnDisabledTab" runat="server" Value=""></asp:HiddenField>
                                                <div id="tabs" class="style-tabs-old" style="border:none;">
                                                        <ul>
                                                        <li style="background:#d5d6e4"><a href="#tabAnswer" rel="noopener noreferrer"><asp:Label ID="Label4" runat="server" CssClass="tabHeaderTextOld">ANSWER</asp:Label></a></li>                                                                
                                                        </ul>
                                                        <div id="tabAnswer" style="background:#d5d6e4;border:1px solid; border-color:black;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:GridView ID="GVAnswers" runat="server" Width="100%" OnRowCreated="GVAnswers_ItemCreated" OnRowCommand="GVAnswers_RowCommand" AllowPaging="False" PageSize="50" AllowSorting="True" CellPadding="1" AutoGenerateColumns="False" CssClass="DATAGRID" EmptyDataRowStyle-Wrap="True"><SelectedRowStyle CssClass="SELECTED"></SelectedRowStyle><EditRowStyle CssClass="EDITROW"></EditRowStyle><AlternatingRowStyle Wrap="False" CssClass="ALTROW"></AlternatingRowStyle><RowStyle CssClass="ROW"></RowStyle><HeaderStyle CssClass="HEADER"></HeaderStyle><Columns><asp:TemplateField ShowHeader="false"><ItemStyle HorizontalAlign="Center" Width="3%"></ItemStyle><ItemTemplate><asp:ImageButton ID="EditButton_WRITE" Style="cursor: hand" runat="server" ImageUrl="~/Navigation/images/icons/edit2.gif" visible="true" CommandName="EditRecord" CommandArgument="<%#Container.DisplayIndex %>"></asp:ImageButton></ItemTemplate></asp:TemplateField><asp:TemplateField ShowHeader="false"><ItemStyle HorizontalAlign="Center" Width="3%"></ItemStyle><ItemTemplate><asp:ImageButton Style="cursor: hand;" ID="DeleteButton_WRITE" ImageUrl="~/Navigation/images/icons/trash.gif" runat="server" CommandName="DeleteRecord" CommandArgument="<%#Container.DisplayIndex %>"></asp:ImageButton></ItemTemplate></asp:TemplateField><asp:TemplateField Visible="False"><ItemTemplate><asp:Label ID="lblAnswerID" Text='<%#GetGuidStringFromByteArray(Container.DataItem("ANSWER_ID"))%>' runat="server"> </asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField Visible="True" HeaderText="ORDER"><ItemStyle HorizontalAlign="center" Width="6%"></ItemStyle><ItemTemplate><asp:Label ID="lblAnswerOrder" Text='<%#Container.DataItem("ANSWER_ORDER")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtAnswerOrder" runat="server" CssClass="FLATTEXTBOX" Visible="True" Width="90"></asp:TextBox></EditItemTemplate></asp:TemplateField>
                                                                                                ...
                                                                                                <asp:TemplateField Visible="True" HeaderText="VALUE"><ItemStyle HorizontalAlign="center" Width="17%"></ItemStyle><ItemTemplate><asp:Label ID="lblAnswerValue" Text='<%#Container.DataItem("ANSWER_VALUE")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtAnswerValue" AutoPostBack="true" OnTextChanged="Answer_Value_TextChanged" runat="server" CssClass="FLATTEXTBOX" Visible="True" Width="95%"></asp:TextBox></EditItemTemplate></asp:TemplateField><asp:TemplateField Visible="True" HeaderText="DESCRIPTION"><ItemStyle HorizontalAlign="center" Width="19%"></ItemStyle><ItemTemplate><asp:Label ID="lblDescription" Text='<%#Container.DataItem("DESCRIPTION")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtDescription" runat="server" CssClass="FLATTEXTBOX" Visible="True" Width="95%"></asp:TextBox></EditItemTemplate></asp:TemplateField><asp:TemplateField Visible="True" HeaderText="SUPPORTS_CLAIM"><ItemStyle HorizontalAlign="center" Width="8%"></ItemStyle><ItemTemplate><asp:Label ID="lblSupports_Claim" Text='<%#Container.DataItem("SUPPORTS_CLAIM_ID")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:DropDownList ID="ddlSupports_Claim" runat="server" Visible="True" Width="75"></asp:DropDownList></EditItemTemplate></asp:TemplateField><asp:TemplateField Visible="True" HeaderText="SCORE"><ItemStyle HorizontalAlign="center" Width="4%"></ItemStyle><ItemTemplate><asp:Label ID="lblScore" Text='<%#Container.DataItem("SCORE")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtScore" runat="server" Visible="True" CssClass="FLATTEXTBOX" Width="95%"></asp:TextBox></EditItemTemplate></asp:TemplateField><asp:TemplateField Visible="True" HeaderText="EFFECTIVE_DATE"><ItemStyle HorizontalAlign="center" Width="16%"></ItemStyle><ItemTemplate><asp:Label ID="lblEffective" Text='<%#Container.DataItem("EFFECTIVE")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtEffective" runat="server" CssClass="FLATTEXTBOX" Visible="True" Width="90%"></asp:TextBox><asp:imagebutton id="btnEffectiveDate" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton></EditItemTemplate></asp:TemplateField><asp:TemplateField Visible="True" HeaderText="EXPIRATION_DATE"><ItemStyle HorizontalAlign="center" Width="16%"></ItemStyle><ItemTemplate><asp:Label ID="lblExpiration" Text='<%#Container.DataItem("EXPIRATION")%>' runat="server"> </asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtExpiration" runat="server" CssClass="FLATTEXTBOX" Visible="True" Width="90%"></asp:TextBox><asp:imagebutton id="btnExpirationDate" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton></EditItemTemplate></asp:TemplateField></Columns><PagerStyle HorizontalAlign="Center" CssClass="PAGER"></PagerStyle></asp:GridView>
                                                                </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="btnNewAnswer" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                                                        cursor: hand; background-repeat: no-repeat" TabIndex="200" runat="server" Font-Bold="false" Width="81px" CssClass="FLATBUTTON" Height="20px" Text="New"></asp:Button>&nbsp;&nbsp; <asp:Button ID="btnSaveAnswer" Style="background-image: url(../Navigation/images/icons/save_icon.gif);
                                                                        cursor: hand; background-repeat: no-repeat" TabIndex="190" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Save"></asp:Button>&nbsp; <asp:Button ID="btnCancelAnswer" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif);
                                                                        cursor: hand; background-repeat: no-repeat" TabIndex="195" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Cancel"></asp:Button>&nbsp; 
                                                                    </td>
                                                                </tr>
                                                                </table>
                                                        </div>
