...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ServiceGroupListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.ServiceGroupListForm" %>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelTables" runat="server" Cssclass="TITLELABEL">Tables</asp:label>:&nbsp;
									<asp:label id="Label7" runat="server" Cssclass="TITLELABELTEXT">Service_Group</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
