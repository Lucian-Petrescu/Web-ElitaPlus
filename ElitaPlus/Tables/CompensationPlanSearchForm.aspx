<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CompensationPlanSearchForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.CompensationPlanSearchForm"
...
<asp:Content ID="SummaryContent" ContentPlaceHolderID="SummaryPlaceHolder" runat="server">
 ...
 <asp:Content ID="Body" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
      ...
      <h2 class="dataGridHeader">
            Search results for Compensation</h2>
        <div>
