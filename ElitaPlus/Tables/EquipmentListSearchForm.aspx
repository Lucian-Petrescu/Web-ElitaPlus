...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EquipmentListSearchForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.EquipmentListSearchForm" %>
                                                    ...
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            <tr>
                                                                ...
                                                                <td style="height: 12px" nowrap align="left" width="1%">
                                                                    <asp:Label ID="moEffectiveDateLabel" runat="server" Visible="false">EFFECTIVE_DATE</asp:Label>
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="1%">
                                                                    <asp:Label ID="moExpirationDateLabel" runat="server" Visible="false">EXPIRATION_DATE</asp:Label>
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="1%">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td nowrap align="left">
                                                                    <table id="Table1" cellspacing="0" cellpadding="0" border="0" style="visibility:hidden;">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox ID="moEffectiveDateText" TabIndex="2" runat="server" Width="170px" 
                                                                ...
                                                                <td nowrap align="left">
                                                                    <table id="Table12" cellspacing="0" cellpadding="0" border="0" style="visibility:hidden;">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox ID="moExpirationDateText" TabIndex="2" runat="server" Width="170" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                &nbsp;
