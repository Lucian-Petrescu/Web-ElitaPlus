...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RuleSearchForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.RuleSearchForm" %>
                                                    ...
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            <tr>
                                                                ...
                                                                <td style="height: 12px" nowrap align="left" width="15%">
                                                                    <asp:Label ID="Label1" runat="server">RULE_TYPE</asp:Label>:
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="15%">
                                                                    <asp:Label ID="Label2" runat="server">RULE_CATEGORY</asp:Label>:
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="15%">
                                                                    <asp:Label ID="moActiveOnDateLabel" runat="server">ACTIVE_ON</asp:Label>:
                                                                </td>
                                                                <td style="height: 12px" nowrap align="left" width="20%">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td nowrap align="left" width ="15%">
                                                                    <asp:DropDownList ID="ddlRuleType" runat="server" Width="85%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td nowrap align="left" width ="15%">
                                                                    <asp:DropDownList ID="ddlRuleCategory" runat="server" Width="85%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td nowrap align="left" width ="15%">
                                                                    <asp:TextBox ID="moActiveOnDateText" runat="server" Width="80%" CssClass="FLATTEXTBOX_TAB"></asp:TextBox>&nbsp;
                                                                ...
                                                                <td nowrap align="left">&nbsp;
                                                                    <asp:Button ID="btnClearSearch" runat="server" CssClass="FLATBUTTON" Height="20px"
                                                                        ...
                                                                        cursor: hand; background-repeat: no-repeat" Text="Clear" Width="90px" />&nbsp;<asp:Button ID="btnSearch" runat="server" CssClass="FLATBUTTON" Height="20px" Style="background-image: url(../Navigation/images/icons/search_icon.gif);
                                        ...
                                        <td colspan="2">
                                            <asp:DataGrid ID="Grid" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="Solid"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn SortExpression="RULE_TYPE" HeaderText="RULE_TYPE">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="15%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn SortExpression="RULE_CATEGORY" HeaderText="RULE_CATEGORY">
                                                        <HeaderStyle HorizontalAlign="Center" ForeColor="#12135B" Width="15%"></HeaderStyle>
                                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                    </asp:BoundColumn>
