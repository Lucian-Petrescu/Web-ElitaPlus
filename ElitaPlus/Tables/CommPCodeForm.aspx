                            ...
                            <cc1:TabPanel ID="moEntityTabPanel" runat="server" HeaderText="Entities" BorderColor="Black" BorderStyle="Solid">
                                ...
                                <ContentTemplate>
                                    <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <asp:Button ID="BtnNewEntity_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif); cursor: hand; background-repeat: no-repeat"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPanelButtons" runat="server">
    <asp:Button ID="btnBack" Style="background-image: url(../Navigation/images/icons/back_icon.gif); cursor: hand; background-repeat: no-repeat"
        TabIndex="14" runat="server" Width="90px"
    ...
    <asp:Button ID="btnSave_WRITE" Style="background-image: url(../Navigation/images/icons/save_trans_icon.gif); cursor: hand; background-repeat: no-repeat"
        TabIndex="15" runat="server" Width="80px"
    ...
    <asp:Button ID="btnUndo_WRITE" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif); cursor: hand; background-repeat: no-repeat"
        TabIndex="16" runat="server" Width="90px"
    ...
    <asp:Button ID="btnNew_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif); cursor: hand; background-repeat: no-repeat"
        TabIndex="17" runat="server" Width="80px"
    ...
    <asp:Button ID="btnCopy_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif); cursor: hand; background-repeat: no-repeat"
        TabIndex="18" runat="server" Width="135px"
        CausesValidation="False" Height="20px" CssClass="FLATBUTTON" Text="New_With_Copy"></asp:Button>
    <asp:Button ID="btnDelete_WRITE" Style="background-image: url(../Navigation/images/icons/clear_icon.gif); cursor: hand; background-repeat: no-repeat"
        TabIndex="19" runat="server" Width="80px"
