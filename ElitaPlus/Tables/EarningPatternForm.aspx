						...
						<TABLE id="moTableMain" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid"
											...
											<asp:panel id="moEarningPatternEditPanel_WRITE" runat="server" Width="100%" Height="98%">
												<TBODY>
													...
													<TR>
														...
														<TD noWrap>
															<asp:textbox id="moCodeText" tabIndex="10" runat="server" Visible="False" CssClass="FLATTEXTBOX"
														...
														<TD colSpan="1">
															<asp:textbox id="moDescriptionText1" tabIndex="10" runat="server" Visible="False" CssClass="FLATTEXTBOX"
																width="210px"></asp:textbox></TD>
													</TR>
													<TR>
														<TD align="right">
														...
														<TD colSpan="1">
															<asp:textbox id="moDescriptionText" tabIndex="10" runat="server" CssClass="FLATTEXTBOX" width="210px"
												...
												<TD align="left" width="100%">
                                                    ...
                                                    <div id="tabsPercentages" style="background:#d5d6e4">
                                                        <table id="tblOpportunities" style="border-right: #999999 1px solid; border-top: #999999 1px solid; border-left: #999999 1px solid; border-bottom: #999999 1px solid"
                                                            cellspacing="2" cellpadding="2" rules="cols" width="100%" background="" border="0">
                                                            <tr>
                                                                <td colspan="2">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="padding-top:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<asp:Button ID="BtnNewPercent_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif); cursor: hand; background-repeat: no-repeat"
                                                                            runat="server" Font-Bold="false" Width="100px" CssClass="FLATBUTTON" Height="20px" Text="New"></asp:Button>&nbsp;
																		<asp:Button ID="BtnSavePercent_WRITE" Style="background-image: url(../Navigation/images/icons/save_icon.gif); cursor: hand; background-repeat: no-repeat"
                                                                            runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Save"></asp:Button>&nbsp;
																		<asp:Button ID="BtnCancelPercent" Style="background-image: url(../Navigation/images/icons/cancel_icon.gif); cursor: hand; background-repeat: no-repeat"
                                                                            runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="Cancel"></asp:Button>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
							...
							<TR>
								<TD align="right" colSpan="2">
									<TABLE id="Table2" style="WIDTH: 678px; HEIGHT: 24px" cellSpacing="1" cellPadding="1" width="678"
										align="left" border="0">
										<TR>
											<TD><asp:button id="btnBack" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/back_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="90px" CssClass="FLATBUTTON" height="20px" Text="BACK"></asp:button></TD>
											<TD><asp:button id="btnApply_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/save_trans_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="90px" CssClass="FLATBUTTON" height="20px" Text="SAVE"></asp:button></TD>
											<TD><asp:button id="btnUndo_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/cancel_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="110px" CssClass="FLATBUTTON" height="20px" Text="UNDO"></asp:button></TD>
											<TD><asp:button id="btnNew_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/add_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="100px" CssClass="FLATBUTTON" height="20px" Text="New"></asp:button></TD>
											<TD><asp:button id="btnCopy_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/add_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="140px" CssClass="FLATBUTTON" height="20px" Text="New_With_Copy"></asp:button></TD>
											<TD><asp:button id="btnDelete_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/clear_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
													runat="server" Width="100px" CssClass="FLATBUTTON" height="20px" Text="Delete"></asp:button></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
