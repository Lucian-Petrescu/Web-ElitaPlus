                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                ...
                                                <tr>
                                                    <td nowrap="" align="left">
                                                        <asp:TextBox ID="moCodeText" runat="server" Width="75%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:TextBox>
                                                    </td>
                                                    <td nowrap="" align="left">
                                                    ...
                                                    <td nowrap="" align="left">
                                                        <table id="Table1" cellspacing="0" cellpadding="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    &nbsp;
                                                                    <asp:ImageButton ID="imgEffectiveDate" TabIndex="2" runat="server" Visible="True" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:ImageButton>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td nowrap="" align="left">
                                                        <table id="Table12" cellspacing="0" cellpadding="0" border="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox ID="moExpirationDateText" TabIndex="2" runat="server" Width="170px" CssClass="FLATTEXTBOX"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    &nbsp;
                                                                    <asp:ImageButton ID="imgExpirationDate" TabIndex="2" runat="server" Visible="True" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:ImageButton>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <asp:TextBox ID="moCommentText" runat="server" Height="70px" TextMode="MultiLine" Width="99%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <div id="tabEquipment" style="background:#d5d6e4;border:1px solid; border-color:black;">
                                                     <asp:Panel ID="PanelCommentEditDetail" runat="server" Width="100%" Height="100%">
                                                        <div id="commentScroller" align="center" style="overflow: auto; width: 99.53%; height: 100%">
                                                            <table id="tblCommentDetail" border="0" cellpadding="2" cellspacing="2" rules="cols" style="width: 100%; height: 100%">
                                                                <tr>
                                                                    <td align="left" valign="top">
                                                                        <url:UserControlSearchAvailable ID="UserControlSearchAvailableEquipment" runat="server" tabindex="12"></url:UserControlSearchAvailable>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
