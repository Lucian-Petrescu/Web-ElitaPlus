<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Navigation/masters/content_default.Master" CodeBehind="ComunaCodeForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.ComunaCodeForm" 
    title="Untitled Page" %>
        ...
        <tr>
            <td colspan="2" style="text-align:center; padding-left:8px; padding-right:8px;">
                <table cellpadding="2" cellspacing="2" border="0" style="BORDER: #999999 1px solid;background-color:#f1f1f1; height:50px; width:100%; padding:0px;">
                            ...
                            <td style="HEIGHT: 12px" noWrap align=left width="1%">
                                <asp:label id="moPostalCodeLabel" runat="server">POSTAL_CODE</asp:label>:</td>
                            <td style="HEIGHT: 12px" noWrap align=left width="1%">
                                <asp:label id="moRegionLabel" runat="server">REGION</asp:label>:</td></tr>
                            <tr>
                            <td noWrap align=left>
                                <asp:textbox id="moComunaTextBox" runat="server" Width="75%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:textbox></td>
                            <td noWrap align=left>
                                <asp:textbox id="moPostalCodeTextbox" runat="server" Width="75%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:textbox></td>
                            <td noWrap align=left>
                                <asp:dropdownlist id="moRegionDrop" runat="server" Width="100%" CssClass="FLATTEXTBOX_TAB" AutoPostBack="False"></asp:dropdownlist></td>
                            </tr>
                ...
                <asp:GridView ID="Grid" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1" AllowPaging="True" AllowSorting="True" CssClass="DATAGRID">
                    ...
                    <Columns>
						...
						<asp:TemplateField Visible="False">
						    <ItemTemplate>
								<asp:Label id="IdLabel" runat="server" text='<%# GetGuidStringFromByteArray(Container.DataItem("COMUNA_CODE_ID"))%>'></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
						<asp:TemplateField HeaderText="COMUNA" SortExpression="COMUNA">
                            <ItemStyle CssClass="CenteredTD" />
                            <ItemTemplate>
                                <asp:Label ID="moComunaLabel" runat="server" Visible="True" TEXT='<%#Container.DataItem("COMUNA")%>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>                                
                                <asp:textbox ID="moComunaTextBox" runat="server" Visible="True" Columns="60" MaxLength="255" Text='<%# Container.DataItem("COMUNA")%>' />                                
                            </EditItemTemplate>
                        </asp:TemplateField>  
						<asp:TemplateField HeaderText="POSTAL_CODE" SortExpression="POSTALCODE">
						    <ItemStyle CssClass="CenteredTD" />
                            <ItemTemplate>
                                <asp:Label id="moPostalCodeLabel" runat="server" text='<%#Container.DataItem("POSTALCODE")%>' />
                            </ItemTemplate>
                            <EditItemTemplate>                                
                                <asp:textbox ID="moPostalCodeTextBox" runat="server" Visible="True" Columns="35" MaxLength="100" text='<%#Container.DataItem("POSTALCODE")%>' />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="REGION" SortExpression="REGION_DSCRIPTION">
						    <ItemStyle CssClass="CenteredTD" />
                            <ItemTemplate>
                                <asp:Label id="moRegionLabel" runat="server" text='<%#Container.DataItem("REGION_DSCRIPTION")%>' />
                            </ItemTemplate>
                            <EditItemTemplate>  
                                <asp:DropDownList ID="moRegionDropdown" runat="server" Visible="True" Width="150px"></asp:DropDownList>
                            </EditItemTemplate>
                        </asp:TemplateField>
                    </Columns>
