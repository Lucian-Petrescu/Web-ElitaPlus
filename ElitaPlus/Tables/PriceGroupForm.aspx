                                                            ...
                                                            <table id="tblDetail" style="width: 100%; height: 100%" cellspacing="2" cellpadding="2" rules="cols" background="" border="0">
                                                                <tr>
                                                                    <td valign="top" align="left">
                                                                        <asp:DataGrid ID="DataGridDetail" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="1px" BackColor="#DEE3E7" BorderColor="#999999" CellPadding="1" AllowPaging="True" AllowSorting="True" OnItemCreated="ItemCreated">
                                                                                        ...
                                                                                        <asp:Panel ID="PanelEditDetail_Write" runat="server" Width="100%" Height="100%">
                                                                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="" width="50%">
                                                                                                        <asp:TextBox ID="TextboxEffectiveDate" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="">
                                                                                                        <asp:TextBox ID="TextboxPriceBandRangeFrom" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td nowrap="" style="text-align:right">
                                                                                                        <asp:Label ID="LabelPriceBandRangeTo" runat="server" Font-Bold="false">High_Price</asp:Label>:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TextboxPriceBandRangeTo" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="">
                                                                                                        <asp:TextBox ID="TextboxHomePrice" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td nowrap="" style="text-align:right">
                                                                                                        <asp:Label ID="LabelCarryInPrice" runat="server" Font-Bold="false">Carry_In_Price</asp:Label>:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TextboxCarryInPrice" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td colspan="4">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="">
                                                                                                        <asp:TextBox ID="TextboxSendInPrice" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td nowrap="" style="text-align:right">
                                                                                                        <asp:Label ID="LabelPickUpPrice" runat="server" Font-Bold="false">Pick_Up_Price</asp:Label>:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TextboxPickUpPrice" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td colspan="4">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="">
                                                                                                        <asp:TextBox ID="TextboxCleaningPrice" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td nowrap="" style="text-align:right">
                                                                                                        <asp:Label ID="LabelEstimatePrice" runat="server" Font-Bold="false">Estimate_Price</asp:Label>:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TextboxEstimatePrice" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td colspan="4">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="">
                                                                                                        <asp:TextBox ID="moReplacementText" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td nowrap="" style="text-align:right">
                                                                                                        <asp:Label ID="LabelHourlyRate" runat="server" Font-Bold="false">Hourly_Rate</asp:Label>:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="TextboxHourlyRate" TabIndex="10" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td colspan="4">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td nowrap="">
                                                                                                        <asp:TextBox ID="TextboxDiscountedPrice" TabIndex="11" runat="server" CssClass="FLATTEXTBOX" Width="80%"></asp:TextBox>
                                                                                                    </td>
                                                                                                    <td nowrap="" style="text-align:right">                                                                                                        
                                                                                                    </td>
                                                                                                    <td>                                                                                                        
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    ...
                                                                                                    <asp:Button ID="btnAddNewChild_Write" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                                                                                        cursor: hand; background-repeat: no-repeat" TabIndex="155" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Height="20px" Text="New"></asp:Button>&nbsp;
                                                                                                    <asp:Button ID="btnAddChildWithCopy_Write" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
                                                                                                        cursor: hand; background-repeat: no-repeat" TabIndex="160" runat="server" Height="20px" Width="136px" CssClass="FLATBUTTON" Text="NEW_WITH_COPY" CausesValidation="False">
                                                                                                    </asp:Button>
...
th="90px" CssClass="FLATBUTTON" Height="20px" Text="Undo"></asp:Button>&nbsp;
                                <asp:Button ID="btnNew_WRITE" Style="background-image: url(../Navigation/images/icons/add_icon.gif);
