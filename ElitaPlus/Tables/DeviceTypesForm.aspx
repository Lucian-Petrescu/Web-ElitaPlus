...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeviceTypesForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Tables.DeviceTypesForm" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html>
<head>
    <title>DeviceTypesForm</title>
                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td height="20">
                                ...
                                <asp:Label ID="Label6" runat="server" CssClass="TITLELABELTEXT">DEVICE_TYPES</asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
                                    ...
                                    <table cellspacing="0" cellpadding="3" width="99%" border="0" align="center">
                                        <tr>
                                            ...
                                            <td width="35%" style="white-space: nowrap;">
                                                <asp:TextBox ID="TextBoxNewProgCode" TabIndex="1" Visible="True" runat="server" Width="280"></asp:TextBox>&nbsp;
                                            </td>
                                            <td nowrap align="left" width="30%" rowspan="2" valign="middle">
                                                <asp:Button ID="bntAdd" TabIndex="3" Style="background-image: url(../Navigation/images/icons/add_icon.gif); cursor: hand; background-repeat: no-repeat"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBoxDescription" TabIndex="2" runat="server" Visible="true" Width="280"></asp:TextBox>
                                            </td>
                                            <td nowrap></td>
                                        </tr>
                                        <tr>
