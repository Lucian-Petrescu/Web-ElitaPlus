...
Namespace Tables
    ...
    Partial Public Class DealerForm
        ...
        '''<summary>
        '''lbltxtPendingClaimsDenyDays control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents lbltxtPendingClaimsDenyDays As Global.System.Web.UI.WebControls.Label

        '''<summary>
        '''txtPendingClaimsDenyDays control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents txtPendingClaimsDenyDays As Global.System.Web.UI.WebControls.TextBox
