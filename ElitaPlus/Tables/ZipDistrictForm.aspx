...
<HTML>
	...
	<body onresize="resizeForm(document.getElementById('scroller'));" leftMargin="0" topMargin="0" onload="changeScrollbarColor();" MS_POSITIONING="GridLayout" border="0">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="tblOuter2" style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; MARGIN: 5px; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid" height="93%" cellSpacing="0" cellPadding="0" rules="none" width="98%" bgColor="#d5d6e4" border="0"> <!--d5d6e4-->
				<tr>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td vAlign="middle" align="center"><asp:panel id="WorkingPanel" runat="server" Width="98%" Height="98%">
							<TABLE id="tblMain1" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; WIDTH: 100%; BORDER-BOTTOM: #999999 1px solid; HEIGHT: 95%" cellSpacing="0" cellPadding="6" rules="cols" width="100%" align="center" bgColor="#fef9ea" border="0">
								<TR>
											...
											<asp:Panel id="EditPanel_WRITE" runat="server" Width="98%">
												<TABLE id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" border="0">
                                                    ...
                                                    <div id="tabs" class="style-tabs-old style-tabs-oldBG">
                                                        <ul>
                                                        <li style="background:#d5d6e4"><a href="#tabZipCodes" rel="noopener noreferrer"><asp:Label ID="Label4" runat="server" CssClass="tabHeaderTextOld">Zip_Codes</asp:Label></a></li>                                                                
                                                        </ul>
                                                            ...
                                                            <TABLE id="Table2" cellSpacing="1" cellPadding="0" width="100%" border="0">
																<TR>
																	...
																	<TD width="25%" align="center">
																		...
																		<asp:button id="btnDeleteZipCode" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/clear_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="210" runat="server" Font-Bold="false" Width="100px" CssClass="FLATBUTTON" Text="Delete" height="20px"></asp:button>
																	</TD>
																	<TD vAlign="top" width="50%">
																		<TABLE id="Table3" cellSpacing="1" cellPadding="0" width="100%" border="0">
																			<TR>
																				<TD width="80%">
																					<asp:RadioButtonList id="RadioButtonListSingleOrRange" runat="server" Height="15px" RepeatDirection="Horizontal" AutoPostBack="true">
																			...
																			<TR>
																				<TD width="80%">
																					...
																					<asp:button id="ButtonAddZipCode" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/add_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="200" runat="server" Font-Bold="false" Width="70px" CssClass="FLATBUTTON" Text="Add" height="20px"></asp:button></TD>
																				<TD width="20%"></TD>
																			</TR>
																		</TABLE>
																	</TD>
								...
								<TR>
									<TD vAlign="bottom" noWrap="" align="left" height="20">
										<asp:button id="btnBack" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/back_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="185" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Text="Back" height="20px"></asp:button>&nbsp;
										<asp:button id="btnSave_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/save_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="190" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Text="Save" height="20px"></asp:button>&nbsp;
										<asp:button id="btnUndo_Write" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/cancel_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="195" runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Text="Undo" height="20px"></asp:button>&nbsp;
										<asp:button id="btnNew_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/add_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="200" runat="server" Font-Bold="false" Width="81px" CssClass="FLATBUTTON" Text="New" height="20px"></asp:button>&nbsp;&nbsp;
										<asp:button id="btnDelete_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/clear_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat" tabIndex="210" runat="server" Font-Bold="false" Width="100px" CssClass="FLATBUTTON" Text="Delete" height="20px"></asp:button></TD>
								</TR>
							</TABLE>
