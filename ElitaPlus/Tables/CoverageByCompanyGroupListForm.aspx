...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CoverageByCompanyGroupListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.CoverageByCompanyGroupListForm"%>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server"  Cssclass="TITLELABELTEXT">Coverage_By_Company_Group</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
																...
																<TABLE cellSpacing="2" cellPadding="2" width="100%" border="0">
																	...
																	<TR>
																		<TD style="HEIGHT: 26px" noWrap align="left">
																			<asp:textbox id="SearchDescriptionTextBox" runat="server" Width="180px" AutoPostBack="False"
																				Height="20px"></asp:textbox></TD>
																		<TD noWrap align="left">
																			<asp:textbox id="SearchCodeTextBox" runat="server" Width="150px" AutoPostBack="False" Height="20px"></asp:textbox></TD>
																		<TD noWrap align="right">
																			<asp:button id="btnClearSearch" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/clear_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
																				runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Text="Clear" height="20px"></asp:button>&nbsp;
																			<asp:button id="btnSearch" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/search_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
																				runat="server" Font-Bold="false" Width="90px" CssClass="FLATBUTTON" Text="Search" height="20px"></asp:button>&nbsp;&nbsp;
																		</TD>
																	</TR>
																</TABLE>
															</TD>
								...
								<TR>
									<TD align="left">
										<asp:button id="btnAdd_WRITE" style="BACKGROUND-IMAGE: url(../Navigation/images/icons/add_icon.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
											runat="server" Font-Bold="false" Width="100px" CssClass="FLATBUTTON" Text="New" height="20px"
