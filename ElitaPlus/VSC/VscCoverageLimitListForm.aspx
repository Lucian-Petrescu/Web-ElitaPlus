...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="VscCoverageLimitListForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.VSC.VscCoverageLimitListForm"%>
	...
	<body leftMargin="0" topMargin="0" onload="changeScrollbarColor();" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; MARGIN: 5px; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="864" border="0" style="WIDTH: 864px; HEIGHT: 24px">
							<TR>
								<TD height="20"><asp:label id="Label1" runat="server"  Cssclass="TITLELABEL">Tables</asp:label>:&nbsp;&nbsp;
								<asp:label id="Label2" runat="server"  Cssclass="TITLELABELTEXT" Width="184px">VSC Coverage Limit</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
			...
			<TABLE id="moTableOuter" style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; MARGIN: 5px; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid"
				...
				<tr>
					<td vAlign="top" align="center" height="100%"><asp:panel id="moPanel" runat="server">
							<TABLE id="moTablelMain" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; WIDTH: 842px; BORDER-BOTTOM: #999999 1px solid; HEIGHT: 565px"
								height="565" cellSpacing="0" cellPadding="6" rules="cols" width="842" align="center"
								bgColor="#fef9ea" border="0">
								<TR>
									<TD style="WIDTH: 922px" height="1"></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD style="WIDTH: 926px" vAlign="top">
										<TABLE style="WIDTH: 744px; HEIGHT: 408px" cellSpacing="0" cellPadding="0" width="744"
											border="0">
											<TR>
												<TD style="WIDTH: 911px" vAlign="top" colSpan="2">
													<TABLE id="moTableSearch" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; WIDTH: 850px; BORDER-BOTTOM: #999999 1px solid; HEIGHT: 81px"
														cellSpacing="0" cellPadding="6" rules="cols" width="850" align="center" bgColor="#f1f1f1"
														border="0">
														<TR>
															<TD>
																<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																	<TR>
																		<TD style="WIDTH: 182px; HEIGHT: 15px" noWrap align="left">
																			<asp:Label id="moLimitCodeLabel" runat="server">COVERAGE_LIMIT_CODE</asp:Label>:</TD>
																		<TD style="WIDTH: 221px; HEIGHT: 15px" noWrap align="left">
																			<asp:Label id="moCoveTypeLabel" runat="server">COVERAGE_TYPE</asp:Label>:</TD>
																		<TD style="HEIGHT: 15px" noWrap align="left">
																			<asp:label id="moMonthLabel" runat="server">MONTHS</asp:label>:</TD>
																		<TD style="HEIGHT: 15px" noWrap align="left">
																			<asp:label id="moMileLabel" runat="server">KM_MILE</asp:label>:</TD>
																	</TR>
																	<TR>
																		<TD style="WIDTH: 182px; HEIGHT: 13px" noWrap align="left" width="182">
																			<asp:TextBox id="moLimitCodeTx" runat="server"></asp:TextBox></TD>
																		<TD style="WIDTH: 221px; HEIGHT: 13px" noWrap align="left" width="221">
																			<asp:dropdownlist id="moCoverageTypeDrop" runat="server" Width="95%" AutoPostBack="True"></asp:dropdownlist></TD>
																		<TD style="HEIGHT: 13px" noWrap align="left" width="25%">
																			<asp:TextBox id="moMonthTx" runat="server"></asp:TextBox></TD>
																		<TD style="HEIGHT: 13px" noWrap align="left" width="25%">
																			<asp:TextBox id="moKmTx" runat="server"></asp:TextBox></TD>
																	</TR>
																	<TR height="50">
																		<TD style="WIDTH: 182px; HEIGHT: 12px"></TD>
																		<TD style="WIDTH: 221px; HEIGHT: 12px"></TD>
																		<TD style="HEIGHT: 12px" align="right" colSpan="2">&nbsp;&nbsp;
											...
											<TR>
												<TD style="WIDTH: 911px" colSpan="2" height="5"></TD>
											</TR>
											<TR>
											...
											<TR id="trPageSize" runat="server">
												<TD style="WIDTH: 922px" vAlign="top" align="left">
											...
											<TR>
												<TD style="WIDTH: 911px" colSpan="2">
													<asp:DataGrid id="moDataGrid" runat="server" Width="851px" BorderStyle="Solid" BorderWidth="1px"
														...
														<Columns>
															...
															<asp:BoundColumn ReadOnly="True" HeaderText="COVERAGE_LIMIT_CODE">
																<HeaderStyle Width="150px"></HeaderStyle>
															</asp:BoundColumn>
															<asp:BoundColumn Visible="False" HeaderText="COVERAGE_TYPE_ID"></asp:BoundColumn>
															<asp:BoundColumn ReadOnly="True" HeaderText="COVERAGE_TYPE"></asp:BoundColumn>
