...
Namespace Reports
    ...
    Partial Public Class CoveredZipDistrictsReportForm
        ...
        '''<summary>
        '''lblCOVEREDZIPDISTRICTS control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents lblCOVEREDZIPDISTRICTS As Global.System.Web.UI.WebControls.Label
