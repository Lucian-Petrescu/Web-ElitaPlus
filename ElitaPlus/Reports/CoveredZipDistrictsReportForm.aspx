<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CoveredZipDistrictsReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.CoveredZipDistrictsReportForm"%>
...
<HTML>
	<HEAD>
		<title>Covered ZIP Districts Report</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="lblCOVEREDZIPDISTRICTS" runat="server" CssClass="TITLELABELTEXT">COVERED_ZIP_DISTRICTS</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
													...
													<TABLE id="Table1" cellSpacing="2" cellPadding="0" width="75%" border="0">
														<TR>
															...
															<TD align="left" width="80%">
																...
																<asp:dropdownlist id="moCountryDrop" runat="server" Width="128px" AutoPostBack="True"></asp:dropdownlist></TD>
														</TR>
														<TR>
															<TD colSpan="2">
																<HR style="HEIGHT: 1px">
														...
														<TR>
															<TD noWrap align="right" width="25%">
																<asp:RadioButton id="rZipDistricts" onclick="ToggleDualDropDownsSelection('multipleDropControl_moMultipleColumnDrop', 'multipleDropControl_moMultipleColumnDropDesc', 'rdealer', false, ''); document.all.item('multipleDropControl_lb_DropDown').style.color = '';"
																	AutoPostBack="false" Checked="True" Runat="server" TextAlign="left" Text="ALL_ZIP_DISTRICTS"></asp:RadioButton></TD>
															<TD noWrap align="center"></TD>
														</TR>
														<TR>
