...
Namespace Reports
    ...
    Partial Public Class CustomerRegistrationReportForm
        ...
        '''<summary>
        '''rproductcode control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents rproductcode As Global.System.Web.UI.WebControls.RadioButton
