...
#End Region
        ...
        Private Sub GenerateReport()
            Try
                ...
                Me.PopulateBOProperty(Me.State.MyBO, "ReportType", "Collection Amdocs Extract Report")
                Me.PopulateBOProperty(Me.State.MyBO, "ReportProc", "R_AMDOCS_COLLECTION_REPORT.export")
