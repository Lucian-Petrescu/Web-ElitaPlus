              ...
              <table>
                <tr>
                  <td>
                    ...
                    <b>
                      <span lang='ES-PR' style='font-family:"Trebuchet MS"'>ORDEN DE SERVICIO CELULARES - GARANTÍA DE SERVICIO</span>
                    </b>
                    </p>
                ...
                <tr>
                  <td colspan ='2'>
                    <div style='border:solid windowtext 1.0pt;padding:1.0pt 4.0pt 1.0pt 4.0pt;background:#0C0C0C'>
                        ...
                        <b>
                          <span lang='ES-PR' style='font-family:"Trebuchet MS";color:white'>ORDEN DE SERVICIO</span>
                        </b>
                        </p>                        
                    </div >
                    <p class='MsoNormal'>
                  ...
                  <td width ="40%">
                    ...
                    <td width ="60%">
                      <p class='MsoNormal'>
                        <b>
                          <span lang='ES-MX' style='font-size:11.0pt;font-family:"Trebuchet MS"'>
                            Reparación en: <span style='color:#999999'></span>
                          </span>
                        </b>
                          <span lang='ES-MX' style='font-size:11.0pt;font-family:"Trebuchet MS";color:#999999'>
                ...
                <tr>
                  <td>
                    <div style='border:solid windowtext 1.0pt;padding:1.0pt 4.0pt 1.0pt 4.0pt;background:#0C0C0C'>
                      <p class='MsoNormal' align='center' style='text-align:center;background:#0C0C0C;border:none;padding:0in'>
                        <b>
                          <span lang='ES' style='font-family:"Trebuchet MS";color:white'>CONFIRMACIÓN RECIBO UNIDAD REPARADA</span>
                        </b>
                      </p>
                    </div>
                      <p class='MsoNormal'>
                        <span class='sp'>
                          <span lang='ES' style='font-size:11.0pt;font-family:"Trebuchet MS"'>
                            ...
                            me ha hecho entrega de la unidad reparada, acorde a los términos y condiciones
                            del Programa.
                          </span>
                        </span>
                      </p>
