<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BillingCollectionsGermanyReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.BillingCollectionsGermanyReportForm" %>
...
<html>
<head>
    <title id="rptWindowTitle" runat="server">Billing Register Collections</title>
                        ...
                        <tr>
                            <td height="20">
                                <asp:Label ID="LabelReports" runat="server"  CssClass="TITLELABEL">Reports</asp:Label>:&nbsp;<asp:Label
                                    ID="Label7" runat="server"  CssClass="TITLELABELTEXT">BILLING_REGISTER_COLLECTIONS</asp:Label></td>
                        </tr>
                    </table>
                </td>
            </tr>
                                        ...
                                        <tr>
                                            <td align="center" colspan="4">
                                                <table cellspacing="2" cellpadding="0" width="75%" border="0">
                                                    ...
                                                    <tr>
                                                        <td nowrap align="right" width="25%" colspan="2">
                                                            <asp:RadioButton ID="rsinglepremium" AutoPostBack="false"
                                                                Text="SINGLE_PREMIUM" TextAlign="left" runat="server" GroupName = "Payment_Type"></asp:RadioButton>
                                                        </td>
                                                        <td nowrap align="left" width="25%">
                                                            &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rddpremium" GroupName = "Payment_Type"
                                                                AutoPostBack="false" Text="DD_PREMIUM" TextAlign="left" runat="server"></asp:RadioButton>
                                                        </td>
                                                        <td nowrap align="left" width="25%">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td nowrap align="right" width="25%" colspan="1">
                                                            <asp:RadioButton ID="rComm" AutoPostBack="false"
                                                                Text="STANDARD" TextAlign="left" runat="server" GroupName = "Commbrkdown"></asp:RadioButton>
                                                        </td>
                                                        <td nowrap align="center" width="25%" colspan="1">
                                                            <asp:RadioButton ID="rBranch" AutoPostBack="false"
                                                                Text="BRANCH" TextAlign="left" runat="server" GroupName = "Commbrkdown"></asp:RadioButton>
                                                        </td>
                                                        <td nowrap align="left" width="25%">
                                                            &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rSalesRep" GroupName = "Commbrkdown"
                                                                AutoPostBack="false" Text="SALES_REP_NUMBER" TextAlign="left" runat="server"></asp:RadioButton>
                                                        </td>  
                                                        <td nowrap align="left" width="25%">
                                                            &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rdealergrpComm" GroupName = "Commbrkdown"
                                                                AutoPostBack="false" Text="DEALER_GROUP" TextAlign="left" runat="server"></asp:RadioButton>
                                                        </td>                                                        
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" nowrap align="center" width="25%" colspan="3">
                                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td valign="top" width="48%" colspan="2" align="left">
