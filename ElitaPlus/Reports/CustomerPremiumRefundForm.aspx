...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CustomerPremiumRefundForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.CustomerPremiumRefundForm" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
	    <title id="rptWindowTitle" runat="server">CustomerPremiumRefund</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">CUSTOMER_PREMIUM_REFUND_REPORT</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
