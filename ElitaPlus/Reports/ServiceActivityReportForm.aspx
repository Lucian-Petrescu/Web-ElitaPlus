<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ServiceActivityReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ServiceActivityReportForm" %>
...
<html>
<head>
    <title id="rptWindowTitle" runat="server">SERVICE_ACTIVITY</title>
    ...
    <script language="JavaScript">	  
	    var arrCtr = [['cboManufacturer'],['rmanufacturer'],['rAllSVCandStore'],['rAllSVC'], ['rAllStore'], ['cboSVC'],['cboStore']]
    </script>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label7" runat="server"  CssClass="TITLELABELTEXT">SERVICE_ACTIVITY</asp:Label>
                        </td>
                                                        ...
                                                        <table id="Table2" border="0" cellpadding="1" cellspacing="1" width="85%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" nowrap colspan="1">                                                                    
                                                                    <asp:RadioButton ID="rAllSVCandStore" onclick="ToggleExt(this, arrCtr);" AutoPostBack="false"
                                                                        Checked="False" runat="server" Text="PLEASE_SELECT_ALL_SVC_AND_STORE" TextAlign="left">
                                                                    </asp:RadioButton>
                                                                </td>
                                                                <td align="left" nowrap colspan="1">                                                                    
                                                                    <asp:RadioButton ID="rAllSVC" onclick="ToggleExt(this, arrCtr);" AutoPostBack="false"
                                                                        Checked="False" runat="server" Text="PLEASE_SELECT_ALL_SVC" TextAlign="left">
                                                                    </asp:RadioButton>
                                                                </td>
                                                                 <td align="right" nowrap colspan="1">                                                                    
                                                                    <asp:RadioButton ID="rAllStore" onclick="ToggleExt(this, arrCtr);" AutoPostBack="false"
                                                                        Checked="False" runat="server" Text="PLEASE_SELECT_ALL_STORE" TextAlign="left">
                                                                    </asp:RadioButton>
                                                                </td>                                                              
                                                            </tr>
                                                             <tr>
                                                             ...
                                                             <tr>
                                                               ...
                                                               <td align="left" nowrap colspan="1">
                                                                    <asp:Label ID="lblSVC" runat="server">OR_A_SINGLE_SVC</asp:Label>&nbsp;&nbsp;
                                                                    <asp:DropDownList ID="cboSVC" runat="server" AutoPostBack="false" onchange="ToggleExt(this, arrCtr);">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td align="left" nowrap colspan="2">
                                                                    <asp:Label ID="lblStore" runat="server">OR_A_SINGLE_STORE</asp:Label>&nbsp;&nbsp;
                                                                    <asp:DropDownList ID="cboStore" runat="server" AutoPostBack="false" onchange="ToggleExt(this, arrCtr);">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr> 
                                                             <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td align="left" nowrap colspan="1">                                                                    
                                                                    <asp:RadioButton ID="rmanufacturer" onclick="ToggleExt(this, arrCtr);" AutoPostBack="false"
                                                                        Checked="False" runat="server" Text="PLEASE CHOOSE ALL MANUFACTURERS" TextAlign="left">
                                                                    </asp:RadioButton>
                                                                </td>
                                                                <td align="left" nowrap colspan="2">
                                                                    <asp:Label ID="cboManufacturerlbl" runat="server">OR A SINGLE MANUFACTURER</asp:Label>&nbsp;&nbsp;
                                                                    <asp:DropDownList ID="cboManufacturer" runat="server" AutoPostBack="false" onchange="ToggleExt(this, arrCtr);">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
