...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LcgReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.LcgReportForm" %>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">LCG</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				...
				<tr>
					<td vAlign="top" align="center" height="100%"><asp:panel id="WorkingPanel" runat="server">
							<TABLE id="tblMain1" style="BORDER-RIGHT: #999999 1px solid; BORDER-TOP: #999999 1px solid; BORDER-LEFT: #999999 1px solid; BORDER-BOTTOM: #999999 1px solid"
											...
											<TR>
												<TD align="center" >
													<TABLE  cellSpacing="0" cellPadding="0"  border="0">
																...
																<TABLE cellSpacing="0" cellPadding="0" border="0">
																	<TR>
																		<TD noWrap align="left" >
																			<asp:label id="moDealerLabel" runat="server">SELECT MONTH AND YEAR</asp:label>:</TD>
																		<TD align="left" >&nbsp;&nbsp;
																			<asp:dropdownlist id="moMonthDropDownList" runat="server" AutoPostBack="false" Width="141px"></asp:dropdownlist></TD>
																		<TD align="left" >&nbsp;&nbsp;&nbsp;</TD>
																		<TD noWrap align="left">
																			<asp:dropdownlist id="moYearDropDownList" runat="server" AutoPostBack="false" Width="80px"></asp:dropdownlist></TD>
																	</TR>
																</TABLE>
															</TD>
														</TR>
														...
														<TR>
															<TD align="left"><uc1:multiplecolumnddlabelcontrol id="multipleDropControl" runat="server"></uc1:multiplecolumnddlabelcontrol></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
								...
								<TR>
									<TD align="left">&nbsp;
										<input type=hidden id='ddSeparator'>
										<asp:button id="btnGenRpt" style="BACKGROUND-IMAGE: url(../Navigation/images/viewIcon2.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
											runat="server" Font-Bold="false" Width="100px" CssClass="FLATBUTTON" height="20px" Text="View"></asp:button></TD>
								</TR>
							</TABLE>
						</asp:panel></td>
				</tr>
