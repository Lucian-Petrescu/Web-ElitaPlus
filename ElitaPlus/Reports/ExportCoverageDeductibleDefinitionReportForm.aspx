...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ExportCoverageDeductibleDefinitionReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ExportCoverageDeductibleDefinitionReportForm" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title id="rptWindowTitle" runat="server">Export Coverage Definitions</title>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label7" runat="server" CssClass="TITLELABELTEXT">EXPORT_COVERAGE_DEDUCTIBLE_DEFINITIONS</asp:Label>
                        </td>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            <table cellspacing="2" cellpadding="0" width="90%" border="0">
                                                ...
                                                <tr>
                                                    <td style="height: 25px" valign="middle" align="center" width="50%" colspan="3" rowspan="1">
                                                        <table style="height: 25px" cellspacing="0" cellpadding="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td style="width: 110px" nowrap>
                                                                    &nbsp;
                                                                    <asp:TextBox ID="moBeginDateText" TabIndex="1" runat="server" Width="95px" CssClass="FLATTEXTBOX" onchange="enableReport()"></asp:TextBox>
                                                                </td>
