...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ClaimsAnalysisByReasonClosedFreeZone.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimsAnalysisByReasonClosedFreeZone"%>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Claims Analysis By Reason Closed including Free Zone</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">CLAIMS_ANALYSIS_BY_REASON_CLOSED_INCLUDING_FREE_ZONE</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
														...
														<TR>
															<TD style="BORDER-TOP: gray thin solid; BORDER-BOTTOM: gray thin" noWrap align="center"
																...
																<TABLE id="Table3" cellSpacing="2" cellPadding="0" width="75%" border="0">
																	...
																	<TR>
																		<TD style="HEIGHT: 13px" noWrap align="left">
																			<asp:RadioButton id="rSvcCtr"
																				AutoPostBack="false" Checked="True" Runat="server" TextAlign="left" Text="PLEASE SELECT ALL SERVICE CENTERS"></asp:RadioButton></TD>
																	</TR>
																	<TR>
