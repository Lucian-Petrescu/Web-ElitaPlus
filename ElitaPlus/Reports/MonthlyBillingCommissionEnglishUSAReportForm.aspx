...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MonthlyBillingCommissionEnglishUSAReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.MonthlyBillingCommissionEnglishUSAReportForm" %>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>MonthlyBillingCommissionEnglish_USA</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">Monthly Billing Commission</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
													...
													<TABLE cellSpacing="2" cellPadding="0" width="75%" border="0">
														...
														<TR>
															...
															<TD style="HEIGHT: 17px" noWrap align="right">
																<asp:label id="moBrokerCommPercentLabel" runat="server">BROKER COMMISSION %</asp:label>: 
																&nbsp;&nbsp;
																<asp:TextBox id="moBrokerCommPercentText" CssClass="FLATTEXTBOX" Width="40" Runat="server" MaxLength="3"></asp:TextBox></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
