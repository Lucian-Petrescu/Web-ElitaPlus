...
Namespace Reports
    ...
    Partial Class NewCertificatesByBranchEnglishUSAReportForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME As String = "NewCertificatesByBranch"
        Private Const RPT_FILENAME_EXPORT As String = "NewCertificatesByBranch-Exp"
        ...
        Private Const TOTALPARAMS As Integer = 25 '21 ' 15  ' 14
        Private Const TOTALEXPPARAMS As Integer = 13 '11 '6  ' 7
        Private Const PARAMS_PER_REPORT As Integer = 13 '11
...
#Region "Populate"
        ...
        Sub populateDealersList()
            ...
            If Not CompanyMultiDrop.SelectedGuid = Guid.Empty Then
                dv = LookupListNew.GetDealerLookupList(CompanyMultiDrop.SelectedGuid)
            Else
                dv = LookupListNew.GetDealerLookupList(CompanyMultiDrop.SelectedGuid)
            End If
...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal compcode As String, ByVal compdesc As String, ByVal dealerCode As String, ByVal dealerName As String, ByVal beginDate As String,
                                  ByVal endDate As String, ByVal detailCode As String, ByVal langCode As String, ByVal dateAddedSold As String, ByVal bybranch As String,
        ...
        Private Sub GenerateReport()
            ...
            If (moReportFormat = ReportCeBase.RptFormat.TEXT_TAB) OrElse (moReportFormat = ReportCeBase.RptFormat.TEXT_CSV) Then
                ...
                params = SetExpParameters(compCode, compDesc, dealerCode, dealerName, beginDate,
                              endDate, detailCode, langCode, dateAddedSold, bybranch, dealerGroup, dealersList)
            Else
                'View Report
        ...
        Sub SetReportParams(ByVal oReportParams As ReportParams, ByVal repParams() As ReportCeBaseForm.RptParam,
            ...
            With oReportParams
                ...
                repParams(startIndex + 11) = New ReportCeBaseForm.RptParam("V_DEALER_GROUP", GuidControl.GuidToHexString(.dealerGroup), reportName)
                repParams(startIndex + 12) = New ReportCeBaseForm.RptParam("V_DEALER_LIST", .dealersList, reportName)
            End With
