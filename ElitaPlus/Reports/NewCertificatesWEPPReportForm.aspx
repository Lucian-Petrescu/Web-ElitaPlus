<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NewCertificatesWEPPReportForm.aspx.vb"
 Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.NewCertificatesWEPPReportForm" %>
											...
											<TR>
												<TD align="center" colSpan="3">
													<TABLE cellSpacing="2" cellPadding="0" width="95%" border="0">
														...
														<TR>
												            <TD colSpan="3"><HR style="WIDTH: 99.43%; HEIGHT: 1px" /></TD>
											            </TR>
														<TR>
															<TD noWrap align="center" width="25%" colSpan="3">
																<asp:CheckBox id="chkTotalsPageByCov"  Text="SHOW_TOTALS_PAGE_BY_COVERAGE"
																	AutoPostBack="false" Runat="server" TextAlign="Left"></asp:CheckBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															</TD>															
														</TR>
													</TABLE>
												</TD>
