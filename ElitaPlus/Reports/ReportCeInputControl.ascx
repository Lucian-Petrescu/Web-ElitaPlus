<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ReportCeInputControl.ascx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ReportCeInputControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<input id="hdExcludeSSRSConfigurationCheck" type="hidden" name="hdExcludeSSRSConfigurationCheck" visible="false" runat="server" />
