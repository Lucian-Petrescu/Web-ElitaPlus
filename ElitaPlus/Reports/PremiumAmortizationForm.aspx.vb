...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(companyCode As String, selectedYearMonth As String, dealerCode As String, _
                               detailCode As String, selectedGroupId As String, addlDACCode As String, langCode As String, _
        ...
        Function SetTotalByCovParameters(companyCode As String, selectedYearMonth As String, dealerCode As String, _
                               detailCode As String, selectedGroupId As String, addlDACCode As String, langCode As String, _
                                dealerForCur As Guid, rptCurrency As Guid, exchangeRateCode As String) As ReportCeBaseForm.Params
            Dim reportFormat As ReportCeBaseForm.RptFormat
            Dim params As New ReportCeBaseForm.Params
        ...
        Function SetExpParameters(companyCode As String, selectedYearMonth As String, dealerCode As String, _
                                detailCode As String, selectedGroupId As String, addlDACCode As String, langCode As String, _
                                 dealerForCur As Guid, rptCurrency As Guid, exchangeRateCode As String) As ReportCeBaseForm.Params
