...
Namespace Reports
    Partial Class PremiumAmortizationForm
        Inherits ElitaPlusPage

#Region "Constants"

        Private Const RPT_FILENAME_WINDOW As String = "PREMIUM AMORTIZATION"
        Private Const RPT_FILENAME As String = "PremiumAmortization"
        ...
        Public Const PAGETITLEWITHCURRENCY As String = "Premium Amortization WITH CURRENCY"
...
#Region "Populate"
        ...
        Private Sub PopulateDealerDropDown()
            ...
            UserDealerMultipleDrop.SetControl(False, _
                                              UserDealerMultipleDrop.MODES.NEW_MODE, _
                                              True, _
                                              dv, _
                                              TranslationBase.TranslateLabelOrMessage(LABEL_OR_A_SINGLE_DEALER), _
                                              True, _
                                              False, _
                                              " ctl00_ContentPanelMainContentBody_rdealer.checked = false;  ctl00_ContentPanelMainContentBody_rGroup.checked = false; ctl00_ContentPanelMainContentBody_cboDealerGroup.selectedIndex = -1;ctl00_ContentPanelMainContentBody_ddlDealerCurrency.selectedIndex = -1; fncEnable(2);", _
                                              "ctl00_ContentPanelMainContentBody_moUserDealerMultipleDrop_moMultipleColumnDrop", _
        ...
        Public Sub ClearLabelsErrSign()
            Try
                ...
                Me.ClearLabelErrSign(lblExchangeRateDate)
        ...
        Private Sub EnableOrDisableControls()
            ...
            If (Not UserCompanyMultipleDrop.SelectedGuid.Equals(Guid.Empty)) Then
                ...
                If (DAC_CODE <> Codes.ADDL_DAC__NONE) Then
                    ...
                    If rGroup.Checked = True Or Me.GetSelectedItem(Me.cboDealerGroup) <> Guid.Empty Then ' cboDealerGroup.SelectedItem.ToString <> String.Empty Then
                        Me.chkTotalsPageByCov.Enabled = True
                        Me.lblTotalsByCov.Enabled = True
                    Else
...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal companyCode As String, ByVal selectedYearMonth As String, ByVal dealerCode As String, _
                               ByVal detailCode As String, ByVal selectedGroupId As String, ByVal addlDACCode As String, ByVal langCode As String, _
        ...
        Function SetTotalByCovParameters(ByVal companyCode As String, ByVal selectedYearMonth As String, ByVal dealerCode As String, _
                               ByVal detailCode As String, ByVal selectedGroupId As String, ByVal addlDACCode As String, ByVal langCode As String, _
                                dealerForCur As Guid, rptCurrency As Guid, exchangeRateCode As String) As ReportCeBaseForm.Params
            Dim reportFormat As ReportCeBaseForm.RptFormat
            Dim params As New ReportCeBaseForm.Params
