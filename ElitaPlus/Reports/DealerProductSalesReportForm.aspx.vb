...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal CompanyId As String, ByVal CompanyCode As String, ByVal companydesc As String, ByVal dealerCode As String, ByVal dealerDesc As String,
                                  ByVal begindate As String, ByVal enddate As String, ByVal isDetail As String, ByVal sortorder As String) As ReportCeBaseForm.Params
        ...
        End Function
        Function SetExpParameters(ByVal CompanyId As String, ByVal CompanyCode As String, ByVal companydesc As String, ByVal dealerCode As String, ByVal dealerDesc As String,
                                  ByVal begindate As String, ByVal enddate As String, ByVal isDetail As String, ByVal sortorder As String) As ReportCeBaseForm.Params
