...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BillingRegisterReInsuranceReportForm.aspx.vb" 
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.BillingRegisterReInsuranceReportForm" %>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">BILLING_REGISTER_REINSURANCE</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
