...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DKInvoicesToBePaidForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.DKInvoicesToBePaidForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
	    <title id="rptWindowTitle" runat="server">InvoicesToBePaid</title>
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelReports"  CssClass="TITLELABEL" runat="server">Reports</asp:label>:
								                <asp:label id="Label7" CssClass="TITLELABELTEXT" runat="server">DK_INVOICES_TO_BE_PAID</asp:label></TD>
