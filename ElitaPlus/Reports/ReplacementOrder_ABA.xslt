          ...
          <tr>
            <td>
              <table cellpadding="2" cellspacing="0" border="0" style="WIDTH:100%">
                <tr>
                  <td>
                    <TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
                      ...
                      <tr>
                        <td></td>
                        <td id="company">N° de Autorización de Reemplazo:</td>
                ...
                <tr>
                  <td class="title">
                    AUTORIZACION DE REEMPLAZO / RECUPERO DE REEMPLAZO
                  </td>
                </tr>
                <tr>
                  <td>
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="label">Código Dealer / Centro </td>
                        <td class="TDBox">
                          &#160;
                ...
                <tr>
                  <td>
                    <table cellpadding="0" cellspaccing="0" border="0" width="100%">
                      <tr>
                        <td width="50%" class="title">______Firma Revisa______</td>
                        <td class="title">______Firma Aprueba______</td>
                      </tr>
                    </table>
                  </td>
                </tr>
