...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ESCRegister_Brazil_Form.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ESCRegister_Brazil_Form" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>ESCRegister_Brazil</title>
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelReports" runat="server" CssClass="TITLELABEL">Reports</asp:label>:&nbsp;<asp:label id="Label7" runat="server" CssClass="TITLELABEL">ESC Register</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
													...
													<TABLE cellSpacing="2" cellPadding="0" width="75%" border="0">
															...
															<TD align="center" width="50%" colSpan="4">
																<TABLE cellSpacing="0" cellPadding="0" width="75%" border="0">
																	<TR>
																		...
																		<td><asp:imagebutton id="BtnBeginDate" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
																		<TD vAlign="middle" noWrap align="right">
																		...
																		<td><asp:imagebutton id="BtnEndDate" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton></TD>
																		<td width="50%">&nbsp;</td>
																	</TR>
																</TABLE>
															</TD>
														...
														<TR>
															...
															<TD noWrap align="left" width="25%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<asp:label id="moDealerLabel" runat="server">SELECT DEALER</asp:label>&nbsp;&nbsp;
																<asp:dropdownlist id="cboDealer" runat="server"></asp:dropdownlist></TD>
														</TR>
														<TR>
															<TD>&nbsp;</TD>
															<TD>&nbsp;</TD>
