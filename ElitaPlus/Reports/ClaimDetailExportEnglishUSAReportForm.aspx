...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ClaimDetailExportEnglishUSAReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimDetailExportEnglishUSAReportForm" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title id = "rptWindowTitle" runat =server>ClaimDetailExportEnglish_USA</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">Claim Detail</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
