                                        ...
                                        <TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
                                            ...
                                            <tr>
                                                <td class="title" colspan="3">
                                                    SERVIZIO ESTENSIONE DI GARANZIA
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tblInner">
                                                                    ...
                                                                    <tr>
                                                                        <td class="title" colspan="2" style="text-align:center;padding-top:3px;border-top:2px #000 solid;border-bottom:2px #000 solid;">
                                                                            Descrizione del guasto
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="TDBox" style="height:50px;" colspan="2">&#160;
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tblInner">
                                                                    <tr>
                                                                        <td class="bold">
                                                                            1).  Confermare rricezione del messaggio<br />
                                                                            2).  Coordinare visita/ritiro con il cliente<br />
                                                                            3).  Completare i dati manacanti
