...
#Region "Crystal Enterprise"
        ...
        Private Sub GenerateReport()
            ...
            Me.PopulateBOProperty(Me.State.MyBO, "ReportType", "COVERAGE_DEDUCTIBLE_DEFINITIONS")
            Me.PopulateBOProperty(Me.State.MyBO, "ReportProc", "R_EXPORTCOVERAGEDEDUCTIBLE.Oralce_Export")
