...
Namespace Reports
    Partial Public Class DKNewCertificatesbyCoverageForm
        Inherits ElitaPlusPage
#Region "Constants"

        Private Const RPT_FILENAME_WINDOW As String = "DK_NEW_CERTIFICATES_BY_COVERAGE"
        Private Const RPT_FILENAME As String = "DKNewCertificatesByCoverage"
...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal userId As String, ByVal dealerCode As String, ByVal beginDate As String,
            ...
            SetReportParams(rptParams, repParams, "Cert-Total", PARAMS_PER_REPORT * 1)     ' Main Report
            ' SetReportParams(rptParams, repParams, "Legend", PARAMS_PER_REPORT * 2)     ' Main Report
