...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MissingRiskTypesInPriceGroupsForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.MissingRiskTypesInPriceGroupsForm" %>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Missing Risk Types In Price Lists</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server"  CssClass="TITLELABELTEXT">RPT_MISSING_RISK_TYPES_IN_PRICE_LISTS_REPORT</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
