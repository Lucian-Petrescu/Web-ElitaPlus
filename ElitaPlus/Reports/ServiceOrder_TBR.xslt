    ...
    <html>
      <head>
        <style>
          ...
          #Address{FONT-SIZE:14px;font-weight:bold;text-align:right;}
              ...
              <table cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td id="Address">
                    ...
                    <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:RPC_NAME" /><br />
                    CNPJ: <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:TAX_ID" /><br />
                    <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:RPC_ADDRESS1" /><br />
                    <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:RPC_ADDRESS2" /><br />
                    <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:RPC_CITY" />,&#160;<xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:RPC_STATE_PROVINCE" />  <br />
                    CEP <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:RPC_ZIP" /><br/>
                    <br />
                    ENCAMINHAR NOTA FISCAL PARA  COBRANÇA:<br/>
                    <xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:COMPANY_NAME" /><br />
                    ENDEREÇO:<xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:COMPANY_ADDRESS1" /><br />
