<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ExportDeniedClaimsReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ExportDeniedClaimsReportForm" %>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label7" runat="server" Font-Bold="false" CssClass="TITLELABELTEXT">DENIED_CLAIMS_EXPORT</asp:Label>
                        </td>
