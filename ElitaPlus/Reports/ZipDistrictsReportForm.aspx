...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ZipDistrictsReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ZipDistrictsReportForm"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>ZIP Districts Report</title>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelReports" runat="server" cssclass="TITLELABEL">Reports</asp:label>:
									<asp:label id="lblZIPDISTRICTS" runat="server" cssclass="TITLELABELTEXT">ZIP_DISTRICTS</asp:label></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD align="center" colSpan="3">
													...
													<TABLE id="Table1" style="HEIGHT: 124px" cellSpacing="2" cellPadding="0" width="75%" border="0">
														<TR>
															<TD noWrap align="center">
																<asp:label id="moLabelReq_NO_TRANSLATE" runat="server"></asp:label>
																<asp:label id="moCountryLabel" runat="server">Country</asp:label>:
																<asp:label id="moCountryLabel_NO_TRANSLATE" runat="server"></asp:label>
																<asp:dropdownlist id="moCountryDrop" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
														</TR>
														<TR>
															<TD>
																<HR style="HEIGHT: 1px">
														...
														<TR>
															<TD noWrap align="left">*
																<asp:RadioButton id="rZipDistricts" onclick="ToggleDualDropDownsSelection('multipleDropControl_moMultipleColumnDrop', 'multipleDropControl_moMultipleColumnDropDesc', 'rZipDistricts', false, ''); document.all.item('multipleDropControl_lb_DropDown').style.color = '';"
																	AutoPostBack="false" Text="ALL_ZIP_DISTRICTS" TextAlign="left" Runat="server" Checked="True"></asp:RadioButton></TD>
														</TR>
														<TR>
															<TD noWrap align="left">
