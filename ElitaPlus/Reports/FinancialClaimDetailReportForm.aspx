<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FinancialClaimDetailReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.FinancialClaimDetailReportForm" %>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label7" runat="server"  CssClass="TITLELABELTEXT">FINANCIAL_CLAIM_DETAIL</asp:Label>
                        </td>
