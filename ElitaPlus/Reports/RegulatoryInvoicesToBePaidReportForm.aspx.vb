...
Namespace Reports
    ...
    Partial Class RegulatoryInvoicesToBePaidReportForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "REGULATORY_PAID_CLAIMS"
        Private Const RPT_FILENAME As String = "RegulatoryPaidClaims"
        ...
        Public Const PAGETITLE As String = "REGULATORY_PAID_CLAIMS"
        Public Const PAGETAB As String = "REPORTS"
        Public Const DOCTITLE As String = "REGULATORY_PAID_CLAIMS"
...
#Region "Report Parameters"
        ...
        Function SetParameters(ByVal companyCode As String, ByVal companyDesc As String,
                               ByVal viewOption As String, ByVal selectedYearMonth As String,
                               ByVal Rpt_GenerateDate As String, ByVal periodExists As Boolean,
            ...
            Dim repParams() As ReportCeBaseForm.RptParam = New ReportCeBaseForm.RptParam() _
                    {
                     ...
                     New ReportCeBaseForm.RptParam("V_YEAR_MONTH", RptGenerateDate),
                     New ReportCeBaseForm.RptParam("V_REPORTNAME", RPT_FILENAME),
                     New ReportCeBaseForm.RptParam("V_VIEWOPTION", viewOption),
                     New ReportCeBaseForm.RptParam("V_PERIODEXISTS", CType(periodExists, String)),
...
#Region "View Report"
        ...
        Private Sub GenerateReport(ByVal ResponseVal As String)
            ...
            Dim selectedMonthYear As String ' MMYYYY format
