...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UPRClipReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.UPRClipReportForm" %>
...
<html>
<head>
    <title id="rptWindowTitle" runat="server">PremiumAmortization</title>
                        ...
                        <tr>
                            <td height="20">
                                <asp:Label ID="LabelReports"  CssClass="TITLELABEL" runat="server">Reports</asp:Label>:<asp:Label
                                    ID="Label7" runat="server"  CssClass="TITLELABELTEXT">UPR_CLIP</asp:Label></td>
                                                ...
                                                <table id="Table2" style="width: 596px;" cellspacing="1" cellpadding="1" width="596"
                                                    ...
                                                    <tr>
                                                        <td style="height: 22px" valign="middle" align="left" colspan="4">
                                                            *
                                                            <asp:RadioButton ID="rdealer" onclick=" document.all.item('moUserDealerMultipleDrop_lb_DropDown').style.color = ''; ToggleExt(this, arrDealerCtr); "
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="2">
                                                            <asp:DropDownList ID="cboDealerGroup" runat="server" Width="190px" type="DropDown"
                                                                onchange="ToggleExt(this, arrDealerGroupCtr); document.all.item('moUserDealerMultipleDrop_lb_DropDown').style.color = '';">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
