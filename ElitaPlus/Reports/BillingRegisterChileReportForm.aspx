<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/Reports/content_Report.Master" 
     Codebehind="BillingRegisterChileReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.BillingRegisterChileReportForm" %>     
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPanelMainContentBody" runat="server" >
    ...
    <tr>
        ...
        <tr runat="server" id="trDealer">
            ...
            <td>
                <uc3:MultipleColumnDDLabelControl ID="multipleDealerDropControl" runat="server">
