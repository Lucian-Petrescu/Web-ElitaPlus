...
Namespace Reports
    ...
    Public Class InvoicesToBePaidReInsuranceForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "Invoices To Be Paid Reinsurance"
        Private Const RPT_FILENAME As String = "InvoicesToBePaidReinsurance"
        Private Const RPT_FILENAME_EXPORT As String = "InvoicesToBePaidReinsurance-Exp"
        ...
        Public Const PAGETITLE As String = "INVOICES TO BE PAID REINSURANCE"
        Public Const PAGETITLEWITHCURRENCY As String = "INVOICES TO BE PAID REINSURANCE WITH CURRENCY"
