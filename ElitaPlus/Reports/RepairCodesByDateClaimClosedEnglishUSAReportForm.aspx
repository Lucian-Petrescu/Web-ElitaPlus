...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RepairCodesByDateClaimClosedEnglishUSAReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.RepairCodesByDateClaimClosedEnglishUSAReportForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>RepairCodeForClaim</title>
	...
	function toggleDateSelection(isClaimClosedDate)
	{
		//debugger;
		if(!isClaimClosedDate)
		{
			document.forms[0].RadiobuttonByClaimOpenedDate.checked = false;
		}
		else
		{
			document.forms[0].RadiobuttonByClaimClosedDate.checked = false;
		}
	}
		</script>
	</HEAD>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server"  cssclass="TITLELABELTEXT">Repair Codes</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
											...
											<TR>
												<TD align="center" colSpan="3">
													<TABLE cellSpacing="2" cellPadding="0" width="75%" border="0">
															...
															<TD align="center" width="50%" colSpan="3">
																<TABLE cellSpacing="0" cellPadding="0" width="75%" border="0">
																	<TR>
																		...
																		<TD>
																			<asp:imagebutton id="BtnBeginDate" runat="server" Width="20px" Height="17px" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton></TD>
																		<TD vAlign="middle" noWrap align="right">&nbsp;&nbsp;
																		...
																		<TD>
																			<asp:imagebutton id="BtnEndDate" runat="server" Width="20px" Height="17px" ImageUrl="../Common/Images/calendarIcon2.jpg"></asp:imagebutton></TD>
																		<TD width="50%">&nbsp;</TD>
																	</TR>
																</TABLE>
															</TD>
														...
														<TR>
															<TD noWrap align="right" width="15%" colSpan="2">
																<asp:RadioButton id="RadiobuttonByClaimClosedDate" onclick="toggleDateSelection(false);" AutoPostBack="false"
																	Runat="server" Text="Please choose claim close date" TextAlign="left"></asp:RadioButton></TD>
															<TD noWrap align="left" width="35%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<asp:RadioButton id="RadiobuttonByClaimOpenedDate" onclick="toggleDateSelection(true);" AutoPostBack="false"
																	Runat="server" Text="or claim open date" TextAlign="left"></asp:RadioButton></TD>
														</TR>
														<TR>
															<TD>&nbsp;</TD>
															<TD>&nbsp;</TD>
														...
														<TR>
															...
															<TD vAlign="top" colSpan="2">
																<asp:RadioButtonList id="rdReportSortOrder" runat="server" RepeatDirection="Vertical">
																	<asp:ListItem Value="1" Selected="True">Repair Code</asp:ListItem>
																	<asp:ListItem Value="2">Service Center Name</asp:ListItem>
																	<asp:ListItem Value="3">Manufacturer</asp:ListItem>
																	<asp:ListItem Value="4">Repair Date</asp:ListItem>
																	<asp:ListItem Value="5">Customer Zip Code</asp:ListItem>
