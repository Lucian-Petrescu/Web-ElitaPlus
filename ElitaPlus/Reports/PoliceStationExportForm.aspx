...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PoliceStationExportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.PoliceStationExportForm"%>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>PoliceStationExport</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">Police Station</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
