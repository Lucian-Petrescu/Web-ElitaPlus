...
#Region "Handlers-Init"
        ...
        Private Sub ClearErrLabels()
            Me.ClearLabelErrSign(PriceListMultipleDrop.CaptionLabel)
            If Me.rPriceLists.Checked Then PriceListMultipleDrop.SelectedIndex = -1
        End Sub
#End Region
...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal companyCode As String, ByVal priceList As String) As ReportCeBaseForm.Params
        ...
        Private Sub GenerateReport()
            ...
            If Me.rPriceLists.Checked Then
                priceList = ALL
            Else
