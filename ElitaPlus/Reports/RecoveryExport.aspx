<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RecoveryExport.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.RecoveryExport" %>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title id = "rptWindowTitle" runat=server>Recovery Export</title>
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelReports" runat="server"  cssclass="TITLELABEL" >Reports</asp:label>:&nbsp;<asp:label id="Label7" runat="server"   cssclass="TITLELABELTEXT" >Recovery_Export</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
