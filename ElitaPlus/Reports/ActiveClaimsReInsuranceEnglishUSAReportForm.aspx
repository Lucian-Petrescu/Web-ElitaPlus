<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActiveClaimsReInsuranceEnglishUSAReportForm.aspx.vb" 
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ActiveClaimsReInsuranceEnglishUSAReportForm" %>
                    ...
                    <tr>
                        <td height="20">
                            <asp:Label ID="LabelReports" runat="server"  CssClass="TITLELABEL">Reports</asp:Label>:&nbsp;<asp:Label
                                ID="Label7" runat="server" CssClass="TITLELABELTEXT">ACTIVE_CLAIMS_REINSURANCE</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                            ...
                                            <table id="tblSearch" style="border-right: #999999 1px solid; border-top: #999999 1px solid;
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <uc1:ReportCeInputControl ID="moReportCeInputControl" runat="server" ExportDataVisible="True" ViewVisible="False"></uc1:ReportCeInputControl>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
