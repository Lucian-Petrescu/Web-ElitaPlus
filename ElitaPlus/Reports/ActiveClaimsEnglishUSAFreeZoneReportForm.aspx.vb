...
Namespace Reports
    ...
    Partial Class ActiveClaimsEnglishUSAFreeZoneReportForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "ACTIVE_CLAIMS_INCLUDING_FREE_ZONE"
        'Private Const RPT_FILENAME As String = "ActiveClaimsEnglishUSA"
        'Private Const RPT_FILENAME_EXPORT As String = "ActiveClaimsEnglishUSA_Exp"

        Private Const RPT_FILENAME As String = "ActiveClaimsFreeZone"
        Private Const RPT_FILENAME_EXPORT As String = "ActiveClaimsFreeZone-Exp"
            ...
            Try
                ...
                If (moReportFormat = ReportCeBase.RptFormat.TEXT_TAB) OrElse (moReportFormat = ReportCeBase.RptFormat.TEXT_CSV) Then
                    ...
                    params = SetExpParameters(GuidControl.GuidToHexString(userId), countryCode, dealerCode, svcCenterCode, svcCenterName,
                                 numberActiveDays, includeAllClaims, FreeZoneFlag, sortOrder, langCode, langCultureValue, createdby)
                Else
                    'View Report
...
#Region "Crystal Enterprise"
        ...
        Sub SetReportParams(ByVal oReportParams As ReportParams, ByVal repParams() As ReportCeBaseForm.RptParam,
            ...
            With oReportParams
                ...
                repParams(startIndex + 5) = New ReportCeBaseForm.RptParam("V_FREE_ZONE_FLAG", .IsFreeZone, reportName)
        ...
        Function SetParameters(ByVal userId As String, ByVal countryCode As String, ByVal dealerCode As String, ByVal svcCenterCode As String,
                                 ...
                                 ByVal numberActiveDays As Integer, ByVal includeAllClaims As String, ByVal IsFreeZone As String, ByVal sortOrder As String,
        ...
        Private Sub cboCountry_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCountry.SelectedIndexChanged
            ...
            Try
                ...
                Else
                    ...
                    Me.cboSvcCenter.Populate(ServiceCenters.ToArray(),
                                            New PopulateOptions() With
                                            {
                                                .AddBlankItem = True
                                            })
