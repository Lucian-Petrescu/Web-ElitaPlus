    ...
    <html>
      ...
      <body>
        <table cellpadding="0" cellspacing="0" border="0" style="PADDING-RIGHT:10px;PADDING-LEFT:10px;width:100%">
          <tr>
            <td colspan="2">
              <table style="width:100%">
                ...
                <tr>
                  <td>
                    Replacement Service Request Claim Number: &#160;<xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:CLAIM_NUMBER" />-<xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:AUTHORIZATION_NUMBER" />
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td>
              Date Of Purchase:&#160;<xsl:value-of select="substring(a:ServiceOrderReport/a:ServiceOrder/a:WARRANTY_SALES_DATE,6,2)" />
              <xsl:text>/</xsl:text>
