          ...
          <tr>
            <td colspan="2">
              <table style="width:100%">
                ...
                <tr>
                  <td>
                    Service Request Claim Number: &#160;<xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:CLAIM_NUMBER" />-<xsl:value-of select="a:ServiceOrderReport/a:ServiceOrder/a:AUTHORIZATION_NUMBER" />
                  </td>
                </tr>
              </table>
            </td>
