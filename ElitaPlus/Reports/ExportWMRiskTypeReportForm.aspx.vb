...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(selectedDealerId As String, langCode As String) As ReportCeBaseForm.Params
        ...
        Private Sub GenerateReport()
            ...
            State.ForEdit = True
            PopulateBOProperty(State.MyBO, "ReportType", "WM_RISKTYPE")
            PopulateBOProperty(State.MyBO, "ReportProc", "R_WMRiskType.Oralce_Export")
