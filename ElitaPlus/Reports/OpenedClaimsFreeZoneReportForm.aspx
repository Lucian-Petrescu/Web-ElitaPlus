...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="OpenedClaimsFreeZoneReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.OpenedClaimsFreeZoneReportForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title id="rptWindowTitle" runat="server">CLAIM_DETAIL_BY_DATE_OPENED_INCLUDING_FREE_ZONE</title>
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:Label ID="LabelReports"  CssClass="TITLELABEL" runat="server">Reports</asp:label>:&nbsp;<asp:Label ID="Label7" runat="server"  CssClass="TITLELABELTEXT">CLAIM_DETAIL_BY_DATE_OPENED_INCLUDING_FREE_ZONE</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
