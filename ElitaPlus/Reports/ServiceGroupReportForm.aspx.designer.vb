...
Namespace Reports
    ...
    Partial Public Class ServiceGroupReportForm
        ...
        '''<summary>
        '''rServiceGroups control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents rServiceGroups As Global.System.Web.UI.WebControls.RadioButton
        ...
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents moMfgLabel As Global.System.Web.UI.WebControls.Label
        ...
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents moMfgDrop As Global.System.Web.UI.WebControls.DropDownList
