...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NewCancellationsReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.NewCancellationsEnglishUSAReportForm" %>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>NewCancellations</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">New Cancellations</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
														...
														<TR>
															...
															<TD noWrap align="left" width="25%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																<asp:RadioButton id="RadiobuttonDetail" onclick="toggleDetailSelection(true);" AutoPostBack="false"
																	Checked="True" Runat="server" Text="OR SHOW DETAIL WITH TOTALS" TextAlign="left"></asp:RadioButton></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
