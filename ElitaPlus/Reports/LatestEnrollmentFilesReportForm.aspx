<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LatestEnrollmentFilesReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.LatestEnrollmentFilesReportForm" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title id="rptWindowTitle" runat="server">LATEST_ENROLLMENT_FILES</title>
                ...
                <table width="100%" border="0">
                    <tr>
                        <td height="20">
                            ...
                            <asp:Label ID="Label7" runat="server"  CssClass="TITLELABELTEXT">LATEST_ENROLLMENT_FILES</asp:Label>
                        </td>
                                                    ...
                                                    <td align="center" colspan="4" valign="top">
                                                        <table cellspacing="1" cellpadding="0" width="85%" border="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td nowrap align="right">
                                                                    <asp:Label ID="lblnumber" runat="server">ENTER_A_NUMBER</asp:Label>:
                                                                </td>
