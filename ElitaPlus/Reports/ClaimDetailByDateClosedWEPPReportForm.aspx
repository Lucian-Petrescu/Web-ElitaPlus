<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ClaimDetailByDateClosedWEPPReportForm.aspx.vb" 
Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimDetailByDateClosedWEPPReportForm" %>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top" width="55%" colspan="2">
                                                                        <asp:RadioButtonList ID="rdReportSortOrder" runat="server" RepeatDirection="Vertical">
                                                                            ...
                                                                            <asp:ListItem Value="7">Branch</asp:ListItem>
