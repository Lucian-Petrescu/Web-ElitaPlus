...
#End Region
        ...
        Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
            ...
            Try
                If Not IsPostBack Then
                    ...
                    AddCalendar(BtnCutOffDate, txtCutOffDate)
        ...
        Public Sub ClearLabelsErrSign()
            Try
                ...
                ClearLabelErrSign(lblCutOffDate)
    ...
    End Sub
        ...
        Private Sub GenerateReport()
            ...
            PopulateBOProperty(State.MyBO, "ReportType", "FILE_RECONCILIATION")
            PopulateBOProperty(State.MyBO, "ReportProc", "r_file_reconciliation.report")
