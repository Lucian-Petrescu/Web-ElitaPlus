...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AgentFixedCommissionReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.AgentFixedCommissionReportForm" %>

<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title id="rptWindowTitle" runat="server">AgentFixedCommission</title>
                    ...
                    <tr>
                        <td height="20">
                            <asp:Label ID="LabelReports"  CssClass="TITLELABEL" runat="server">Reports</asp:Label>:&nbsp;<asp:Label
                                ID="Label7" runat="server"  CssClass="TITLELABELTEXT">Agent Fixed Commission</asp:Label>
                        </td>
                                        ...
                                        <td align="center" colspan="3">
                                            <table border="0" cellpadding="0" cellspacing="2" width="75%">
                                                ...
                                                <asp:RadioButton ID="rbyBranch" runat="server" AutoPostBack="false" Checked="True"
                                                    ...
                                                    <td align="left">
                                                        <asp:RadioButton ID="rbySalesRep" runat="server" AutoPostBack="false" GroupName="gb"
                                                            onclick="toggleRadioButtonSelection('rbyBranch','rbySalesRep',true);" Text="SALES_REP"
