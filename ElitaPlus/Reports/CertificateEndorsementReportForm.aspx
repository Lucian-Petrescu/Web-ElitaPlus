...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CertificateEndorsementReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.CertificateEndorsementReportForm" %>
<%@ Register TagPrefix="uc1" TagName="ReportCeInputControl" Src="ReportCeInputControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Certificate Endorsements</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">Certificate Endorsements</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
								...
								<TR>
									<TD align="left">&nbsp;
										<asp:button id="btnGenRpt" style="BACKGROUND-IMAGE: url(../Navigation/images/viewIcon2.gif); CURSOR: hand; BACKGROUND-REPEAT: no-repeat"
											runat="server" Font-Bold="false" CssClass="FLATBUTTON" Width="100px" height="20px" Text="View"></asp:button></TD>
								</TR>
							</TABLE>
						</asp:panel></td>
				</tr>
