...
Namespace Reports
    ...
    Partial Class BillingRegisterReInsuranceReportForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "Billing Register Reinsurance"
        Private Const RPT_FILENAME As String = "BillingRegisterReinsurance"
        Private Const RPT_FILENAME_EXPORT As String = "BillingRegisterReinsurance_Exp"
...
#End Region
        ...
        Sub PopulateDealerDropDown()
            ...
            cboDealer.Populate(DealerList, New PopulateOptions() With
                {
                   .AddBlankItem = True
                })

            cboDealerCode.Populate(DealerList, New PopulateOptions() With
                {
                   .AddBlankItem = True,
        ...
        Function SetParameters(companyCode As String, dealerCode As String, begindate As String, enddate As String, isSummary As String, sortorder As String) As ReportCeBaseForm.Params
