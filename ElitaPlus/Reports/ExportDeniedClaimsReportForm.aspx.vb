...
Namespace Reports
    Partial Public Class ExportDeniedClaimsReportForm
        Inherits ElitaPlusPage

#Region "Constants"

        Private Const RPT_FILENAME_WINDOW As String = "DENIED_CLAIMS_EXPORT"
        Private Const RPT_FILENAME As String = "DeniedClaims"
        Private Const RPT_FILENAME_EXPORT As String = "DeniedClaims-Exp"
