...
#Region "Report Parameters"
        ...
        Private Sub GenerateReport()
            ...
            If RadiobuttonCollected.Checked Then
                billingStatus = "C"
            ElseIf RadiobuttonInCollection.Checked Then
                billingStatus = "I"
            ElseIf RadiobuttonNotCollected.Checked Then
                billingStatus = "R"
            ElseIf RadiobuttonAllOptions.Checked Then
                billingStatus = ALL
            Else
            ...
            If RadiobuttonDetail.Checked Then
                detailCode = YES
            ElseIf RadiobuttonTotalsOnly.Checked Then
                detailCode = NO
            End If
        ...
        Function SetExpParameters(company_code As String, company_description As String,
                                 dealerCode As String,
                              beginDate As String,
                              endDate As String,
                              billingStatus As String,
                              detailCode As String,
                              langCultureValue As String) As ReportCeBaseForm.Params
        ...
        Function SetParameters(company_code As String, company_description As String,
                               dealerCode As String,
                               beginDate As String,
                               endDate As String,
                               billingStatus As String,
