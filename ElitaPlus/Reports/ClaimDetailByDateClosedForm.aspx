...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ClaimDetailByDateClosedForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimDetailByDateClosedForm" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title id="rptWindowTitle" runat="server">ClaimDetailByDateClosed</title>
            ...
            <tr>
                <td valign="top">
                    <table width="100%" border="0">
                        <tr>
                            <td height="20">
                                <asp:Label ID="LabelReports"  CssClass="TITLELABEL" runat="server">Reports</asp:Label>:&nbsp;<asp:Label ID="Label7" runat="server"  CssClass="TITLELABELTEXT">Claim Detail By Date Closed</asp:Label></td>
                        </tr>
                    </table>
                </td>
            </tr>
                                            ...
                                            <td align="center" colspan="4">
                                                <table cellspacing="2" cellpadding="0" width="75%" border="0">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>                                                      
                                                           <td nowrap align="right" width="25%" colspan="2">
                                                            <asp:label ID="lblIncColumns"
                                                                TextAlign="left" Text="INCLUDE_ADDITIONAL_COLUMNS" runat="server">
                                                            </asp:label></td>
                                                        <td nowrap align="left" width="25%">
                                                            &nbsp;&nbsp;
                                                            <asp:checkbox ID ="chkIncColumns" runat="server" AutoPostBack="false"></asp:checkbox>&nbsp;&nbsp;</td>
                                                        <td nowrap align="left" width="25%">
                                                        </td>
                                                    </tr>
                                                </table>
