...
Namespace Reports
    Partial Class ClaimsByManufacturerEnglishUSAFreeZoneReportForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "CLAIMS_BY_MANUFACTURER_INCLUDING_FREE_ZONE"
        Private Const RPT_FILENAME As String = "ClaimsByManufacturerFreeZone_EN"
        Private Const RPT_FILENAME_EXPORT As String = "ClaimsByManufacturerFreeZone-Exp_EN"
...
#Region "Properties"
        Private ReadOnly Property TheCeInputControl() As ReportCeInputControl
            Get
...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal userId As String, ByVal manufacturerIdParam As String, ByVal beginDate As String,
                                      ByVal endDate As String, ByVal FreeZoneFlag As String, ByVal selectedManufacturerName As String) As ReportCeBaseForm.Params
        ...
        Private Sub GenerateReport()
            ...
            ReportCeBase.EnableReportCe(Me, TheCeInputControl)
            ...
            Dim params As ReportCeBaseForm.Params = SetParameters(GuidControl.GuidToHexString(userId), manufacturerIdParam, beginDate, endDate, FreeZoneFlag, selectedManufacturerName)
