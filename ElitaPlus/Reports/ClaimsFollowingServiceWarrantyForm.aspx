...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ClaimsFollowingServiceWarrantyForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimsFollowingServiceWarrantyForm" %>
<%@ Register TagPrefix="uc1" TagName="ErrorController" Src="../Common/ErrorController.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Claims Following Service Warranty</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">CLAIMS_FOLLOWING_SERVICE_WARRANTY</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
											...
											<TR>
												<TD align="center" colSpan="3">
													<TABLE cellSpacing="2" cellPadding="0" width="75%" border="0">
														...
														<TR>
															<TD align="center" colSpan="3">
																<asp:Label id="lbMaximumNumberOfDaysGap" runat="server">MAXIMUM NUMBER OF DAYS GAP</asp:Label>
																<asp:TextBox id="tbMaxNumberOfDaysGap" runat="server"></asp:TextBox></TD>
														</TR>
														<TR>
															<TD colSpan="3">&nbsp;</TD>
														</TR>
