...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MonthlyProductionCertificatesReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.MonthlyProductionCertificatesReportForm"%>
<%@ Register TagPrefix="uc1" TagName="MultipleColumnDDLabelControl" Src="../Common/MultipleColumnDDLabelControl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>MonthlyProductionCertificates</title>
		...
		<SCRIPT language="JavaScript">
	     //var arrDealerGroupCtr = [[['cboDealer'],['cboDealerCode']],['rbdealer'],['rDealerGroup'],['moDealerGroupDrop']]
				...
				<TR>
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20"><asp:label id="LabelReports" runat="server" CssClass="TITLELABEL">Reports</asp:label>:<asp:label id="Label7" runat="server"  CssClass="TITLELABELTEXT">MONTHLY PRODUCTION - CERTIFICATES REPORT CRITERIA</asp:label></TD>
								...
								<TR>
									<TD>
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD align="center" colSpan="3">
													<TABLE style="HEIGHT: 240px" cellSpacing="2" cellPadding="0" width="75%" border="0">
														<TR>
														...
														<TR>
															<TD vAlign="top" noWrap align="center" colSpan="3">
																<TABLE id="Table2" style="HEIGHT: 106px" cellSpacing="1" cellPadding="1" width="100%" border="0">
																	<TR>
																		<TD vAlign="bottom" noWrap align="right">*
																			<asp:RadioButton id="rdealer" onclick=" document.all.item('multipleDropControl_lb_DropDown').style.color = ''; ToggleExt(this, arrDealerGroupCtr);"
																				GroupName="Dealer" type="radio" TextAlign="left" Text="SELECT_ALL_DEALERS" Runat="server" Checked="True"
																	...
																	<TR>
																		<TD style="WIDTH: 233px; HEIGHT: 3px"></TD>
																		<TD style="WIDTH: 24px; HEIGHT: 3px"></TD>
																		<TD style="WIDTH: 118px; HEIGHT: 3px"></TD>
																	...
																	<TR>
																		<TD noWrap align="right">
																			<asp:RadioButton id="rGroup" onclick="ToggleExt(this, arrDealerGroupCtr); document.all.item('multipleDropControl_lb_DropDown').style.color = '';"
																				tabIndex="1" type="radio" TextAlign="left" Text="SELECT_ALL_GROUPS" Runat="server" AutoPostBack="false"></asp:RadioButton></TD>
																		<TD style="WIDTH: 24px"></TD>
																		<TD style="WIDTH: 118px">
																			<asp:label id="moDealerGroupLabel" runat="server">OR_A_SINGLE_GROUP</asp:label></TD>
																		<TD align="left">
																			<asp:dropdownlist id="cboDealerGroup" runat="server" type="DropDown" AutoPostBack="false" Width="248px"
														...
														<TR>
															<TD noWrap align="center" width="25%" colSpan="4">
																<asp:RadioButton id="RadiobuttonTotalsOnly" onclick="toggleDetailSelection(false);" TextAlign="left"
																	Text="SHOW TOTALS ONLY" Runat="server" AutoPostBack="false"></asp:RadioButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
