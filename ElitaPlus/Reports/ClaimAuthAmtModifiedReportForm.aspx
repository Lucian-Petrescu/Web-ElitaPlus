<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Reports/content_Report.Master" 
 CodeBehind="ClaimAuthAmtModifiedReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimAuthAmtModifiedReportForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPanelMainContentBody" runat="server" >
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="vertical-align: top;">
        ...
        <TR> 
			...
			<td class="LABELCOLUMN" style="vertical-align: bottom;" height="10px">
			    <asp:radiobutton id="rbAllRisktypes" 
				 AutoPostBack="false" Checked="False" Runat="server" Text="PLEASE SELECT ALL RISK TYPES" TextAlign="left"></asp:radiobutton>
		    </TD>
			<TD>
			    <asp:label id="lblrisktype" runat="server">OR A SINGLE RISK TYPE</asp:label>:
				<asp:dropdownlist id="cborisktype" runat="server" AutoPostBack="false"></asp:dropdownlist>
			</TD>
		</TR>
		 <tr>
            <td class="BLANKROW" colspan="3">
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                             <asp:RadioButtonList ID="rdReportSortOrder" runat="server" RepeatDirection="Vertical">
                                ...
                                <asp:ListItem Value="2">Claim_Updated_By</asp:ListItem>
                                <asp:ListItem Value="3">Claim_Updated_Date</asp:ListItem>
                                <asp:ListItem Value="4">Risk_Type</asp:ListItem>
                                <asp:ListItem Value="5">Service_Center_Name</asp:ListItem>                                
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
