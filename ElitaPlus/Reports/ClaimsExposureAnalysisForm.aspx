...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ClaimsExposureAnalysisForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ClaimsExposureAnalysisForm"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Claims Exposure Analysis</title>
					...
					<TD vAlign="top">
						<TABLE width="100%" border="0">
							<TR>
								...
								<asp:label id="Label7" runat="server" CssClass="TITLELABELTEXT">Claims_Exposure_Analysis</asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
											...
											<TR>
												<TD align="center" colSpan="3">
													<TABLE cellSpacing="2" cellPadding="0" width="75%" border="0">
														<TR>
															<TD style="HEIGHT: 71px" align="center" colSpan="4">
																<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
																	...
																	<TR>
																		<TD align="right" colSpan="2">
																			<asp:label id="BeginMonthYearLabel" runat="server"  Width="206px">SELECT_BEGIN_MONTH_AND_YEAR</asp:label>&nbsp;
																	...
																	<TR>
																		<TD align="right" colSpan="2">
																			<asp:label id="EndMonthYearLabel" runat="server"  Width="206px">SELECT_END_MONTH_AND_YEAR</asp:label>&nbsp;
														...
														<TR>
															<TD style="BORDER-TOP: gray thin solid; HEIGHT: 69px" noWrap align="center" width="25%"
																colSpan="4">
																	...
																	<TR>
																		<TD style="HEIGHT: 13px" noWrap align="left">
																			<asp:RadioButton id="rdealer" onclick="ToggleDualDropDownsSelection('multipleDropControl_moMultipleColumnDrop', 'multipleDropControl_moMultipleColumnDropDesc', 'rdealer', false, ''); document.all.item('multipleDropControl_lb_DropDown').style.color = '';"
																				AutoPostBack="false" Text="SELECT_ALL_DEALERS" TextAlign="left" Runat="server" Checked="False"></asp:RadioButton></TD>
																	</TR>
																	<TR>
														...
														<TR>
															<TD style="BORDER-TOP: gray thin solid" colSpan="4">&nbsp;
																<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
																	<TR>
																		<TD align="right">
																			<asp:Label id="Label4" runat="server" Width="101px" Visible="False"></asp:Label>
																			<asp:label id="Label1" runat="server">Summarize_By</asp:label></TD>
																		<TD>
																			<asp:RadioButton id="RadiobuttonDealer" AutoPostBack="false" Text="Dealer" Runat="server" GroupName="SummarizeBy"></asp:RadioButton></TD>
																	</TR>
																	<TR>
																		<TD></TD>
																		<TD>
																			<asp:RadioButton id="RadiobuttonRiskType" AutoPostBack="false" Text="Risk_Type" Runat="server" GroupName="SummarizeBy"></asp:RadioButton></TD>
																	</TR>
																	<TR>
																		<TD></TD>
																		<TD>
																			<asp:RadioButton id="RadiobuttonRiskTypePerDealer" AutoPostBack="false" Text="Risk_Type_Per_Dealer"
																				Runat="server" GroupName="SummarizeBy"></asp:RadioButton></TD>
																	</TR>
																</TABLE>
															</TD>
														</TR>
