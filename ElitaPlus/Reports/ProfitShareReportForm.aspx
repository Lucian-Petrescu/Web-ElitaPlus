<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProfitShareReportForm.aspx.vb" Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ProfitShareReportForm" %>
						...
						<TABLE width="100%" border="0">
							<TR>
								<TD height="20">
									...
									<asp:label id="Label7" runat="server"  cssclass="TITLELABELTEXT">Profit_Share_Report</asp:label></TD>
																...
																<TABLE style="WIDTH: 484px; HEIGHT: 18px" cellSpacing="0" cellPadding="0" width="484" border="0">
																	<TR>
																		...
																		<TD style="WIDTH: 110px" noWrap>&nbsp;
																			<asp:textbox id="moBeginDateText" tabIndex="1" runat="server" CssClass="FLATTEXTBOX" width="95px"></asp:textbox></TD>
																		...
																		<TD style="WIDTH: 110px" noWrap>&nbsp;
																			<asp:textbox id="moEndDateText" tabIndex="1" runat="server" CssClass="FLATTEXTBOX" width="95px"></asp:textbox></TD>
																		<TD style="WIDTH: 15px" vAlign="middle" align="center">
