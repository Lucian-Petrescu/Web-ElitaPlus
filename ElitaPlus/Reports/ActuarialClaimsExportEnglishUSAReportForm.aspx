...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActuarialClaimsExportEnglishUSAReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ActuarialClaimsExportEnglishUSAReportForm" %>
                    ...
                    <tr>
                        <td height="20">
                            <asp:Label ID="LabelReports" CssClass="TITLELABEL" runat="server">Reports</asp:Label>:&nbsp;<asp:Label
                                ID="Label7" runat="server" CssClass="TITLELABELTEXT">ACTUARIAL_CLAIMS</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                                                    ...
                                                    <td style="height: 35px" align="center" width="50%" colspan="3">
                                                        <table cellspacing="0" cellpadding="0" width="75%" border="0">
                                                            <tr>
                                                                ...
                                                                <td nowrap>
                                                                    &nbsp;
                                                                    <asp:TextBox ID="moBeginDateText" TabIndex="1" runat="server" CssClass="FLATTEXTBOX" onchange="enableReport()"></asp:TextBox>
                                                                ...
                                                                <td nowrap>
                                                                    ...
                                                                    <asp:TextBox ID="moEndDateText" TabIndex="1" runat="server" CssClass="FLATTEXTBOX"
                                                                        Width="125px" onchange="enableReport()"></asp:TextBox>
