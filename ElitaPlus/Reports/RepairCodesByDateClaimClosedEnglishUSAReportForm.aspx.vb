...
#Region "Handlers-Init"
        ...
        Private Sub InitializeForm()
            ...
            Me.RadiobuttonByClaimClosedDate.Checked = True
        End Sub
...
#Region "Crystal Enterprise"
        ...
        Function SetParameters(ByVal userId As String, ByVal orderBy As Integer, ByVal selectionType As Integer, ByVal beginDate As String,
        ...
        Private Sub GenerateReport()
            ...
            Dim orderBy As Integer = CType(Me.rdReportSortOrder.SelectedValue, Integer)
            ...
            If (Me.RadiobuttonByClaimClosedDate.Checked) Then
                selectionType = 1
            Else
                selectionType = 2
            End If
