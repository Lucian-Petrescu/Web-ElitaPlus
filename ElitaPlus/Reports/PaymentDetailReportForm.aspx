<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Reports/ElitaReportExtractBase.Master" CodeBehind="PaymentDetailReportForm.aspx.vb" 
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.PaymentDetailReportForm" Theme="Default"  %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    <div class="dataContainer">
        <table class="formGrid" align="left" border="0" cellspacing="0" cellpadding="0" style="padding-left: 0px;" width="100%">
            <tr>
                <td nowrap align="right" colspan="1" style="width: 1%"></td>
                ...
                <tr>
                    <td class="BLANKROW" colspan="4"><hr /></td>
                </tr>
                <tr>
