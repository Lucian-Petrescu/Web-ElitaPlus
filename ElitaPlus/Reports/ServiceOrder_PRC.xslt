      ...
      <body>
        <table cellpadding="0" cellspacing="0" border="0" style="PADDING-RIGHT:10px;PADDING-LEFT:10px;width:100%">
          ...
          <tr>
            ...
            <td class="esp">(TIPO DE SERVICIO)</td>
          </tr>
          <tr>
            <td>&#160;</td>
            <td></td>
          ...
          <tr>
            <td colspan="2">Remember to contact customer within the next 4 hours to coordinate service. </td>
          </tr>
          <tr>
            <td>&#160;</td>
            <td></td>
          ...
          <tr>
            <td colspan="2">For questions or further authorization contact: authorizations.ESC.PR@assurant.com</td>
          </tr>
        </table>
      </body>
    </html>
