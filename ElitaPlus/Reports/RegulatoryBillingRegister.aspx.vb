...
Namespace Reports
    ...
    Partial Class RegulatoryBillingRegister
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "REGULATORY_BILLING_REGISTER"
        Private Const RPT_FILENAME As String = "RegulatoryBillingRegister"
        ...
        Public Const PAGETITLE As String = "REGULATORY_BILLING_REGISTER"
        Public Const PAGETAB As String = "REPORTS"
        Public Const DOCTITLE As String = "REGULATORY_BILLING_REGISTER"
        ...
        Private Sub GenerateReport(ByVal ResponseVal As String)
            ...
            If TheReportCeInputControl.RadioButtonVIEWControl.Checked = True Then
                ...
                ElseIf New Date(Integer.Parse(selectedYear), Integer.Parse(selectedMonth), 1) <= Date.Today.AddMonths(-6) Then
                    ...
                    Throw New GUIException(Message.MSG_INVALID_YEARMONTH, Assurant.ElitaPlus.Common.ErrorCodes.GUI_REPORT_PERIOD_TOO_OLD_CANNOT_RUN_FORTHAT_DATE)
