<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActiveClaimsEnglishUSAFreeZoneReportForm.aspx.vb"
    Inherits="Assurant.ElitaPlus.ElitaPlusWebApp.Reports.ActiveClaimsEnglishUSAFreeZoneReportForm" %>
...
<html>
<head>
    <title id="rptWindowTitle" runat="server">ACTIVE_CLAIMS_INCLUDING_FREE_ZONE</title>
                    ...
                    <tr>
                        <td height="20">
                            <asp:Label ID="LabelReports" runat="server"  CssClass="TITLELABEL">Reports</asp:Label>:&nbsp;<asp:Label
                                ID="Label7" runat="server" CssClass="TITLELABELTEXT">ACTIVE_CLAIMS_INCLUDING_FREE_ZONE</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
