...
Namespace Reports
    ...
    Partial Class RegulatoryIssuedCancelledRegisterReportForm
...
#Region "Constants"
        ...
        Private Const RPT_FILENAME_WINDOW As String = "REGULATORY_ISSUED_CANCELLED_REGISTER"
        Private Const RPT_FILENAME As String = "RegulatoryIssuedCancelledRegister"
        Private Const RPT_FILENAME_EXPORT As String = "RegulatoryIssuedCancelledRegister-Exp"
        ...
        Public Const PAGETITLE As String = "REGULATORY_ISSUED_CANCELLED_REGISTER"
        Public Const PAGETAB As String = "REPORTS"
        Public Const DOCTITLE As String = "REGULATORY_ISSUED_CANCELLED_REGISTER"
        ...
        Public Const OPTION_BROWSER As String = "WBARH"
#End Region
...
#Region "Enable/Clear Controls"
        ...
        Private Sub EnableDisablePageControls()
            If TheReportCeInputControl.RadioButtonVIEWControl.Checked = True Then
                ControlMgr.SetVisibleControl(Me, divPDF, False)
                ControlMgr.SetVisibleControl(Me, divView, True)
                TheReportCeInputControl.DestinationCodeSelected = OPTION_BROWSER
            ElseIf TheReportCeInputControl.RadioButtonTXTControl.Checked = True Then
                ControlMgr.SetVisibleControl(Me, divPDF, False)
                ControlMgr.SetVisibleControl(Me, divView, True)
                TheReportCeInputControl.DestinationCodeSelected = OPTION_FTP
            Else
                ControlMgr.SetVisibleControl(Me, divView, False)
                ControlMgr.SetVisibleControl(Me, divPDF, True)
                GetReportDatesAndPageNumber(RPT_FILENAME)
                TheReportCeInputControl.DestinationCodeSelected = OPTION_BROWSER
            End If
        End Sub
...
#Region "Web Form Designer Generated Code "
        ...
        Private Sub Page_Init(sender As System.Object, e As System.EventArgs) Handles MyBase.Init
            ...
            AddHandler CType(Page.Master, ElitaReportBase).SelectedViewOption, AddressOf ViewPDFRadioButtonChecked
            InitializeComponent()
        End Sub
...
#Region "Initialize/Populate Controls"
        ...
        Private Sub PopulateCompaniesDropdown()
            ...
            UserCompanyMultipleDrop.SetControl(True, UserCompanyMultipleDrop.MODES.NEW_MODE, True, dv, ALL + " " + TranslationBase.TranslateLabelOrMessage(LABEL_SELECT_COMPANY), True, False)
        ...
        Private Sub PopulateMonthsDropdown()
            ...
            'dv.Sort = "CODE"
            'Me.BindListControlToDataView(Me.moMonthDropDownList, dv, , , True, False)
        End Sub
...
#Region "Report Parameters"
        ...
        Function SetParameters(companyCode As String, companyDesc As String, _
            ...
            If (moReportFormat = ReportCeBase.RptFormat.TEXT_TAB) OrElse (moReportFormat = ReportCeBase.RptFormat.TEXT_CSV) Then
                ...
                viewOption = "Export"
                'If TheReportCeInputControl.DestinationCodeSelected Is Nothing Then
                ' TheReportCeInputControl.DestinationCodeSelected = OPTION_FTP
                'End If
            End If
