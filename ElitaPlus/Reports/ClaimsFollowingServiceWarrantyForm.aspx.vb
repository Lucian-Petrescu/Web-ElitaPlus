...
#End Region
        ...
        Private Sub btnGenRpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenRpt.Click
            Try
                ...
                Dim maxNumberOfDaysGap As String = Me.tbMaxNumberOfDaysGap.Text
        ...
        Function SetParameters(ByVal userId As String, ByVal beginDate As String,
                                  ByVal endDate As String, ByVal maxNumberOfDaysGap As String) As ReportCeBaseForm.Params
        ...
        Private Sub InitializeForm()
            ...
            Me.tbMaxNumberOfDaysGap.Text = "0"
        End Sub
