                ...
                <table width="85%" border="0">
                    <tr>
                        ...
                        <td style="width: 80%;text-align:right;">
                            ...
                            <asp:Button ID="btnExisting" runat="server" SkinID="SearchButton" Text="SEARCH">
                            </asp:Button>
                        </td>
                    </tr>
                </table>
        ...
        <div style="width: 100%">
            <asp:GridView ID="GridInvoices" runat="server" Width="100%" AllowPaging="True" CellPadding="1"
                ...
                <Columns>
                    ...
                    <asp:BoundField SortExpression="svc_control_number" HeaderText="Invoice_Number">
                    </asp:BoundField>
        ...
        <%--<div class="Pages">--%>
            ...
            <table width="100%" class="dataGrid">
                ...
                <Columns>
                    ...
                    <asp:BoundField SortExpression="claim_extended_status" HeaderText="claim_extended_status">
                    </asp:BoundField>
                </Columns>
                <PagerSettings PageButtonCount="30" Mode="Numeric" Position="TopAndBottom" />
                <PagerStyle />
