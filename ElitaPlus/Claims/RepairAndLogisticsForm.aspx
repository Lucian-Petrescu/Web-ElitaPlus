        ...
        <tbody>
            ...
            <tr>
                ...
                <td valign="middle" align="left" width="50%">
                    <asp:TextBox ID="TextboxVerificationNumber" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX"></asp:TextBox>
                </td>
                <td style="width: 1%" valign="middle" nowrap="" align="right">
                    <asp:Label ID="LabelMaxAuthorizedAmount" runat="server">Max_Authorized_Amount:</asp:Label>
                </td>
                <td valign="middle" align="left" width="50%">
                    <asp:TextBox ID="TextboxMaxAuthorizedAmount" TabIndex="-1" runat="server" Width="50%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
        </tbody>
    </table>
                                ...
                                <div class="Page" runat="server" id="ViewPanel_READ" style="display: block; height: 470px; overflow: auto">
                                    <table id="Table1" class="formGrid" border="0" width="95%">
                                        <tr>
                                            ...
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextboxCustomerName" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                                <asp:Label ID="LabelPOS" runat="server">POS:</asp:Label>
                                            </td>
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextboxPOS" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                            ...
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextboxCoverageType" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextboxDateOfClaim" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">&nbsp;
                                            </td>
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                        ...
                                        <asp:Panel runat="server" ID="pnlNoUseClaimAuthorization">
                                            <tr>
                                                ...
                                                <td valign="middle" align="left" width="50%">&nbsp;
                                                    <asp:TextBox ID="TextboxServiceCenter" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                                </td>
                                                <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                                <td valign="middle" align="left" width="50%">&nbsp;
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 17px" valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextCurrentProductCode" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxManufacturer" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                                <asp:Label ID="LabelModel" runat="server">Model:</asp:Label>
                                            </td>
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextboxModel" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxSKU" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxSerialNumber" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX_CURRENCY" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxIMEINumber" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX_CURRENCY" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td valign="middle" align="left" colspan="3">&nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="TextboxProblemDescription" Style="border-right: #999999 1px solid; border-top: #999999 1px solid; border-left: #999999 1px solid; border-bottom: #999999 1px solid" TabIndex="4" runat="server" Width="95%" CssClass="FLATTEXTBOX" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">&nbsp;
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div>
                                                    <ajaxToolkit:ModalPopupExtender runat="server" ID="mdlPopup" TargetControlID="lnkAuthDetails" PopupControlID="pnlUseClaimAuthorization" DropShadow="True" BackgroundCssClass="ModalBackground" CancelControlID="btnCancel" BehaviorID="addNewModal" PopupDragHandleControlID="pnlUseClaimAuthorization" Y="50" RepositionMode="RepositionOnWindowScroll">
                                                    </ajaxToolkit:ModalPopupExtender>
                                                    <asp:Panel runat="server" ID="pnlUseClaimAuthorization" Style="display: none;">
                                                        <div id="lightRedirect" class="overlay_message_content">
                                                            ...
                                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td align="left" width="25%" style="font-weight: bold" runat="server" id="AuthorizationNumberTD">
                                                                            <strong></strong>
                                                                        </td>
                                                                        <td align="right" width="25%">
                                                                            <asp:Label runat="server" ID="StatusLabel" SkinID="SummaryLabel">AUTHORIZATION_STATUS</asp:Label>:
                                                                        </td>
                                                                        <td align="left" width="25%" style="font-weight: bold" runat="server" id="AUTHORIZATIONStatusTD">
                                                                            <strong></strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <Elita:UserControlAuthorizationInfo ID="moClaimAuthorizationInfoController" runat="server" align="center"></Elita:UserControlAuthorizationInfo>
                                                            <div class="btnZone">
                                                                <div class="">
                                                                    <asp:LinkButton ID="btnCancel" runat="server" SkinID="AlternateRightButton" Text="Close"></asp:LinkButton>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </asp:Panel>
                                ...
                                <div class="Page" runat="server" id="moReplacedDevicePanel" style="display: block; height: 470px; overflow: auto">
                                    <table id="Table3" class="formGrid" border="0">
                                        <tr>
                                            ...
                                            <td valign="middle" align="left" width="50%">&nbsp;
                                                <asp:TextBox ID="TextboxDeviceReceptionDate" TabIndex="-1" runat="server" Width="50%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                            <td valign="middle" align="left">&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxReplacementType" TabIndex="-1" runat="server" Width="50%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                            <td valign="middle" align="left">&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxManufacturerOfReplacedDevice" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                                <asp:Label ID="LabelTotalLaborAmount" runat="server">Total_Labor_Amount:</asp:Label>
                                            </td>
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxTotalLaborAmount" TabIndex="-1" runat="server" Width="125" CssClass="FLATTEXTBOX_CURRENCY" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxModelOfReplacedDevice" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                                <asp:Label ID="LabelTotalPartsAmount" runat="server">Total_Parts_Amount:</asp:Label>
                                            </td>
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxTotalPartsAmount" TabIndex="-1" runat="server" Width="125" CssClass="FLATTEXTBOX_CURRENCY" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxSerialNrOfReplacedDevice" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                                <asp:Label ID="LabelServiceCharge" runat="server">Service_Charge:</asp:Label>
                                            </td>
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxServiceCharge" TabIndex="-1" runat="server" Width="125" CssClass="FLATTEXTBOX_CURRENCY" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxIMEIOfReplacedDevice" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                            <td valign="middle" align="left">&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxSKUOfReplacedDevice" TabIndex="-1" runat="server" Width="93%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right">
                                                <asp:Label ID="LabelShippingAmount" runat="server">Shipping_Amount:</asp:Label>
                                            </td>
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxShippingAmount" TabIndex="-1" runat="server" Width="125" CssClass="FLATTEXTBOX_CURRENCY" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left">&nbsp;
                                                <asp:TextBox ID="TextboxServiceLevel" TabIndex="-1" runat="server" Width="50%" CssClass="FLATTEXTBOX" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 1%" valign="middle" nowrap="" align="right"></td>
                                            <td valign="middle" align="left">&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 83%" valign="middle" align="left" colspan="3">&nbsp;
                                                <asp:TextBox ID="TextboxProblemFound" Style="border-right: #999999 1px solid; border-top: #999999 1px solid; border-left: #999999 1px solid; border-bottom: #999999 1px solid" TabIndex="4" runat="server" Width="93%" CssClass="FLATTEXTBOX" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
