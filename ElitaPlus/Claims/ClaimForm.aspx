...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td id="tdBtnArea" nowrap="nowrap" runat="server" colspan="2">
                            <asp:Button ID="btnModalSelectServiceCenterYes" runat="server" Text="YES" SkinID="PrimaryRightButton"></asp:Button>
                            <asp:Button ID="btnModalSelectServiceCenterNo" runat="server" Text="NO" SkinID="AlternateRightButton"></asp:Button>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div id="ModalServiceCenter" class="overlay">
        <div id="light" class="overlay_message_content" style="left: 5%; right: 5%; top: 5%; max-height: 80%">
            ...
            <Elita:UserControlSelectServiceCenter ID="ucSelectServiceCenter" runat="server"></Elita:UserControlSelectServiceCenter>
        </div>
        <div id="fade" class="black_overlay">
        </div>
    </div>
        ...
        <div id="Div1" class="overlay_message_content">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <a href="javascript:void(0)" onclick="hideModal('ModalReopenClaim');" rel="noopener noreferrer">
                                <img id="Img3" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="absmiddle"></a>
            ...
            <table class="formGrid" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        <td align="right">
                            <img id="img4" name="imgMsgIcon" width="28" runat="server" src="~/App_Themes/Default/Images/dialogue_confirm.png" height="28">
                        </td>
                    ...
                    <tr>
                        ...
                        <td id="td2" nowrap="nowrap" runat="server" colspan="2">
                            <input id="btnModalReopenClaimYes" class="primaryBtn floatR" runat="server" type="button" value="Yes">
                            <input id="btnModalReopenClaimNo" class="popWindowAltbtn floatR" runat="server" type="button" value="No" onclick="hideModal('ModalReopenClaim');">
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <asp:Panel ID="Panel2" runat="server" Height="98%" Width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td nowrap="nowrap" width="30%">
                                    <asp:TextBox ID="TextboxMasterClaimNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                ...
                                <td nowrap="nowrap" width="37%">
                                    <asp:TextBox ID="TextboxLoanerCenter" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxClaimNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelRiskType" runat="server">Risk_Type</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxRiskType" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxCallerName" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelServiceCenter" runat="server">Service_Center</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxServiceCenter" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxMethodOfRepair" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelCaller_Tax_Number" runat="server">CALLER_TAX_NUMBER</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxCaller_Tax_Number" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxLossDate" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelContactName" runat="server">Contact_Name</asp:Label>:
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxContactName" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:DropDownList ID="cboCauseOfLossId" TabIndex="1" runat="server" SkinID="MediumDropDown" Enabled="false" AutoPostBack="true">
                                    </asp:DropDownList>
                                </td>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxCertificateNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxReportedDate" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelDealerName" runat="server">Dealer</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxDealerName" TabIndex="-1" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxCoverageType" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="Lbluseshipaddress" runat="server" Visible="false">Use_Ship_Address:</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:DropDownList ID="cbousershipaddress" TabIndex="1" runat="server" SkinID="SmallDropDown" AutoPostBack="true" Visible="false">
                                    </asp:DropDownList>
                                    <asp:Label ID="LabelNotificationType" runat="server">Notification_Type</asp:Label>
                                    <asp:TextBox ID="TextboxNotificationType" runat="server" SkinID="SmallTextBox" ReadOnly="True" TabIndex="-1"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="txtCurrentRetailPrice" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="lblPaymentPassedDue" runat="server">Payment_Passed_Due</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="txtPaymentPassedDue" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxAuthorizationNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelSource" runat="server">Source</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxSource" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxStoreNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            ...
                            <tr runat="server" id="trUseEquipment1">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxCurrentDeviceSKU" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelPrice" runat="server">Price:</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxPrice" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" id="trUseEquipment2">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxMobileNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelSerialNumber" runat="server">Serial_Number:</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxSerialNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" id="trUseEquipment3">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxManufacturer" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelModel" runat="server">Model:</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxModel" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right" width="18%">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxLastModifiedBy" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelDeductible" runat="server">Deductible</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxDeductible" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxClaimsAdjuster" TabIndex="-1" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelDiscount" runat="server">DISCOUNT</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxDiscount" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxUserName" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelAboveLiability" runat="server">Above_Liability</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxAboveLiability" runat="server" SkinID="MediumTextBox" ReadOnly="True" TabIndex="-1"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxSlavageAmount" runat="server" SkinID="MediumTextBox" ReadOnly="True" TabIndex="-1"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxLastModifiedDate" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <asp:TextBox ID="TextboxClaimStatus" runat="server" Width="263px" ReadOnly="True" TabIndex="-1" Visible="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelAssurantPays" runat="server">Assurant_Pay</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxAssurantPays" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" id="trDueToSCFromAssurant">
                                ...
                                <td style="height: 18px">
                                    <asp:TextBox ID="TextboxDueToSCFromAssurant" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">&nbsp;
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxSpecialService" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True">
                                    </asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxConsumerPays" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">&nbsp;
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxTotalPaid" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr runat="server" id="trDedCollection">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxDedCollMethod" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">&nbsp;
                                    <asp:Label ID="LabelCCAuthCode" runat="server">CC_AUTH_CODE</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxCCAuthCode" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">&nbsp;
                                ...
                                <td nowrap="nowrap">
                                    <asp:DropDownList ID="cboWhoPays" TabIndex="1" runat="server" SkinID="MediumDropDown" Enabled="false">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <asp:ImageButton ID="ImageButtonDeviceActivationDate" TabIndex="2" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                                <td align="right" nowrap="nowrap">
                    ...
                    <div id="tabs" class="style-tabs">
                                            ...
                                            <div id="dvClaimEquipment" runat="server">
                                                <table class="formGrid" width="66%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtEnrolledMake" runat="server" CssClass="FLATTEXTBOX" Enabled="false" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <asp:Label ID="lblClaimedMake" runat="server" Text="MAKE"> </asp:Label>
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtClaimedMake" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtEnrolledModel" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtEnrolledSku" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <asp:Label ID="lblClaimedSKu" runat="server" Text="SKU_NUMBER"> </asp:Label>
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtClaimedSku" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtEnrolledIMEI" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                            <asp:Label ID="lblClaimedIMEI" runat="server" Text="IMEI_NUMBER"> </asp:Label>
                                                        </td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtClaimedIMEI" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtEnrolledComments" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="false" Rows="5"></asp:TextBox>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtClaimedComments" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="false" Rows="5"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div id="dvRefurbReplaceEquipment" runat="server">
                                                <table class="formGrid" width="64%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtRefurbReplaceMake" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtRefurbReplaceSku" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtRefurbReplaceIMEI" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtRefurbReplaceComments" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="false" Rows="5"></asp:TextBox>
                        ...
                        <div id="tbClaimAuthorization">
                            ...
                            <div class="Page dataContainer" id="dvClaimAuthorizationDetails" runat="server">
                                ...
                                <%--<div style="width: 100%">--%>
                                <asp:GridView ID="GridClaimAuthorization" runat="server" Width="100%" AutoGenerateColumns="False" SkinID="DetailPageGridView" AllowSorting="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ServiceCenterName" SortExpression="ServiceCenterName" ReadOnly="true" HtmlEncode="false" HeaderText="SERVICE_CENTER_NAME" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="AuthorizedAmount" SortExpression="AuthorizedAmount" ReadOnly="true" HtmlEncode="false" HeaderText="AUTHORIZED_AMOUNT" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="CreatedDate" SortExpression="CreatedDate" ReadOnly="true" HtmlEncode="false" HeaderText="CREATED_DATE" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="ClaimAuthStatus" ReadOnly="true" HeaderText="Status" SortExpression="ClaimAuthStatus" HtmlEncode="false"></asp:BoundField>
                                    </Columns>
                                </asp:GridView>
                                <%--</div>--%>
                            </div>
                                ...
                                <div id="dvClaimShipping" runat="server">
                                    <table class="formGrid" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtShipperToSC" runat="server" CssClass="FLATTEXTBOX" Enabled="false" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblShipperToCust" runat="server" Text="SHIPPER_NAME"> </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtShipperToCust" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtShipToSC" runat="server" CssClass="FLATTEXTBOX" ReadOnly="false" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblShipToCust" runat="server" Text="TRACKING_NUMBER"> </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtShipToCust" runat="server" ReadOnly="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="Page">
                                <div id="dvClaimFulfillmentDetails" runat="server">
                                    <table class="formGrid" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtOptionDescription" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblTrackingNumber" runat="server" Text="TRACKING_NUMBER"> </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtTrackingNumber" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtShippingDate" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblActualDeliveryDate" runat="server" Text="ACTUAL_DELIVERY_DATE"> </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtActualDeliveryDate" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtExpectedShippingDate" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblExpectedDeliveryDate" runat="server" Text="EXPECTED_DELIVERY_DATE"> </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtExpectedDeliveryDate" runat="server" Enabled="false" CssClass="FLATTEXTBOX" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtAddress1" runat="server" ReadOnly="true" SkinID="LargeTextBox" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblCity" runat="server" Text="CITY"> </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtCity" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtAddress2" runat="server" ReadOnly="true" SkinID="LargeTextBox" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtAddress3" runat="server" ReadOnly="true" SkinID="LargeTextBox" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" nowrap="nowrap">
                                                <asp:TextBox ID="txtPostalCode" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtStoreCode" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="lblStoreType" runat="server" Text="STORE_TYPE"> </asp:Label>
                                            </td>
                                            <td align="left" nowrap="nowrap">
                                                <asp:TextBox ID="txtStoreType" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtStoreName" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                            <td align="right">
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtPasscode" runat="server" ClientIDMode="Static" ReadOnly="true" hidden="true" SkinID="MediumTextBox"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="btnZone">
                                    <div style="visibility:hidden">
                                        <asp:Button runat="server" ID="btnContinue" SkinID="PrimaryRightButton" Text="Continue"></asp:Button>
                                        <asp:Button runat="server" ID="btnLegacyContinue" SkinID="PrimaryRightButton" Text="Continue"></asp:Button>
                    ...
                    <table class="formGrid" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td nowrap="nowrap" width="30%">
                                    <asp:TextBox ID="TextboxDeniedReasons" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="true" Rows="5"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td nowrap="nowrap" class="style1">
                                    <asp:TextBox ID="TextboxFraudulent" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True">
                                    </asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">&nbsp;</td>
                                <td nowrap="nowrap"></td>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxComplaint" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True">
                                    </asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">&nbsp;</td>
                                <td nowrap="nowrap"></td>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:DropDownList ID="cboReasonClosed" TabIndex="2" runat="server" SkinID="MediumDropDown" Enabled="false" AutoPostBack="True">
                                    </asp:DropDownList>
                                </td>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxFollowupDate" TabIndex="2" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                    <asp:ImageButton ID="ImageButtonFollowupDate" TabIndex="2" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">&nbsp;
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxClaimActivity" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <asp:ImageButton ID="ImageButtonVisitDate" TabIndex="2" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxInvoiceProcessDate" TabIndex="2" runat="server" ReadOnly="true" SkinID="MediumTextBox"></asp:TextBox>
                                    <asp:ImageButton ID="ImageButtonInvoiceProcessDate" TabIndex="2" runat="server" Visible="False" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelRepairDate" runat="server">Repair_Date</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxRepairDate" TabIndex="2" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                    <asp:ImageButton ID="ImageButtonRepairDate" TabIndex="2" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxInvoiceDate" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelBatchNumber" runat="server">BATCH_NUMBER</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxBatchNumber" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxClaimClosedDate" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelPickUpDate" runat="server">PickUp_Date</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxPickupDate" TabIndex="2" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                    <asp:ImageButton ID="ImageButtonPickupDate" TabIndex="2" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxRepairCode" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelLoanerReturnedDate" runat="server">Loaner_Returned</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxLoanerReturnedDate" TabIndex="2" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                    <asp:ImageButton ID="ImageButtonLoanerReturnedDate" TabIndex="2" runat="server" Visible="True" ImageUrl="~/App_Themes/Default/Images/calendar.png" ImageAlign="AbsMiddle"></asp:ImageButton>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right" width="18%">
                                ...
                                <td nowrap="nowrap" width="30%">
                                    <asp:TextBox ID="TextboxAuthorizedAmount" TabIndex="2" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right" width="15%">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxDefectReason" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                                    <asp:Label ID="LabelExpectedRepairDate" runat="server">EXPECTED_REPAIR_DATE</asp:Label>
                                </td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxExpectedRepairDate" TabIndex="-1" runat="server" SkinID="MediumTextBox" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right" width="18%">
                                ...
                                <td nowrap="nowrap" width="30%">
                                    <asp:TextBox ID="TextboxProblemDescription" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="true" Rows="5"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxSpecialInstruction" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="true" Rows="5"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right" width="15%">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="TextboxTechnicalReport" TabIndex="4" runat="server" SkinID="LargeTextBox" TextMode="MultiLine" ReadOnly="true" Rows="5"></asp:TextBox>
                                </td>
                                <td nowrap="nowrap" align="right">
        ...
        <div class="btnZone">
            <div>
                <asp:Button ID="btnSave_WRITE" TabIndex="5" runat="server" SkinID="PrimaryRightButton" Text="Save"></asp:Button>
                <asp:Button ID="btnEdit_WRITE" TabIndex="5" runat="server" SkinID="PrimaryRightButton" Text="Edit"></asp:Button>
                <asp:LinkButton ID="btnUndo_WRITE" TabIndex="5" runat="server" SkinID="AlternateRightButton" Text="Undo"></asp:LinkButton>
                <asp:Button ID="btnBack" SkinID="AlternateLeftButton" TabIndex="5" runat="server" Text="Back"></asp:Button>
                <asp:Button ID="ActionButton" runat="server" TabIndex="5" SkinID="ActionButton" Text="LabelActionButtonMenu"></asp:Button>
                <ajaxToolkit:HoverMenuExtender ID="HoverMenuExtender1" runat="server" TargetControlID="ActionButton" PopupControlID="PanButtonsHidden" PopupPosition="top" PopDelay="25" HoverCssClass="popupBtnHover">
                </ajaxToolkit:HoverMenuExtender>
                <asp:Panel ID="PanButtonsHidden" runat="server" SkinID="PopUpMenuPanel">
                    <asp:Button ID="btnDenyClaim" Visible="false" runat="server" SkinID="PopMenuButton" Text="DENY_CLM"></asp:Button>
                    <asp:Button ID="btnAuthDetail" runat="server" Text="AUTH_DETAIL" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnChangeCoverage" runat="server" Text="CHANGE_COVERAGE" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnClaimHistoryDetails" runat="server" Text="Claim_History_Details" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnOutboundCommHistory" runat="server" Text="Outbound_Comm_History" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnCertificate" runat="server" Text="Certificate" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnComment" runat="server" Text="Comments" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnServiceCenterInfo" runat="server" Text="Center_Info" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnClaimDeniedInformation" runat="server" SkinID="PopMenuButton" Text="Claim_Denied_Letter"></asp:Button>
                    <asp:Button ID="btnStatusDetail" runat="server" Text="EXTENDED_STATUS" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnItem" runat="server" Text="Item" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnMasterClaim" runat="server" Text="MASTERCLAIM" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnNewServiceCenter" runat="server" Text="New_Center" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnNewItemInfo" runat="server" Text="New Item Info" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnPoliceReport" runat="server" Text="Police_Report" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnPartsInfo" runat="server" Text="Parts   Info" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnPrint" runat="server" Text="RePrint" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnUseRecoveries" runat="server" Text="RECOVERY" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnRedo" runat="server" Text="Redo" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnReplaceItem" runat="server" Text="Replace_Item" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnReopen_WRITE" runat="server" Text="Re_Open_Claim" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnShipping" runat="server" Text="SHIPPING" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnServiceWarranty" runat="server" Text="Service_Warranty" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnRepairLogistics" runat="server" Text="Repair_And_Logistics" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnClaimIssues" runat="server" Text="CLAIM_ISSUES" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnClaimImages" runat="server" Text="CLAIM_IMAGES" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnClaimCaseList" runat="server" Text="CLAIM_CASE_DETAILS" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnAddConseqDamage" Visible="false" runat="server" Text="CONSEQ_DAMAGE" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnPriceRetailSearch" Visible="false" runat="server" Text="RETAIL_PRICE_SEARCH" SkinID="PopMenuButton"></asp:Button>
                    <asp:Button ID="btnChangeFulfillment" runat="server" Text="CHANGE_FULFILLMENT" SkinID="PopMenuButton" Enabled="false" Visible="false"></asp:Button>
                    <asp:Button ID="btnReplacementQuote" runat="server" Text="REPLACEMENT_QUOTE" SkinID="PopMenuButton" Enabled="True" Visible="True"></asp:Button>
                </asp:Panel>
            </div>
        </div>
        <input id="HiddenSaveChangesPromptResponse" type="hidden" name="HiddenSaveChangesPromptResponse" runat="server"><input id="HiddenLimitExceeded" type="hidden" name="HiddenLimitExceeded" runat="server">
    </asp:Panel>
