...
<div>
    <table class="summaryGrid" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                <td align="right">
                    <asp:Label ID="CertificateNumberLabel" runat="server" >CERTIFICATE NUMBER</asp:Label>:
                </td>
                ...
                <td class="padLeft" align="right" runat="server" id="ServiceCenterLabelTD">
                    <asp:Label ID="ServiceCenterNameLabel" runat="server" >SERVICE CENTER NAME</asp:Label>:
                </td>
                <td class="bor padRight" align="left" runat="server" id="ServiceCenterTD"></td>

                <td class="padLeft" align="left">
                    <asp:Label ID="StatusLabel" runat="server" >CLAIM STATUS</asp:Label>:
                </td>
