...
<asp:Content ID="Content3" ContentPlaceHolderID="SummaryPlaceHolder" runat="server">
    <Elita:ProtectionAndEventDetails ID="moProtectionAndEventDetails" runat="server" align="center"></Elita:ProtectionAndEventDetails>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
        ...
        <div id="light" class="overlay_message_content">
            <p class="modalTitle">
                ...
                <a href="javascript:void(0)" onclick="hideModal('ModalServiceWarranty');" rel="noopener noreferrer">
                    <img id="Img11" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="absmiddle" class="floatR"></a>
            </p>
            <table class="formGrid" width="98%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        <td align="right">
                            <img id="img12" name="imgMsgIcon" width="28" runat="server" src="~/App_Themes/Default/Images/dialogue_confirm.png" height="28">
                        </td>
                    ...
                    <tr>
                        ...
                        <td id="td4" nowrap="nowrap" runat="server" colspan="2">
                            <asp:Button ID="btnModalServiceWarrantyYes" runat="server" SkinID="PrimaryRightButton" Text="Yes"></asp:Button>
                            <input id="btnModalServiceWarrantyNo" class="popWindowAltbtn floatR" runat="server" type="button" value="No" onclick="hideModal('ModalServiceWarranty');">
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div id="light" class="overlay_message_content">
            <p class="modalTitle">
                ...
                <a href="javascript:void(0)" onclick="hideModal('ModalClaimCancel');" rel="noopener noreferrer">
                    <img id="Img7" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="absmiddle" class="floatR"></a>
            </p>
            <table class="formGrid" width="98%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        <td align="right">
                            <img id="img8" name="imgMsgIcon" width="28" runat="server" src="~/App_Themes/Default/Images/dialogue_confirm.png" height="28">
                        </td>
                    ...
                    <tr>
                        ...
                        <td id="td2" nowrap="nowrap" runat="server" colspan="2">
                            <input id="btnModalCancelClaimYes" class="primaryBtn floatR" runat="server" type="button" value="Yes">
                            <input id="btnModalClaimCancelNo" class="popWindowAltbtn floatR" runat="server" type="button" value="No" onclick="hideModal('ModalClaimCancel');">
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <a href="javascript:void(0)" onclick="hideModal('ModalMasterClaim');" rel="noopener noreferrer">
                                <img id="Img6" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="top"></a>
            
            </td></tr></table>
            <div class="Page">
                <asp:GridView ID="grdMasterClaim" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True" SkinID="DetailPageGridView" AllowSorting="true">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="MASTER_CLAIM_#" SortExpression="MASTER_CLAIM_NUMBER">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="btnSelectClaim" CommandName="SelectAction" CausesValidation="False"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="CLAIM_#" DataField="CLAIM_NUMBER" SortExpression="CLAIM_NUMBER" ReadOnly="true" HtmlEncode="false" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                        <asp:BoundField HeaderText="DATE_OF_LOSS" DataField="LOSS_DATE" SortExpression="LOSS_DATE" ReadOnly="true" HtmlEncode="false" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                    </Columns>
        ...
        <div id="light" class="overlay_message_content" style="width: 470px">
            <p class="modalTitle">
                ...
                <a href="javascript:void(0)" onclick="hideModal('ModalDenyClaim');" rel="noopener noreferrer">
                    <img id="Img9" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="absmiddle" class="floatR"></a>
            </p>
            <table width="100%" border="0" class="formGrid" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="step3_cboDeniedReason" runat="server" SkinID="MediumDropDown" AutoPostBack="false">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="step3_cboFraudulent" runat="server" SkinID="MediumDropDown" AutoPostBack="false">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="step3_cboComplaint" runat="server" SkinID="MediumDropDown" AutoPostBack="false">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td id="td5" runat="server" colspan="2">
                            ...
                            <input id="btnModalBbDolNo" class="popWindowAltbtn floatR" runat="server" type="button" value="No" onclick="hideModal('ModalBypassDoL');">
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div id="light" class="overlay_message_content" style="left: 10%; right: 5%; top: 5%; max-height: 80%">
            <p class="modalTitle">
                ...
                <a href="javascript:void(0)" onclick="hideModal('ModalSoftQuestions');" rel="noopener noreferrer">
                    <img id="Img10" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="absmiddle" class="floatR"></a>
            </p>
            ...
            <div class="dataContainer">
                <asp:TreeView ID="tvQuestion" runat="server" Target="_self" ShowExpandCollapse="true" ShowLines="true" NodeStyle-HorizontalPadding="5" NodeStyle-VerticalPadding="0">
                    <SelectedNodeStyle BackColor="LightGray"></SelectedNodeStyle>
                ...
                <div class="stepWizBox">
                    <Elita:UserControlWizard runat="server" ID="WizardControl">
                        <Steps>
                            ...
                            <Elita:StepDefinition StepNumber="3" StepName="CLAIM_DETAILS"></Elita:StepDefinition>
                            <Elita:StepDefinition StepNumber="4" StepName="LOCATE_SERVICE_CENTER"></Elita:StepDefinition>
                        ...
                        <table class="formGrid" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="step1_btnDateOfLoss" runat="server" ImageUrl="~/App_Themes/Default/Images/calendar.png" valign="bottom"></asp:ImageButton>
                                    </td>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td>
                                        <asp:ImageButton ID="step1_btnDateReported" runat="server" ImageUrl="~/App_Themes/Default/Images/calendar.png" valign="bottom"></asp:ImageButton>
                                    </td>
                                    <td>
                            ...
                            <table class="formGrid" cellspacing="0" cellpadding="0" border="0">
                                <tbody>
                                    <tr id="step1_riskTypeTR" runat="server">
                                        <td nowrap="nowrap" align="right">
                                            <span class="mandate">*</span><asp:Label ID="step1_riskTypeLabel" runat="server" Text="RISK_TYPE"></asp:Label>:
                                        </td>
                                        <td nowrap="nowrap">
                                    ...
                                    <tr>
                                        <td nowrap="nowrap" align="right">
                                            <span class="mandate">*</span><asp:Label ID="step1_coverageTypeLabel" runat="server" Text="COVERAGE_TYPE"></asp:Label>:
                                        </td>
                                        <td nowrap="nowrap">
                                    ...
                                    <tr>
                                        <td nowrap="nowrap" align="right">
                                            <span class="mandate">*</span><asp:Label ID="step1_callerNameLabel" runat="server" Text="NAME_OF_CALLER"></asp:Label>:
                                        </td>
                                        <td nowrap="nowrap">
                                    ...
                                    <tr>
                                        <td nowrap="nowrap" align="right">
                                            <span class="mandate">*</span><asp:Label ID="step1_problemDescriptionLabel" runat="server" Text="PROBLEM_DESCRIPTION"></asp:Label>:
                                        </td>
                                        <td nowrap="nowrap">
                        ...
                        <div class="stepformZone">
                            <table border="0" class="formGrid" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="step2_TextboxInvNum" runat="server" MaxLength="30" SkinID="MediumTextBox" TabIndex="15"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:DropDownList ID="step2_cboRiskTypeId" runat="server" SkinID="MediumDropDown" TabIndex="9">
                                        </asp:DropDownList>
                                    ...
                                    <td>
                                        <asp:TextBox ID="step2_TextboxDeductiblePercent" runat="server" SkinID="MediumTextBox" TabIndex="20"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step2_TextboxCoverageType" runat="server" SkinID="MediumTextBox" TabIndex="11"></asp:TextBox>
                                    </td>
                                    <td nowrap="nowrap" align="right">
                                        <asp:Label ID="step2_labelSKU" runat="server" Font-Bold="False">SKU_NUMBER</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="step2_TextboxSKU" runat="server" SkinID="MediumTextBox" TabIndex="20" Width="75%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:DropDownList ID="step2_cboMethodOfRepair" runat="server" AutoPostBack="true" TabIndex="13" SkinID="MediumDropDown">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step2_TextboxProductCode" runat="server" SkinID="MediumTextBox" TabIndex="16"></asp:TextBox>
                                    </td>
                                    <td nowrap="nowrap" align="right">&nbsp;
                                    </td>
                                    <td>&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step2_TextboxLiabilityLimit" runat="server" SkinID="MediumTextBox" TabIndex="19"></asp:TextBox>
                                    </td>
                                    <td nowrap="nowrap" align="right">&nbsp;
                                    </td>
                                    <td>&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step2_TextboxRepairDiscountPct" runat="server" SkinID="SmallTextBox" TabIndex="19"></asp:TextBox>
                                    </td>
                                    <td nowrap="nowrap" align="right">&nbsp;
                                    </td>
                                    <td>&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step2_TextboxReplacementDiscountPct" runat="server" SkinID="SmallTextBox" TabIndex="19"></asp:TextBox>
                                    </td>
                                    <td nowrap="nowrap" align="right">&nbsp;
                                    </td>
                                    <td>&nbsp;
                        ...
                        <div class="stepformZone">
                            <table border="0" class="formGrid" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:Label ID="step2_lblEnrolledDeviceInfo" runat="server" Text="ENROLLED_DEVICE_INFO" Visible="false" Font-Bold="true"></asp:Label>
                                    </td>
                                    <td align="right" nowrap="nowrap">&nbsp;
                                    </td>
                                    <td nowrap="nowrap">
                                        <asp:Label ID="step2_lblClaimedEquipment" runat="server" Text="CLAIMED_DEVICE_INFO" Visible="false" Font-Bold="true"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="step2_ddlClaimedManuf" Visible="false" TabIndex="3" runat="server" SkinID="MediumDropDown">
                                        </asp:DropDownList>
                                        <asp:TextBox ID="step2_txtClaimedmake" runat="server" SkinID="SmallTextBox" TabIndex="17" Visible="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td>
                                        <asp:TextBox ID="step2_txtClaimedModel" runat="server" SkinID="SmallTextBox" TabIndex="20" Visible="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td>
                                        <asp:TextBox ID="step2_txtClaimedDescription" TabIndex="8" runat="server" SkinID="MediumTextBox" Visible="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" nowrap="nowrap">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="step2_ddlClaimedSku" Visible="false" TabIndex="3" runat="server" SkinID="MediumDropDown">
                                        </asp:DropDownList>
                                        <asp:TextBox ID="step2_txtClaimedSKu" TabIndex="8" runat="server" SkinID="MediumTextBox" Visible="False"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td align="right" nowrap="nowrap">
                                        <asp:Label ID="step2_LabelClaimSerialNumber" runat="server" Text="SERIAL_NUMBER" Visible="False"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="step2_txtClaimedSerialNumber" TabIndex="12" runat="server" SkinID="MediumTextBox" Visible="False"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="stepformZone">
                            <table border="0" class="formGrid" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="step2_cboApplyDiscount" runat="server" SkinID="MediumDropDown" TabIndex="24">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="step2_TextboxDiscountAmt" runat="server" SkinID="MediumTextBox" TabIndex="21"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:DropDownList ID="step2_cboCalimAllowed" runat="server" SkinID="MediumDropDown" TabIndex="24">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" nowrap="nowrap">
                                    ...
                                    <td>
                                        <asp:TextBox ID="step2_TextboxDiscountPercent" runat="server" SkinID="MediumTextBox" TabIndex="23"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">&nbsp;
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        ...
                                        <asp:ImageButton ID="step3_ImageButtonLossDate" TabIndex="75" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg" ImageAlign="AbsMiddle"></asp:ImageButton>
                                    </td>
                                    <td nowrap="nowrap" align="right">
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        ...
                                        <asp:ImageButton ID="step3_ImageButtonReportDate" TabIndex="75" runat="server" ImageUrl="../Common/Images/calendarIcon2.jpg" ImageAlign="AbsMiddle"></asp:ImageButton>
                                    </td>
                                    <td nowrap="nowrap" align="right">
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step3_TextboxOutstandingPremAmt" TabIndex="75" runat="server" ReadOnly="true" SkinID="MediumTextBox" ForeColor="Red" Font-Bold="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:DropDownList ID="step3_cboCauseOfLossId" TabIndex="77" runat="server" SkinID="MediumDropDown" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td nowrap="nowrap" align="right">
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:DropDownList ID="step3_cboUseShipAddress" TabIndex="77" runat="server" SkinID="MediumDropDown" AutoPostBack="True" Visible="false">
                                        </asp:DropDownList>
                                    </td>
                                    <td nowrap="nowrap" align="right">
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="step3_txtNewDeviceSKU" TabIndex="86" runat="server" AutoPostBack="true" SkinID="MediumTextBox"></asp:TextBox>
                                    </td>
                                </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="step3_txtPickupDate" TabIndex="76" runat="server" AutoPostBack="true" SkinID="MediumTextBox"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap" align="right">
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="step3_txtVisitDate" TabIndex="88" runat="server" AutoPostBack="true" SkinID="MediumTextBox"></asp:TextBox>   
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    -->
                                    ...
                                    <div class="dataContainer" id="dvClaimAuthorizationDetails" runat="server">
                                        <div style="width: 100%">
                                            <asp:GridView ID="GridClaimAuthorization" runat="server" Width="100%" AutoGenerateColumns="False" SkinID="DetailPageGridView" AllowSorting="true">
                                                ...
                                                <HeaderStyle></HeaderStyle>
                                                <Columns>
                                                    <asp:BoundField DataField="AuthorizationNumber" SortExpression="AuthorizationNumber" ReadOnly="true" HtmlEncode="false" HeaderText="CLAIM_AUTHORIZATION_NUMBER" HeaderStyle-HorizontalAlign="Center"></asp:BoundField>
                ...
                <asp:Panel ID="PanelPoliceReport" Width="100%" runat="server">
                    <div class="dataContainer">
                        ...
                        <Elita:UserControlPoliceReport_New ID="mcUserControlPoliceReport" runat="server"></Elita:UserControlPoliceReport_New>
                    </div>
                </asp:Panel>
                <div class="dataContainer">
                    ...
                    <div id="light" class="overlay_message_content" style="width: 1100px; left: 8%">
                        <p class="modalTitle">
                            ...
                            <a href="javascript:void(0)" onclick="hideModal('modalClaimImages');" rel="noopener noreferrer">
                                <img id="img3" src="~/App_Themes/Default/Images/icon_modalClose.png" runat="server" width="16" height="18" align="absmiddle" class="floatR"></a>
                        </p>
                    ...
                    <div id="light" class="overlay_message_content" style="width: 500px">
                        ...
                        <table width="100%" border="0" class="formGrid" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="step3_modalClaimIssue_btnSave" runat="server" SkinID="PrimaryRightButton" Text="SAVE" OnClientClick="return validate();"></asp:Button>
                                    <input id='step3_modalClaimIssue_btnCancel' runat="server" type="button" name="Cancel" value="Cancel" onclick="HideErrorAndModal('ModalIssue');" class='popWindowCancelbtn
                                        floatR'>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div id="light" class="overlay_message_content" style="width: 45%; top: 50px; overflow: hidden;">
                        ...
                        <table width="100%" border="0" class="formGrid" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="step3_cboDedCollMethod" runat="server" SkinID="MediumDropDown" AutoPostBack="True">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="step3_txtDedCollAuthCode" runat="server" SkinID="MediumTextBox" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;
                                ...
                                <td>
                                    <asp:Button ID="btnDedCollContinue" runat="server" CssClass="primaryBtn
                                            floatR" Text="CONTINUE" CausesValidation="false"></asp:Button>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="stepformZone">
                        <table class="formGrid" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="right" nowrap="nowrap">
                                        <asp:Label runat="server" ID="step4_moSearchByLabel" Text="SEARCH_BY"></asp:Label>
                                        :
                                    </td>
                                    <td align="left" nowrap="nowrap">
                                        <asp:RadioButton ID="step4_RadioButtonByZip" runat="server" AutoPostBack="True" Text="BY_ZIP" GroupName="SEARCH_TYPE"></asp:RadioButton>
                                    </td>
                                    <td align="left" nowrap="nowrap">
                                        <asp:RadioButton ID="step4_RadioButtonByCity" runat="server" AutoPostBack="True" Text="BY_CITY" GroupName="SEARCH_TYPE"></asp:RadioButton>
                                    </td>
                                    <td align="left" nowrap="nowrap">
                                        <asp:RadioButton ID="step4_RadioButtonAll" runat="server" AutoPostBack="True" Text="ALL" GroupName="SEARCH_TYPE"></asp:RadioButton>
                                    </td>
                                    <td align="left" nowrap="nowrap">
                                    ...
                                    <td nowrap="nowrap">
                                        <asp:DropDownList ID="step4_moCountryDrop" runat="server" SkinID="SmallDropDown" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td nowrap="nowrap" runat="server" id="step4_tdCityLabel">
                                        <asp:Label runat="server" ID="step4_moCityLabel" Text="CITY"></asp:Label>
                                        :
                                    </td>
                                    ...
                                    <td runat="server" id="step4_tdClearButton">
                                        <asp:Button ID="step4_btnClearSearch" runat="server" SkinID="AlternateLeftButton" Text="Clear"></asp:Button>
                                    </td>
                                ...
                                <tr>
                                    <td align="left" runat="server" id="step4_tdServiceCenterLabel" colspan="11">
                                        <table>
                                            <tbody>
                                                <Elita:MultipleColumnDDLabelControl runat="server" ID="step4_moMultipleColumnDrop"></Elita:MultipleColumnDDLabelControl>
                                            </tbody>
                                        </table>
                                    </td>
                                </tr>
                        ...
                        <table class="formGrid" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td nowrap="nowrap" colspan="2">
                                    <asp:TextBox ID="step5_TextboxCertificate" runat="server" SkinID="MediumTextBox" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" nowrap="nowrap">
                            ...
                            <tr>
                                <td align="right" nowrap="nowrap" colspan="3"></td>
                            </tr>
                            <tr>
                                <td align="right" nowrap="nowrap">
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap" colspan="2">
                                    <asp:TextBox ID="step5_TextboxCommentText" runat="server" TextMode="MultiLine" Rows="5" Columns="45" SkinID="MediumTextBox"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="btnZone">
                ...
                <asp:LinkButton ID="btnCancel" runat="server" SkinID="AlternateRightButton" Text="Cancel" OnClientClick="return revealModal('ModalCancel');"></asp:LinkButton>
                <asp:Button ID="btnBack" runat="server" SkinID="AlternateLeftButton" Text="Back"></asp:Button>
                <asp:Button ID="btnUndo_Write" TabIndex="195" runat="server" Font-Bold="false" Text="Undo" SkinID="AlternateLeftButton"></asp:Button>
                <asp:Button ID="btnEdit_WRITE" TabIndex="200" runat="server" Text="Edit" CausesValidation="False" SkinID="AlternateLeftButton"></asp:Button>
                <asp:Button ID="btnSoftQuestions" TabIndex="190" runat="server" Font-Bold="false" Text="Soft Questions" SkinID="AlternateLeftButton"></asp:Button>
                <asp:Button ID="btnClaimOverride_Write" TabIndex="190" runat="server" Text="Override" SkinID="AlternateLeftButton"></asp:Button>
                <asp:Button ID="btnComment" TabIndex="190" runat="server" Text="Comments" SkinID="AlternateLeftButton"></asp:Button>
                <asp:Button ID="btnDenyClaim" runat="server" Font-Bold="false" TabIndex="195" Text="Deny_Claim" SkinID="AlternateLeftButton"></asp:Button>
                <asp:LinkButton ID="btnCancel_Write" TabIndex="190" runat="server" Text="Cancel" OnClientClick="return revealModal('ModalCancel');" SkinID="AlternateRightButton" Visible="false"></asp:LinkButton>
                <asp:LinkButton ID="btnCancelClaim" TabIndex="190" runat="server" Text="Cancel" OnClientClick="return revealModal('ModalClaimCancel');" SkinID="AlternateRightButton" Visible="false"></asp:LinkButton>
    ...
    <asp:HiddenField ID="HiddenSaveChangesPromptResponse" runat="server"></asp:HiddenField>
    <asp:HiddenField ID="hdnSelectedServiceCenterId" runat="server" Value="XXXX"></asp:HiddenField>
