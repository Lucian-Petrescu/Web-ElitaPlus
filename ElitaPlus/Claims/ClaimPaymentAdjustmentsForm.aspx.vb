...
#Region "Controlling Logic"
    Public Sub GetClaimStatusCode()
        Try
            ...
            If Me.State.ClaimStatusCode = Me.CLAIM_CLOSED_STATUS Then
    ...
    Private Sub ToggleButtons(ByVal blnNewPaymentEnabled As Boolean, ByVal blnReversePaymentEnabled As Boolean, ByVal blnAdjustPaymentEnabled As Boolean)
        ...
        If Not Me.State.selectedClaimID.Equals(Guid.Empty) Then
            ...
            If Not ClaimBO.CertificateId.Equals(Guid.Empty) Then
                ...
                If oClmSystem.PayClaimId.Equals(noId) Then
                    If Me.btnNEW_PAYMENT.Visible And Me.btnNEW_PAYMENT.Enabled Then
                        ControlMgr.SetEnableControl(Me, Me.btnNEW_PAYMENT, False)
                    End If
                    If Me.btnREVERSE_PAYMENT.Visible And Me.btnREVERSE_PAYMENT.Enabled Then
                        ControlMgr.SetEnableControl(Me, Me.btnREVERSE_PAYMENT, False)
                    End If
                    If Me.btnADJUST_PAYMENT.Visible And Me.btnADJUST_PAYMENT.Enabled Then
    ...
    Private Sub LoadClaimPayments()
        Try
            ...
            If (Not State.ClaimInvoiceDV Is Nothing) AndAlso State.ClaimInvoiceDV.Count > 0 Then
    ...
    Private Sub ReversePayment(ByVal blnReversal As Boolean)
...
#Region " Datagrid Related "
    ...
    Private Sub Grid_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles Grid.ItemDataBound
        ...
        If itemType = ListItemType.Item Or itemType = ListItemType.AlternatingItem Or itemType = ListItemType.SelectedItem Then
            Me.PopulateControlFromBOProperty(e.Item.Cells(Me.GRID_COL_CLAIM_INVOICE_ID_IDX), dvRow(ClaimInvoice.ClaimInvoicesDV.COL_CLAIM_INVOICE_ID))
            Me.PopulateControlFromBOProperty(e.Item.Cells(Me.GRID_COL_INVOICE_NUMBER_IDX), dvRow(ClaimInvoice.ClaimInvoicesDV.COL_INVOICE_NUMBER))
            Me.PopulateControlFromBOProperty(e.Item.Cells(Me.GRID_COL_PAYEE_IDX), dvRow(ClaimInvoice.ClaimInvoicesDV.COL_PAYEE))
            Me.PopulateControlFromBOProperty(e.Item.Cells(Me.GRID_COL_CREATED_DATE_IDX), dvRow(ClaimInvoice.ClaimInvoicesDV.COL_CREATED_DATE))
            Me.PopulateControlFromBOProperty(e.Item.Cells(Me.GRID_COL_INVOICE_AMOUNT_IDX), dvRow(ClaimInvoice.ClaimInvoicesDV.COL_INVOICE_AMOUNT))
            Me.PopulateControlFromBOProperty(e.Item.Cells(Me.GRID_COL_PAID_BY_IDX), dvRow(ClaimInvoice.ClaimInvoicesDV.COL_PAID_BY))
    ...
    Public Sub ItemCommand(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Try
            If e.CommandName = "SelectAction" AndAlso Grid.Enabled Then
                ...
                Dim decPaymentAmount As Decimal = CType(e.Item.Cells(Me.GRID_COL_INVOICE_AMOUNT_IDX).Text, Decimal)
                ...
                If Me.State.ClaimStatusCode = Me.CLAIM_CLOSED_STATUS AndAlso decPaymentAmount > 0 Then
...
#Region " Buttons Clicks "
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            If Me.ButtonClicked = Me.REVERSE_PAYMENT Then
                '**************************************REVERSE PAYMENT********************************
            ...
            ElseIf Me.ButtonClicked = Me.ADJUST_PAYMENT Then
                '*************************************ADJUST PAYMENT***********************************
    ...
    Private Sub btnNEW_PAYMENT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNEW_PAYMENT.Click
        Me.ToggleButtons(False, False, False)
        Me.ButtonClicked = Me.NEW_PAYMENT
    ...
    Private Sub btnADJUST_PAYMENT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnADJUST_PAYMENT.Click
        ...
        Me.ToggleButtons(False, False, False)
        Me.ButtonClicked = Me.ADJUST_PAYMENT
        Session("ButtonClicked") = Me.ButtonClicked
        Me.SetGridControls(Grid, False)
    ...
    Private Sub btnREVERSE_PAYMENT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnREVERSE_PAYMENT.Click
        ControlMgr.SetVisibleControl(Me, tblPaymentDetails, True)
        ControlMgr.SetVisibleControl(Me, tblHR, True)
        ...
        Me.ToggleButtons(False, False, False)
        Me.ButtonClicked = Me.REVERSE_PAYMENT
        Session("ButtonClicked") = Me.ButtonClicked
        Me.SetGridControls(Grid, False)
        SetFocus(Me.txtInvoiceNumber)
        Me.MenuEnabled = False
