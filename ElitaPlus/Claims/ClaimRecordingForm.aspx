                                ...
                                <table style="width: 100%; height: 100%">
                                    <tbody>
                                        <tr>
                                            <td width="20%"></td>
                                            <td align="left">
                                                <asp:Label ID="lblDvcSelected" Font-Bold="true"  runat="server"> Selected </asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="lblDvcCorrected" Font-Bold="true" runat="server"> Corrected </asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
