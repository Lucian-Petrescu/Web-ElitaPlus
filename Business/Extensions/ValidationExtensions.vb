...
Public Module ValidationExtensions
    ...
    <Extension()>
    Public Function Validate(ByVal pValue As Object) As IEnumerable(Of ValidationResult)
        Return Validate(pValue, "Instance")
    End Function

    <Extension()>
    Public Function Validate(ByVal pValue As Object, ByVal parameterName As String) As IEnumerable(Of ValidationResult)
