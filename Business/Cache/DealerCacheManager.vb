...
Public Class DealerCacheManager
    ...
    Friend Sub New(dealerRepository As IDealerRepository(Of Dealer),
    ...
    Friend Function CacheKey(dealerCode As String) As String
        Return String.Format("{0}#{1}", CacheKeyValue, dealerCode.ToUpperInvariant())
    End Function

    Friend Function BuildCache(dealerCode As String) As Dealer
    ...
    Friend Function CacheKey(dealerId As Guid) As String
        Return String.Format("{0}#{1}", CacheKeyValue, dealerId)
    End Function

    Friend Function BuildCache(dealerId As Guid) As Dealer
    ...
    ''' <returns></returns>
    Friend Function CacheKey(dealerCode As String, productCode As String) As String
        Return String.Format("{0}#{1}#{2}", CacheKeyValue, dealerCode.ToUpperInvariant(), productCode.ToUpperInvariant())
    End Function

    Friend Function BuildCache(dealerCode As String, productCode As String) As Product
        Return ProductRepository.Get(Function(p) p.ProductCode = productCode AndAlso p.Dealer.DealerCode = dealerCode, Nothing, "Items,Items.Coverages").FirstOrDefault
    End Function
    ''' <summary>
    ...
    ''' <returns></returns>
    Friend Function CacheKey(dealerCode As String, warrantySalesDate As Date) As String
        Return String.Format("{0}#{1}#{2}", CacheKeyValue, dealerCode.ToUpperInvariant(), warrantySalesDate)
    End Function

    Friend Function BuildCache(dealerCode As String, warrantySalesDate As Date) As Contract
    ...
    Friend Function CacheKey(dealerId As Guid, Code As String, cacheType As String) As String
        Return String.Format("{0}#{1}#{2}", cacheType, dealerId.ToString(), Code.ToUpperInvariant())
    End Function

    Friend Function BuildBranchCache(dealerId As Guid, BranchCode As String) As Branch
