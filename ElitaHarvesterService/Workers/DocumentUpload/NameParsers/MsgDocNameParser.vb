...
Namespace Workers.DocumentUpload.NameParsers
    ...
    Public Class MsgDocNameParser
        Inherits DocumentNameParser

        Private Shared ReadOnly DocTypeMapping As IReadOnlyDictionary(Of String, String) = New Dictionary(Of String, String) From {{"CHEQUE", "CHECK"}}
