...
Public Class ReSendEnrollRewardTask
    Inherits TaskBase
...
#End Region
    ...
    Protected Friend Overrides Sub Execute()
        ...
        Try
            If (Not String.IsNullOrEmpty(MyBase.PublishedTask(PublishedTask.SEND_ENR_REWARD_EMAIL_RESP_ID))) Then
                ExactTargetId = GuidControl.ByteArrayToGuid(GuidControl.HexToByteArray(MyBase.PublishedTask(PublishedTask.SEND_ENR_REWARD_EMAIL_RESP_ID)))
                    ...
                    If response.Id <> Guid.Empty Then
                        ...
                        Try
                            ...
                            With objTrans
                                ...
                                .CommunicationFormat = Codes.TASK_RESEND_ENR_REWARD_EMAIL
