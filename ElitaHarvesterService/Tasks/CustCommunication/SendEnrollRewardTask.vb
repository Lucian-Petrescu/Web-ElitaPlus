...
Public Class SendEnrollRewardTask
    Inherits TaskBase
...
#Region "Properties"
    ...
    Private Const TriggerKey = "OUTBOUND_COMM_REWARD_TRIGGER_KEY"
        ...
        Try
            If (Not String.IsNullOrEmpty(MyBase.PublishedTask(PublishedTask.CERTIFICATE_ID))) Then
                ...
                If (Not CertificateId.Equals(Guid.Empty)) Then
                    ...
                    request.Attributes = New NameValue(7) {}
                    ...
                    request.Attributes.SetValue(New NameValue() With {.Name = "VoucherLink", .Value = ""}, 3)
                    ...
                    If response.Id <> Guid.Empty Then
                        ...
                        Try
                            ...
                            With objTrans
                                ...
                                .CommunicationFormat = Codes.TASK_SEND_ENR_REWARD_EMAIL
                                ...
                                .RetryCompoReference = Codes.EVNT_TYP_CRT_RESEND_REWARDS_INFO
                                .Save()
                            End With
