...
Public Class VendorAuthorizationFileLoadTask
    Inherits FileLoadTaskBase
#Region "Fields"
    Private _claimLoadFileProcessedId As Guid
    Private _claimAuthorizationFileLoad As VendorAuthorizationFileLoad
#End Region
...
#Region "Properties"
    ...
    Private Property ClaimAuthorizationFileLoad As VendorAuthorizationFileLoad
        Get
