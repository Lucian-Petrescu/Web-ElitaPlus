...
#Region "Protected Methods"
    ...
    Protected Friend Overrides Sub Execute()
        ...
        cancelProductTask = DirectCast(TaskFactory.CreateTask(Codes.TASK__AV_CANCEL_PRODUCT, PublishedTask, MyBase.MachineName, MyBase.ProcessThreadName), CancelProductTask)
        cancelProductTask.Execute()

        Dim activateProductTask As ActivateProductTask
        activateProductTask = DirectCast(TaskFactory.CreateTask(Codes.TASK__AV_ACTIVATE_PRODUCT, PublishedTask, MyBase.MachineName, MyBase.ProcessThreadName), ActivateProductTask)
