...
#if DataEntities
Partial Public Class DictionaryItem
         Inherits BaseEntity
    ...
    Public Overridable Property Translations As ICollection(Of DictionaryItemTranslation) = New HashSet(Of DictionaryItemTranslation)
