...
#Region "Load Methods"
    ...
    Public Function LoadCaseActionList(CaseId As Guid, LanguageId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_CASE_ACTION_LIST")
        ...
        outputParameter(PO_CURSOR_CASE) = New DBHelper.DBHelperParameter(SP_PARAM_NAME_CASE_ACTION_LIST, GetType(DataSet))
        ...
        End Try
    End Function
    Public Function LoadClaimActionList(ClaimId As Guid, LanguageId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_CLAIM_ACTION_LIST")
        Dim ds As DataSet = New DataSet
        Dim outputParameter(PO_CURSOR_CASE) As DBHelper.DBHelperParameter
        Dim inParameters As New Generic.List(Of DBHelper.DBHelperParameter)
        Dim param As DBHelper.DBHelperParameter
        ...
        outputParameter(PO_CURSOR_CASE) = New DBHelper.DBHelperParameter(SP_PARAM_NAME_CLAIM_ACTION_LIST, GetType(DataSet))
