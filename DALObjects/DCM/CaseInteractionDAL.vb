...
#Region "Load Methods"
    ...
    Public Function LoadCaseInteractionList(ByVal CaseId As Guid, ByVal LanguageId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_CASE_INTERACTION_LIST")
