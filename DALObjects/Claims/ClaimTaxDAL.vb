...
#Region "Load Methods"
    ...
    Public Sub Load(ByVal familyDS As DataSet, ByVal id As Guid)
        Dim selectStmt As String = Me.Config("/SQL/LOAD_BY_CLAIM_INVOICE_ID")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter(Me.COL_NAME_CLAIM_INVOICE_ID, id.ToByteArray)}
        Try
    ...
    Public Function LoadListByClaimInvoice(ByVal claimInvoiceId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST_BY_CLAIM_INVOICE_ID")
    ...
    Public Function LoadClaimTaxCountry(ByVal claimId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_CLAIM_TAX_COUNTRY")
