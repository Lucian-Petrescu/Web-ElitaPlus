...
#Region "Load Methods"
    ...
    Public Function LoadClaimIssuesByIssueType(ByVal issueTypeId As Guid, userId As Guid) As DataSet
        Dim ds as New DataSet
        Dim selectStmt As String = Me.Config("/SQL/GetClaimIssueListByIssueType")
