...
#Region "Load Methods"
    ...
    Public Sub Load(ByVal familyDS As DataSet, ByVal id As Guid)
        ...
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter(Me.COL_NAME_SERVICE_CENTER_ID, id.ToByteArray)}
        Try
    ...
    Public Function GetContactInfoView(ByVal ContactInfoId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_CONTACT_INFO_LIST")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter(Me.COL_NAME_CONTACT_INFO_ID, ContactInfoId.ToByteArray)}
        Try
