...
#Region "Load Methods"
    ...
    Public Function LoadList(familyDS As DataSet, RuleId As Guid, CurrentDate As DateTime) As DataSet
    ...
    Public Function IsChild(RuleProcessId As Guid, ProcessId As Guid, companyIds As ArrayList, languageId As Guid) As DataSet
        ...
        Try
            Dim params() As DBHelper.DBHelperParameter = {New DBHelper.DBHelperParameter(COL_NAME_PROCESS_ID, ProcessId.ToByteArray), _
                                                          New DBHelper.DBHelperParameter(COL_NAME_RULE_PROCESS_ID, RuleProcessId.ToByteArray)}
