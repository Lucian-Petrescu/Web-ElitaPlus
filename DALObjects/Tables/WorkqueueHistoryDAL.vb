...
#Region "Load Methods"
    ...
    Public Function LoadWorkQueueItemHistory(ByVal WorkQueueId As Guid, ByVal languageId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_WORKQUEUE_HISTORY")
    ...
    Public Function LoadWorkQueueUsersActions(ByVal WorkQueueId As Guid, ByVal languageId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_WORKQUEUE_USERS_ACTIONS")
        Dim parameters() As OracleParameter
