...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal EarningCodeId As Guid, ByVal EarningPatternId As Guid) As DataSet
        ...
        parameters = New DBHelper.DBHelperParameter() _
                    {New DBHelper.DBHelperParameter(Me.COL_NAME_EARNING_CODE_ID, EarningCodeId.ToByteArray), _
                     New DBHelper.DBHelperParameter(Me.COL_NAME_EARNING_PATTERN_ID, EarningPatternId.ToByteArray)}
