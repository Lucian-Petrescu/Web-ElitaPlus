...
#Region "Load Methods"
    ...
    Public Sub LoadList(ByVal ds As DataSet, ByVal ProductSpecialServiceId As Guid)
    ...
    Public Function LoadProdSplSvcList(ByVal SpecialServiceId As Guid, ByVal ProductCodeId As Guid) As DataSet
        Dim ds As New DataSet
        Dim parameters() As OracleParameter
        Dim selectStmt As String = Me.Config("/SQL/LOAD_BY_PROD_CODE_SPL_SVC")
        Try
