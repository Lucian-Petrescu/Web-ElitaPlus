...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal familyDS As DataSet, ByVal company_group_id As Guid, ByVal language_id As Guid) As DataSet
    ...
    Public Function LoadListForQouteEngine(ByVal familyDS As DataSet, ByVal company_group_id As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST")
    ...
    Public Function LoadCollectionMethodsList(ByVal familyDS As DataSet, ByVal company_group_id As Guid, ByVal language_id As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_COLLECTION_METHODS_LIST_FOR_VSC_QOUTE")
        ...
        Try
            DBHelper.Fetch(familyDS, selectStmt, Me.TABLE_NAME_COLLECTIONS, parameters)
        Catch ex As Exception
            Throw New DataBaseAccessException(DataBaseAccessException.DatabaseAccessErrorType.ReadErr, ex)
        End Try
    End Function

    Public Function LoadPaymentInstrumentsList(ByVal familyDS As DataSet, ByVal company_group_id As Guid, ByVal language_id As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_PAYMENT_INSTRUMENTS_LIST_FOR_VSC_QOUTE")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter("language_id", language_id.ToByteArray), _
                            New DBHelper.DBHelperParameter("Company_Group_ID", company_group_id.ToByteArray)}


        Try
            DBHelper.Fetch(familyDS, selectStmt, Me.TABLE_NAME_PAYMENT_INSTRUMENTS, parameters)
        Catch ex As Exception
            Throw New DataBaseAccessException(DataBaseAccessException.DatabaseAccessErrorType.ReadErr, ex)
        End Try
    End Function
    Public Function LoadPaymentTypesList(ByVal familyDS As DataSet, ByVal company_group_id As Guid, ByVal language_id As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_PAYMENT_TYPES_LIST_FOR_VSC_QOUTE")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter("language_id1", language_id.ToByteArray), _
                            New DBHelper.DBHelperParameter("language_id2", language_id.ToByteArray), _
                            New DBHelper.DBHelperParameter("Company_Group_ID", company_group_id.ToByteArray)}
        ...
        Try
            DBHelper.Fetch(familyDS, selectStmt, Me.TABLE_NAME_PAYMENT_TYPES, parameters)
        Catch ex As Exception
            Throw New DataBaseAccessException(DataBaseAccessException.DatabaseAccessErrorType.ReadErr, ex)
        End Try
    End Function
