...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal familyDs As DataSet, ByVal migrationPathId As Guid) As DataSet
    ...
    Public Function GetReplacementEquipments(ByVal migrationPathId As Guid, ByVal equipmentId As Guid, ByVal numberOfreplacements As Integer) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_BEST_REPLACEMENT")
