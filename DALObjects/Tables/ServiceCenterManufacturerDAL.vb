...
#Region "Load Methods"
    ...
    Public Sub LoadList(ByVal ds As DataSet, ByVal serviceCenterManufacturerId As Guid)
        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST")
        ...
        DBHelper.Fetch(ds, selectStmt, Me.TABLE_NAME, New DBHelper.DBHelperParameter() {serviceCenterManufacturerParam})
    End Sub
