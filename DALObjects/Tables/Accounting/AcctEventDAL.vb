...
#Region "Load Methods"
    ...
    Public Function LoadList(EventTypeMask As Guid, AcctcompanyMask As Guid, LanguageId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_LIST")
        Dim whereClauseConditions As String = ""
        Dim inCausecondition As String = ""
        Dim bIsLikeClause As Boolean = False

        whereClauseConditions &= " AND UPPER(" & TABLE_NAME & "." & COL_NAME_ACCT_COMPANY_ID & ") =HEXTORAW('" & GuidToSQLString(AcctcompanyMask) & "')"
        ...
        If (Not EventTypeMask = Guid.Empty) Then
            whereClauseConditions &= " AND UPPER(" & COL_NAME_ACCT_EVENT_TYPE_ID & ") =HEXTORAW('" & GuidToSQLString(EventTypeMask) & "')"
        End If
