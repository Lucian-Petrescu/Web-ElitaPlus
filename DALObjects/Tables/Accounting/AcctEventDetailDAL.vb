...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal AcctEventMask As Guid, ByVal LanguageId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST")
        Dim whereClauseConditions As String = ""
        Dim inCausecondition As String = ""
        Dim bIsLikeClause As Boolean = False

        whereClauseConditions &= " AND " & Me.COL_NAME_ACCT_EVENT_ID & " =HEXTORAW('" & Me.GuidToSQLString(AcctEventMask) & "')"
