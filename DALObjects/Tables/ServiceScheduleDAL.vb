...
#Region "Load Methods"
    ...
    Public Sub LoadList(ByVal familyDS As DataSet, ByVal id As Guid)
        Dim selectStmt As String = Me.Config("/SQL/LOAD_SERVICE_CENTER_SCHEDULE_LIST")
    ...
    Public Function GetScheduleTableView(ByVal ScheduleId As Guid) As DataSet
        Dim selectStmt As String = Me.Config("/SQL/GET_SERVICE_CENTER_SCHEDULE_TABLE")
