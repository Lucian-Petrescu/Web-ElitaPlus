...
#Region "Load Methods"
    ...
    Public Sub LoadByDealerIdClaimTypeId(ByVal familyDS As DataSet, ByVal DealerId As Guid, ByVal ClaimTypeId As Guid)
        Dim selectStmt As String = Me.Config("/SQL/LOAD_BY_DEALERID_CLAIMTYPEID")
