...
#Region "Load Methods"
    ...
    Public Sub Load(ByVal familyDS As DataSet, ByVal sDesc As String, ByVal CompanyGroupID As Guid)
        Dim selectStmt As String = Me.Config("/SQL/LOADFROMDESCANDCOMPGROUP")
    ...
    End Function
    Public Function LoadVSCMakes(ByVal companyGroupId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/LOAD_VSC_MAKES")
        Dim parameters() As OracleParameter
    ...
    Public Function LoadMakesForWS(ByVal companyGroupId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/LOAD_MAKES_FOR_WS")
        Dim parameters() As OracleParameter
    ...
    Public Function GetMakesForWSByWarrantyMaster(ByVal dealerId As Guid, ByVal companyGroupId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/LOAD_MAKES_FOR_WS_BY_WARRANTY_MASTER")
        Dim parameters() As OracleParameter
    ...
    Public Overloads Function ResolveManufacturer(ByVal manufacturerName As String, ByVal companyGroupId As Guid) As Guid
        Try
            Dim selectStmt As String = Me.Config("/SQL/RESOLVE_MANUFACTURER")
