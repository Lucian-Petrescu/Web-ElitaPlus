...
#Region "Load Methods"
    ...
    Public Sub Load(familyDS As DataSet, id As Guid)
        ...
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter(COL_NAME_SERVICE_ORDERS_ADDRESS_ID, id.ToByteArray)}
        Try
    ...
    Public Sub Load(id As Guid, familyDS As DataSet)
        Dim selectStmt As String = Config("/SQL/LOAD_USING_PARENT_ID")
