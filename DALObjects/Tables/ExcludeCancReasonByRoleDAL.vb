...
#Region "Load Methods"
    ...
    End Function
    Public Function LoadList(ByVal familyDs As DataSet, ByVal CancellationReasonId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST_FOR_CANC_REASON")
