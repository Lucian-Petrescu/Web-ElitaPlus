...
#Region "Load Methods"
    ...
    Public Sub LoadList(ByVal ds As DataSet, ByVal ProductCodeId As Guid)
        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST")
        Dim ProductCodeIdParam As New DBHelper.DBHelperParameter("product_code_id", ProductCodeId.ToByteArray)
        DBHelper.Fetch(ds, selectStmt, Me.TABLE_NAME, New DBHelper.DBHelperParameter() {ProductCodeIdParam})
        'Return DBHelper.Fetch(selectStmt, Me.TABLE_NAME)
    End Sub
