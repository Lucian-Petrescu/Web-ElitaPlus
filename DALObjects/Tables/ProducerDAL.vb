...
#Region "Load Methods"
    ...
    Public Function LoadList(descriptionMask As String, codeMask As String, compIds As ArrayList) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_LIST")
        ...
        If bIsLikeClause = True Then
            ' hextoraw
            inCausecondition &= MiscUtil.BuildListForSql(COL_NAME_COMPANY_ID, compIds, True)
        Else
            ' not HextoRaw
            inCausecondition &= MiscUtil.BuildListForSql(COL_NAME_COMPANY_ID, compIds, False)
        End If
