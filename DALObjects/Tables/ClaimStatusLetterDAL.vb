...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal compIds As ArrayList, ByVal dealerId As Guid, ByVal claimStatusByGroupId As Guid, ByVal companyGroupId As Guid, ByVal languageId As Guid) As DataSet
