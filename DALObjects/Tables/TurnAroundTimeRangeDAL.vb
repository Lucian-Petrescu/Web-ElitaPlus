...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal companyGroupId As Guid, ByVal languageId As Guid) As DataSet
    ...
    Public Function LoadListWithColor(ByVal companyGroupId As Guid, ByVal languageId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/LOAD_LIST_WITH_COLOR")
        Dim parameters() As OracleParameter
        parameters = New OracleParameter() _
                                    {New OracleParameter(COL_NAME_LANGUAGE_ID, languageId.ToByteArray), _
                                     New OracleParameter(COL_NAME_COMPANY_GROUP_ID, companyGroupId.ToByteArray)}
    ...
    Public Function GetMinMaxValFromTAT(ByVal companyGroupId As Guid, ByVal rangeCode As String) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/GET_MIN_MAX_VAL_FROM_TAT")
        Dim parameters() As OracleParameter
        parameters = New OracleParameter() _
    ...
    End Function
    Public Function GetMinMaxValFromTAT(ByVal turnAroundTimeRangeId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/GET_MIN_MAX_VAL_FROM_ID")
        Dim parameters() As OracleParameter
        parameters = New OracleParameter() _
