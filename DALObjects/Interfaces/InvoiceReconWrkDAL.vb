...
#Region "Load Methods"
    ...
    Public Function LoadList(familyDS As DataSet, claimloadFileProcessedId As Guid, languageID As Guid) As DataSet
        ...
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() {New DBHelper.DBHelperParameter("language_id", languageID.ToByteArray), _
                                                                                           New DBHelper.DBHelperParameter(COL_NAME_CLAIMLOAD_FILE_PROCESSED_ID, claimloadFileProcessedId.ToByteArray)}
        Try
            DBHelper.Fetch(familyDS, selectStmt, TABLE_NAME, parameters)
        Catch ex As Exception
            Throw New DataBaseAccessException(DataBaseAccessException.DatabaseAccessErrorType.ReadErr, ex)
