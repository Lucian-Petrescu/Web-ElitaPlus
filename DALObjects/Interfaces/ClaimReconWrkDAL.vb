...
#Region "Load Methods"
    ...
    Public Function LoadList(ByVal claimfileProcessedID As Guid) As DataSet
    ...
    Public Function GetDealerCode(ByVal claimfileProcessedId As Guid) As DataSet

        Dim selectStmt As String = Me.Config("/SQL/GET_DEALER_CODE")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() { _
                         New DBHelper.DBHelperParameter(Me.TABLE_KEY_NAME, claimfileProcessedId.ToByteArray)}
