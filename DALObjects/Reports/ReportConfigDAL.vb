...
#Region "Load Methods"
    ...
    Public Function LoadList(compIds As ArrayList, report As String, reportCe As String, _
        ...
        If (Not reportCe.Equals(String.Empty) OrElse Not reportCe = "") AndAlso (FormatSearchMask(reportCe)) Then
            whereClauseConditions &= Environment.NewLine & "AND " & "Upper(rep.report_ce_name)" & reportCe.ToUpper
        End If

        report = report.Trim()
        If (Not report.Equals(String.Empty) OrElse Not report = "") AndAlso (FormatSearchMask(report)) Then
