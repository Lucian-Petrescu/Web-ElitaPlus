...
#Region "Load Methods"
    ...
    Public Function AdminLoadList(ds As DataSet, LanguageId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_LIST_ADMIN")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() _
            {New DBHelper.DBHelperParameter(COL_NAME_LANG_ID, LanguageId.ToByteArray)}
        Return (DBHelper.Fetch(ds, selectStmt, TABLE_NAME, parameters))
    End Function

      Public Function DeviceLoadList(ds As DataSet, LanguageId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_LIST_DEVICE_GROUPS")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() _
            {New DBHelper.DBHelperParameter(COL_NAME_LANG_ID, LanguageId.ToByteArray)}
        Return (DBHelper.Fetch(ds, selectStmt, TABLE_NAME, parameters))
    End Function

    Public Function AdminLoadListTranslation(ds As DataSet, ListId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/LOAD_LIST_TRANSLATION")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() _
            {New DBHelper.DBHelperParameter(COL_NAME_LIST_ID, ListId.ToByteArray)}
        Return (DBHelper.Fetch(ds, selectStmt, TABLE_NAME, parameters))
    End Function

    Public Function GetTranslation(ds As DataSet, LanguageId As Guid, DictItemId As Guid) As DataSet
        Dim selectStmt As String = Config("/SQL/GET_TRANSLATION")
        Dim parameters() As DBHelper.DBHelperParameter = New DBHelper.DBHelperParameter() _
...
#Region "Public Members"
    ...
    Public Function AddDropdown(code As String, maintainable_by_user As String, englishTranslation As String, userId As String) As Integer
        Dim selectStmt As String = Config("/SQL/ADD_DROPDOWN")
    ...
    Public Function DeleteDropdown(listId As Guid) As Integer
        Dim selectStmt As String = Config("/SQL/DELETE_DROPDOWN")
