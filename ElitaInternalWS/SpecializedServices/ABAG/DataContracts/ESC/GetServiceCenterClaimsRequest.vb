...
Namespace SpecializedServices.Abag
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Abag/GetServiceCenterClaims", Name:="GetServiceCenterClaimsRequest")>
    Public Class GetServiceCenterClaimsRequest

        <DataMember(IsRequired:=True, Name:="ServiceCenterCode", Order:=1), Required()>
        Public Property ServiceCenterCode As String

        <DataMember(IsRequired:=True, Name:="ClaimStatus", Order:=2), Required()>
        Public Property ClaimStatus As String

        <DataMember(IsRequired:=True, Name:="ClaimType", Order:=3), Required()>
        Public Property ClaimType As String

        <DataMember(IsRequired:=True, Name:="MethodofRepair", Order:=4), Required()>
        Public Property MethodofRepair As String

         <DataMember(Name:="CompanyCode", Order:=5)>
        ...
        <DataMember(Name:="BatchNumber", Order:=21)>
        Public Property BatchNumber As String

        <DataMember(Name:="SerialNumber", Order:=22)>
        Public Property SerialNumber As String

        <DataMember(Name:="WorkPhone", Order:=23)>
