...
Namespace SpecializedServices.Abag
    ...
    Public Interface IEscService
        ...
        Function GetPreInvoice(request As GetPreInvoiceRequest) As GetPreInvoiceResponse
        ...
        Function GetPriceList(request As GetPriceListDetailRequest) As GetPriceListDetailResponse
        ...
        Function GetExtendedClaimStatusList(request As GetExtendedStatusesRequest) As GetExtendedStatusesResponse
