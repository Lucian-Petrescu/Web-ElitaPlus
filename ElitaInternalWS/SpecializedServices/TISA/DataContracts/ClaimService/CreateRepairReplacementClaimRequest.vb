...
Namespace SpecializedServices.Tisa
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/ClaimService/CreateClaim", Name:="CreateReplacementClaimRequest")>
    Public Class CreateRepairReplacementClaimRequest
