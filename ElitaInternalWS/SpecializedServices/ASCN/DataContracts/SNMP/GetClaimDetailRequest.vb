...
Namespace SpecializedServices.Ascn
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Ascn/GetClaimDetail", Name:="GetClaimDetailRequest")>
    ...
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Ascn/GetClaimDetail", Name:="DetailsListEnum")>
