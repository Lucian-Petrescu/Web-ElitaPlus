...
Namespace SpecializedServices.Ascn
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Ascn/SVCUpdateClaim", Name:="UpdateClaimRequest")>
    Public Class UpdateClaimRequest
        ...
        <DataMember(Name:="VisitDate", Order:=13)>
        Public Property VisitDate As Date

        'Req 6292 / US 214283 - Adding Pick-Up date and Salvage Amount
        <DataMember(Name:="PickupDate", Order:=14)>
        Public Property PickupDate As Date?

        <DataMember(Name:="SalvageAmount", Order:=15)>
        Public Property SalvageAmount As Decimal?
    End Class

    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Ascn/SVCUpdateClaim", Name:="ClaimExtInfo")>
    ...
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Ascn/SVCUpdateClaim", Name:="PartsList")>
    ...
    <DataContract(Namespace:="http://elita.assurant.com/SpecializedServices/Ascn/SVCUpdateClaim", Name:="StockCodeEnum")>
