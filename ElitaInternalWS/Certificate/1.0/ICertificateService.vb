...
Namespace Certificates
    ...
    Public Interface ICertificateServiceV1
        ...
        <OperationContract(Name:="CancelByExternalCertNum"),
            ...
            FaultContract(GetType(CompanyNotFoundFault)),
            FaultContract(GetType(ValidationFault))>
        Function CancelByExternalCertNum(request As CancelByExternalCertNumRequest) As CancelByExternalCertNumResponse
        ...
        <OperationContract(Name:="SearchAppleCertificateByImei"),
            ...
            FaultContract(GetType(CompanyNotFoundFault)),
            FaultContract(GetType(DealerNotFoundFault))>
        Function SearchAppleCertificateByImei(request As SearchAppleCertificateByImeiRequest) As SearchAppleCertificateByImeiResponse
    End Interface
End Namespace
