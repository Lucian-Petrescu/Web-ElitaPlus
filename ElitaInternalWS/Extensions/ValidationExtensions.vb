...
Public Module ValidationExtensions
    ...
    <Extension()>
    Public Sub HandleFault(pResults As IEnumerable(Of ValidationResult))
    ...
    <Extension()>
    Private Function ToDictionary(pResults As IEnumerable(Of ValidationResult)) As Dictionary(Of String, String)
