...
Namespace Claims
    ...
    Public Interface IClaimServiceV1
        ...
        Function GetClaims(request As GetClaimsRequest) As GetClaimsResponse
        ...
        Function UpdateClaim(request As UpdateClaimRequest) As UpdateClaimResponse

        <OperationContract(Name:="GetClaimDetails"),
            ElitaPermission(PermissionCodes.WS_Claim_GetClaimDetails),
            FaultContract(GetType(ClaimNotFoundFault))>
        Function GetClaimDetails(request As GetClaimDetailsRequest) As GetClaimDetailsResponse
