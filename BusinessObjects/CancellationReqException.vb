        ...
        Try
            ...
            If Not bValidElita Or Not bValidGVS Then
                ...
                If Not bValidGVS Then
                    ...
                    msg.To.Add(String.Format("{0}", If(AppConfig.CurrentEnvironment.ToUpper.Equals(AppConfig.PRODUCTION_ENVIRONMENT), ElitaPlusIdentity.Current.ActiveUser.Company.Email, TEST_EMAIL).ToString))
