'************* THIS CODE HAS BEEN GENERATED FROM TEMPLATE BusinessObject.cst (6/1/2011)  ********************
...
#Region "Constructors"
    ...
    Protected Sub Load()
        Try
            Dim dal As New RegularExpressionDAL
    ...
    Public ReadOnly Property Id As Guid
        Get
            If row(RegularExpressionDAL.TABLE_KEY_NAME) Is DBNull.Value Then
                Return Nothing
            Else
                Return New Guid(CType(row(RegularExpressionDAL.COL_NAME_REGULAR_EXPRESSION_ID), Byte()))
            End If
        End Get
    End Property
