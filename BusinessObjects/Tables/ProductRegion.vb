'************* THIS CODE HAS BEEN GENERATED FROM TEMPLATE BusinessObject.cst (6/21/2012)  ********************
...
#Region "Properties"
    ...
    Public ReadOnly Property Id() As Guid
        Get
            If row(ProductRegionDAL.TABLE_KEY_NAME) Is DBNull.Value Then
                Return Nothing
            Else
                Return New Guid(CType(row(ProductRegionDAL.COL_NAME_PRODUCT_REGION_ID), Byte()))
            End If
        End Get
    End Property
    ...
    Public Property ProductCodeId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ProductRegionDAL.COL_NAME_PRODUCT_CODE_ID, Value)
        End Set
    End Property
    ...
    Public Property RegionId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ProductRegionDAL.COL_NAME_REGION_ID, Value)
        End Set
    End Property
