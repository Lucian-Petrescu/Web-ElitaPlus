Public Class SgRtManufacturerList
    ...
    Public Sub New(ByVal parent As ServiceGroupRiskType)
    ...
    Public Function Find(ByVal manufacturerId As Guid) As SgRtManufacturer
    ...
    Private Shared Function LoadTable(ByVal parent As ServiceGroupRiskType) As DataTable
        Try
