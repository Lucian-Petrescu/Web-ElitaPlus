...
#Region "Properties"
    ...
    Public Property DealerId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(CoverageMfgDAL.COL_NAME_DEALER_ID, Value)
        End Set
    End Property
    ...
    Public Property ManufacturerId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(CoverageMfgDAL.COL_NAME_MANUFACTURER_ID, Value)
        End Set
    End Property
    ...
    Public Property Model() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(CoverageMfgDAL.COL_NAME_MODEL, Value)
        End Set
    End Property
    ...
    Public Property Deductible() As DecimalType
        ...
        Set(ByVal Value As DecimalType)
            CheckDeleted()
            Me.SetValue(CoverageMfgDAL.COL_DEDUCTIBLE, Value)
        End Set
    End Property
...
#Region "DataView Retrieveing Methods"
    Public Shared Function getList(ByVal dealerId As Guid, _
                                                ByVal manufacturerId As Guid, ByVal CompanyGroupId As Guid) As CoverageMfgSearchDV
