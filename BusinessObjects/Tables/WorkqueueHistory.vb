...
#Region "Shared Members"
    ...
    Public Shared Sub AddItem(wkQItemId As Guid, wkQId As Guid, reason As String, actionCode As String, wkQItemDesc As String)
...
#Region "DataView Retrieveing Methods"
    Public Shared Function LoadWorkQueueItemHistory(WorkQueueId As Guid, languageId As Guid) As DataView
        Try
            Dim dal As New WorkqueueHistoryDAL
            Dim ds As DataSet
    ...
    Public Shared Function LoadWorkQueueUsersActions(WorkQueueId As Guid, languageId As Guid) As DataView
        Try
            Dim dal As New WorkqueueHistoryDAL
            Dim ds As DataSet
