...
#Region "Properties"
    ...
    Public Property CountryId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(CountryLineOfBusinessDAL.COL_NAME_COUNTRY_ID, Value)
        End Set
    End Property
    ...
    Public Property Code() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(CountryLineOfBusinessDAL.COL_NAME_CODE, Value)
        End Set
    End Property
    ...
    Public Property Description() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(CountryLineOfBusinessDAL.COL_NAME_DESCRIPTION, Value)
        End Set
    End Property
    ...
    Public Property LineOfBusinessId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(CountryLineOfBusinessDAL.COL_NAME_LINE_OF_BUSINESS_ID, Value)
        End Set
    End Property
    ...
    Public Property InUse() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(CountryLineOfBusinessDAL.COL_NAME_IN_USE, Value)
        End Set
    End Property
