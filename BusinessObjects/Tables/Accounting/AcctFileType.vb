...
#Region "Constructors"
    ...
    Protected Sub Load()
        Try
            Dim dal As New AcctFileTypeDAL
...
#Region "Properties"
    ...
    Public ReadOnly Property Id() As Guid
        Get
            If row(AcctFileTypeDAL.TABLE_KEY_NAME) Is DBNull.Value Then
                Return Nothing
            Else
                Return New Guid(CType(row(AcctFileTypeDAL.COL_NAME_ACCT_FILE_TYPE_ID), Byte()))
            End If
        End Get
    End Property
    ...
    Public Property Code() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(AcctFileTypeDAL.COL_NAME_CODE, Value)
        End Set
    End Property
