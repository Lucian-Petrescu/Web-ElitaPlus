...
'************* THIS CODE HAS BEEN GENERATED FROM TEMPLATE BusinessObject.cst (12/28/2010)  ********************
...
#Region "Properties"
    ...
    Public ReadOnly Property Id() As Guid
        Get
            If row(ProductSpecialServiceDAL.TABLE_KEY_NAME) Is DBNull.Value Then
                Return Nothing
            Else
                Return New Guid(CType(row(ProductSpecialServiceDAL.COL_NAME_PRODUCT_SPECIAL_SERVICE_ID), Byte()))
            End If
        End Get
    End Property
    ...
    Public Property SpecialServiceId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ProductSpecialServiceDAL.COL_NAME_SPECIAL_SERVICE_ID, Value)
        End Set
    End Property
    ...
    Public Property ProductCodeId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ProductSpecialServiceDAL.COL_NAME_PRODUCT_CODE_ID, Value)
        End Set
    End Property
...
#Region "DataView Retrieveing Methods"
    ...
    Public Shared Function LoadProdSplSvcList(ByVal SpecialServiceId As Guid, ByVal ProductCodeId As Guid) As DataSet
        Try
            Dim dal As New ProductSpecialServiceDAL
            'Dim ds As DataSet
            Return dal.LoadProdSplSvcList(SpecialServiceId, ProductCodeId)
