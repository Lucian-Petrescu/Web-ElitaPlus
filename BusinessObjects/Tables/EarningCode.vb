...
#Region "Properties"
    ...
    Public Property CompanyGroupId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(EarningCodeDAL.COL_NAME_COMPANY_GROUP_ID, Value)
        End Set
    End Property
    ...
    Public Property Code() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(EarningCodeDAL.COL_NAME_CODE, Value)
        End Set
    End Property
    ...
    Public Property Description() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(EarningCodeDAL.COL_NAME_DESCRIPTION, Value)
        End Set
    End Property
