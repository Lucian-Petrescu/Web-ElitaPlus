...
#Region "Properties"
    ...
    Public Property MsgType() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(MessageCodeDAL.COL_NAME_MSG_TYPE, Value)
        End Set
    End Property
    ...
    Public Property MsgCode() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(MessageCodeDAL.COL_NAME_MSG_CODE, Value)
        End Set
    End Property
    ...
    Public Property LabelId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(MessageCodeDAL.COL_NAME_LABEL_ID, Value)
        End Set
    End Property
    ...
    Public Property MsgParameterCount() As LongType
        ...
        Set(ByVal Value As LongType)
            CheckDeleted()
            Me.SetValue(MessageCodeDAL.COL_NAME_MSG_PARAMETER_COUNT, Value)
        End Set
    End Property
