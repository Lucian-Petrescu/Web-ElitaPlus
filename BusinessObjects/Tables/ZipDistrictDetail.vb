...
#Region "Properties"
    ...
    Public Property ZipDistrictId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ZipDistrictDetailDAL.COL_NAME_ZIP_DISTRICT_ID, Value)
        End Set
    End Property
    ...
    Public Property ZipCode() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(ZipDistrictDetailDAL.COL_NAME_ZIP_CODE, Value)
        End Set
    End Property
...
#Region "Shared Methods"
    Public Shared Function GetZipCodesUsedInOtherZipDistricts(ByVal zipDistrictId As Guid) As DataView
        Dim dal As New ZipDistrictDetailDAL
