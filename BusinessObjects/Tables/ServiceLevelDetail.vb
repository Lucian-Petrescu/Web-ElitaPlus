...
#Region "Properties"
    ...
    Public Property ServiceLevelGroupId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_SERVICE_LEVEL_GROUP_ID, Value)
        End Set
    End Property
    ...
    Public Property Code() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_CODE, Value)
        End Set
    End Property
    ...
    Public Property Description() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_DESCRIPTION, Value)
        End Set
    End Property
    ...
    Public Property RiskTypeId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_RISK_TYPE_ID, Value)
        End Set
    End Property
    ...
    Public Property CostTypeId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_COST_TYPE_ID, Value)
        End Set
    End Property
    ...
    Public Property ServiceLevelCost() As DecimalType
        ...
        Set(ByVal Value As DecimalType)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_SERVICE_LEVEL_COST, Value)
        End Set
    End Property
    ...
    Public Property EffectiveDate() As DateType
        ...
        Set(ByVal Value As DateType)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_EFFECTIVE_DATE, Value)
        End Set
    End Property
    ...
    Public Property ExpirationDate() As DateType
        ...
        Set(ByVal Value As DateType)
            CheckDeleted()
            Me.SetValue(ServiceLevelDetailDAL.COL_NAME_EXPIRATION_DATE, Value)
        End Set
    End Property
