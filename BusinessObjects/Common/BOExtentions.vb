...
Module BOExtentions
    <Extension> _
    Public Function FindValidationErrors(Of TBusinessObject As IBusinessObjectBase)(objectToValidate As TBusinessObject) As ValidationError()
    ...
    <Extension> _
    Public Function ToDate(inputString As String, defaultValue As Nullable(Of DateTime)) As Nullable(Of DateTime)
    ...
    <Extension> _
    Public Function ToDecimal(inputString As String, defaultValue As Nullable(Of Decimal)) As Nullable(Of Decimal)
    ...
    <Extension> _
    Public Function ToGuid(inputString As String, defaultValue As Nullable(Of Guid)) As Nullable(Of Guid)
    ...
    <Extension> _
    Public Function ToString(inputGuid As Guid, Optional ByVal defaultValue As String = Nothing) As String
