Public Class Codes
    ...
    Public Const EVNT_TYP__CLAIM_DOCUMENT_UPLOAD = "CLAIM_DOCUMENT_UPLOADED"
    Public Const EVNT_TYP_CLM_REPLACEMNT_QUOTE = "CLM_REPLACEMNT_QUOTE"
    Public Const EVNT_TYP_LOGISTIC_STAGE_ADDRESS As String = "LOGISTIC_STAGE_ADDRESS_UPDATED"
...
#End Region
    ...
    Public Const DLR_ATTR_ALLOW_MODIFY_CLAIMED_DEVICE As String = "ALLOW_MODIFY_CLAIMED_DEVICE"
    'Product Attributes
    ...
    Public Const AUTH_FULFILLMENT_TYPE_SWRPR As String = "AUTH_FUL_TYPE-SWRPR"  'service warranty - repair
    Public Const AUTH_FULFILLMENT_TYPE_SWRPL As String = "AUTH_FUL_TYPE-SWRPL"  'service warranty - replacement 
    ...
    Public Const ACCT_BUCKETS_SOURCE_COMMBRKDOWN_OPTION_PRICEMATRIX As String = "ACCTBUCKETSOURCE_COMMBRKDOWN-PM"
    Public Const ACCT_BUCKETS_SOURCE_COMMBRKDOWN_OPTION_INCOMING As String = "ACCTBUCKETSOURCE_COMMBRKDOWN-I"
    Public Const ACCT_BUCKETS_SOURCE_COMMBRKDOWN_OPTION_DIFFERENCE As String = "ACCTBUCKETSOURCE_COMMBRKDOWN-D"
    Public Const ACCT_BUCKETS_SOURCE_COMMBRKDOWN_OPTION_CERTCOMM As String = "ACCTBUCKETSOURCE_COMMBRKDOWN-C"


    'US-521680
    Public Const NEW_COMMISSION_MODULE_CONFIGURED As String = "NEW_COMMISSION_MODULE_CONFIGURED"

    'PBI-489838
    Public Const SEQUENTIAL_RENEWAL_NUMBER_VALIDATION As String = "SEQUENTIAL_RENEWAL_NUMBER_VALIDATION"
End Class
