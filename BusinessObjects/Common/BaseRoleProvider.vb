Public MustInherit Class BaseRoleProvider
    Public Shared Function CreateRoleProvider(ByVal roleProviderTypeCode As String) As IRemoteRoleProvider
    ...
    Friend Shared Function CreateRoleProvider(ByVal roleProviderTypeId As Guid) As IRemoteRoleProvider
