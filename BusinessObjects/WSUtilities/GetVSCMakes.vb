...
#Region "Constructors"
    ...
    Public Sub New(ds As GetVSCMakesDs)
        MyBase.New()
...
#Region "Private Members"
    ...
    Private Sub MapDataSet(ds As GetVSCMakesDs)
    ...
    Private Sub Load(ds As GetVSCMakesDs)
        Try
            Initialize()
    ...
    Private Sub PopulateBOFromWebService(ds As GetVSCMakesDs)
        Try
