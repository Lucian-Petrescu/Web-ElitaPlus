...
Public Class GetVSCMakes
    Inherits BusinessObjectBase

#Region "Constants"
    Public Const DATA_COL_NAME_COMPANY_GROUP_CODE As String = "company_group_code"
    Private Const TABLE_NAME As String = "GetVSCMakes"

#End Region

#Region "Constructors"

    Public Sub New(ByVal ds As GetVSCMakesDs)
        MyBase.New()
...
#Region "Private Members"
    ...
    Private Sub MapDataSet(ByVal ds As GetVSCMakesDs)
    ...
    Private Sub Load(ByVal ds As GetVSCMakesDs)
        Try
            Initialize()
    ...
    Private Sub PopulateBOFromWebService(ByVal ds As GetVSCMakesDs)
        Try
            If ds.GetVSCMakes.Count = 0 Then Exit Sub
            With ds.GetVSCMakes.Item(0)
...
#Region "Public Members"
    ...
    Public Overrides Function ProcessWSRequest() As String
        Try
            ...
            ds = Manufacturer.GetVSCMakes(companyGroupID)
