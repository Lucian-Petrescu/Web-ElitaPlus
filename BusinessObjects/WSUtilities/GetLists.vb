...
#Region "Constructors"
    ...
    Public Sub New(ds As GetListsDs)
        MyBase.New()
...
#Region "Private Members"
    ...
    Private Sub MapDataSet(ds As GetListsDs)
    ...
    Private Sub Load(ds As GetListsDs)
        Try
            Initialize()
    ...
    Private Sub PopulateBOFromWebService(ds As GetListsDs)
        Try
