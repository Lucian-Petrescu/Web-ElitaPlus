...
#Region "Constructors"
    ...
    Public Sub New(ds As GetSalutationsDs)
        MyBase.New()
...
#Region "Private Members"
    ...
    Private Sub MapDataSet(ds As GetSalutationsDs)
    ...
    Private Sub Load(ds As GetSalutationsDs)
        Try
            Initialize()
    ...
    Private Sub PopulateBOFromWebService(ds As GetSalutationsDs)
        Try
        ...
        Try
            ...
            Else
                ...
                ElseIf objSalutationDS.Tables.Count > 0 AndAlso objSalutationDS.Tables(0).Rows.Count > 0 Then
                    objSalutationDS.Tables(0).Columns.Remove(COL_NAME_SALUTATION_ID)
