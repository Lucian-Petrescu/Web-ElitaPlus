...
#Region "Constructors"
    ...
    Protected Sub Load()
        Try
            Dim dal As New TransDtlFollowupDAL
...
#Region "Properties"
    ...
    Public ReadOnly Property Id() As Guid
        Get
            If row(TransDtlFollowupDAL.TABLE_KEY_NAME) Is DBNull.Value Then
                Return Nothing
            Else
                Return New Guid(CType(row(TransDtlFollowupDAL.COL_NAME_TRANS_DTL_FOLLOWUP_ID), Byte()))
            End If
        End Get
    End Property
    ...
    Public Property TransDtlClmUpdte2elitaId() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(TransDtlFollowupDAL.COL_NAME_TRANS_DTL_CLM_UPDTE_2ELITA_ID, Value)
        End Set
    End Property
    ...
    Public Property XmlCreateDate() As DateType
        ...
        Set(ByVal Value As DateType)
            CheckDeleted()
            Me.SetValue(TransDtlFollowupDAL.COL_NAME_XML_CREATE_DATE, Value)
        End Set
    End Property
    ...
    Public Property XmlCommentTypeCode() As Guid
        ...
        Set(ByVal Value As Guid)
            CheckDeleted()
            Me.SetValue(TransDtlFollowupDAL.COL_NAME_XML_COMMENT_TYPE_CODE, Value)
        End Set
    End Property
    ...
    Public Property XmlComments() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(TransDtlFollowupDAL.COL_NAME_XML_COMMENTS, Value)
        End Set
    End Property
    ...
    Public Property XmlCallerName() As String
        ...
        Set(ByVal Value As String)
            CheckDeleted()
            Me.SetValue(TransDtlFollowupDAL.COL_NAME_XML_CALLER_NAME, Value)
        End Set
    End Property
