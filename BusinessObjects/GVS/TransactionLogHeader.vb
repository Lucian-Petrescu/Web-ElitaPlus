...
#Region "DataView Retrieveing Methods"
    ...
    Public Class ExceptionSearchDV
        ...
        Public Const COL_TRANSACTION_LOG_HEADER_ID As String = "transaction_log_header_id"
        Public Const COL_CLAIM_NUMBER As String = "claim_number"
        Public Const COL_TRANSACTION_DATE As String = "transaction_date"
        ...
        Public Const COL_ORIGINATOR As String = "originator"
        ...
        Public Function AddNewRowToEmptyDV() As ExceptionSearchDV
            ...
            row(ExceptionSearchDV.COL_TRANSACTION_LOG_HEADER_ID) = (New Guid()).ToByteArray
            row(ExceptionSearchDV.COL_CLAIM_NUMBER) = ""
            'row(ExceptionSearchDV.COL_TRANSACTION_DATE) = ""
            row(ExceptionSearchDV.COL_CUSTOMER_NAME) = ""
            row(ExceptionSearchDV.COL_SERVICE_CENTER_CODE) = ""
            row(ExceptionSearchDV.COL_AUTHORIZATION_NUMBER) = ""
            row(ExceptionSearchDV.COL_ERROR_CODE) = ""
            row(ExceptionSearchDV.COL_ORIGINATOR) = ""
            dt.Rows.Add(row)
    ...
    Public Class TransactionStatusDV
        ...
        Public Shared Sub AddNewRowToEmptyDV(ByRef dv As TransactionStatusDV)
            ...
            If dv Is Nothing Then
                ...
                blnEmptyTbl = True
                dt = New DataTable
                dt.Columns.Add(TransactionStatusDV.COL_TRANSACTION_LOG_HEADER_ID, Guid.Empty.ToByteArray.GetType)
            ...
            row = dt.NewRow
            row(TransactionStatusDV.COL_TRANSACTION_LOG_HEADER_ID) = (New Guid()).ToByteArray
    ...
    Public Class TransactionPartDV
        ...
        Public Shared Sub AddNewRowToEmptyDV(ByRef dv As TransactionPartDV)
            ...
            If dv Is Nothing Then
                ...
                blnEmptyTbl = True
                dt = New DataTable
                dt.Columns.Add(TransactionPartDV.COL_TRANSACTION_LOG_HEADER_ID, Guid.Empty.ToByteArray.GetType)
    ...
    Public Class TransactionDataDV
        ...
        Public Const COL_TRANSACTION_LOG_HEADER_ID As String = "transaction_log_header_id"
        Public Const COL_ORIGINATOR As String = "originator"
        Public Const COL_FUNCTION_TYPE As String = "function_type"
        Public Const COL_FUNCTION_TYPE_CODE As String = "function_type_code"
        Public Const COL_SERVICE_TYPE As String = "service_type"
        Public Const COL_HIDE As String = "hide"
        Public Const COL_RESEND As String = "resend"
        Public Const COL_CUSTOMER_NAME As String = "customer_name"
        Public Const COL_TAX_ID As String = "tax_id"
        ...
        Public Const COL_PHONE1 As String = "phone1"
        Public Const COL_PHONE2 As String = "phone2"
        Public Const COL_EMAIL As String = "email"
        Public Const COL_RETAILER As String = "retailer"
        Public Const COL_INVOICE_NUMBER As String = "invoice_number"
        Public Const COL_PROD_SALES_DATE As String = "prod_sales_date"
        Public Const COL_PROD_SALES_PRICE As String = "prod_sales_price"
        Public Const COL_MODEL As String = "model"
        Public Const COL_SERIAL_NUMBER As String = "serial_number"
        Public Const COL_CLAIM_NUMBER As String = "claim_number"
        Public Const COL_GVS_SERVICE_ORDER_NUM As String = "gvs_service_order_num"
        Public Const COL_SERVICE_CENTER_CODE As String = "service_center_code"
        Public Const COL_METHOD_OF_REPAIR As String = "method_of_repair"
        Public Const COL_CLAIM_CREATED_DATE As String = "claim_created_date"
        Public Const COL_PROBLEM_DESCRIPTION As String = "problem_description"
        Public Const COL_TECHNICAL_REPORT As String = "technical_report"
        Public Const COL_CLAIMACTIVITY_CODE As String = "claim_activity_code"
        Public Const COL_REPAIR_DATE As String = "repair_date"
        Public Const COL_PICKUP_DATE As String = "pickup_date"
        Public Const COL_SCHEDULE_VISIT_DATE As String = "schedule_visit_date"
        Public Const COL_EXPECTED_REPAIR_DATE As String = "expected_repair_date"
        Public Const COL_VISIT_DATE As String = "visit_date"
        Public Const COL_DEFECT_REASON_CODE As String = "defect_reason_code"
        Public Const COL_LIABILITY_LIMIT_AMOUNT As String = "liability_limit_amount"
        Public Const COL_LIABILITY_LIMIT_PERCENT As String = "liability_limit_percent"
        Public Const COL_DEDUCTIBLE_AMOUNT As String = "deductible_amount"
        Public Const COL_DEDUCTIBLE_PERCENT As String = "deductible_percent"
        Public Const COL_LABOR_AMOUNT As String = "labor_amount"
        Public Const COL_shipping As String = "shipping"
    ...
    Public Class TransactionFollowUpDV
        ...
        Public Shared Sub AddNewRowToEmptyDV(ByRef dv As TransactionFollowUpDV)
            ...
            If dv Is Nothing Then
                ...
                blnEmptyTbl = True
                dt = New DataTable
                dt.Columns.Add(TransactionFollowUpDV.COL_TRANSACTION_LOG_HEADER_ID, Guid.Empty.ToByteArray.GetType)
            ...
            row = dt.NewRow
            row(TransactionFollowUpDV.COL_TRANSACTION_LOG_HEADER_ID) = (New Guid()).ToByteArray
    ...
    Public Shared Function GetLastSuccessfulTransmissionTimeByType() As DataView
        ...
        Try
            Dim objTransactionLogHeaderDAL As New TransactionLogHeaderDAL
            Return objTransactionLogHeaderDAL.GetLastSuccessfulTransmissionTimeByType(ElitaPlusIdentity.Current.ActiveUser.CompanyGroup.Id)
        Catch ex As Assurant.ElitaPlus.DALObjects.DataBaseAccessException
