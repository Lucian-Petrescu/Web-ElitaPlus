...
Public Class InterfaceCoverageRateDs
    ...
    Public Delegate Sub InterfaceCoverageRateRowChangeEventHandler(sender As Object, e As InterfaceCoverageRateRowChangeEvent)
    ...
    Public Class InterfaceCoverageRateDataTable
        ...
        Public Default ReadOnly Property Item(index As Integer) As InterfaceCoverageRateRow
            Get
        ...
        Public Overloads Sub AddInterfaceCoverageRateRow(row As InterfaceCoverageRateRow)
            Me.Rows.Add(row)
        End Sub
        
        Public Overloads Function AddInterfaceCoverageRateRow( _
                    company_group_code As String,  _
                    dealer_code As String,  _
                    dealer_group_code As String,  _
                    deductible_type As String,  _
                    deductible As Decimal,  _
                    reduced_deductible As Decimal,  _
                    plan_code As String,  _
                    plan_name As String,  _
                    plan_term_months As System.UInt64,  _
                    _plan_term_KM_MI As System.UInt64,  _
                    _KM_MI_from As System.UInt64,  _
                    _KM_MI_to As System.UInt64,  _
                    engine_manuf_Warr_months As System.UInt64,  _
                    _engine_manuf_Warr_KM_MI As System.UInt64,  _
                    class_code As String,  _
                    gwp As Decimal,  _
                    wp As Decimal,  _
                    commission_percent As Decimal,  _
                    marketing_percent As Decimal,  _
                    admin_expense As Decimal,  _
                    profit_percent As Decimal,  _
                    loss_cost_percent As Decimal,  _
                    Taxes_Percent As Decimal) As InterfaceCoverageRateRow
        ...
        Public Sub RemoveInterfaceCoverageRateRow(row As InterfaceCoverageRateRow)
            Me.Rows.Remove(row)
        End Sub
    End Class
    ...
    Public Class InterfaceCoverageRateRowChangeEvent
        ...
        Public Sub New(row As InterfaceCoverageRateRow, action As DataRowAction)
            MyBase.New
            Me.eventRow = row
